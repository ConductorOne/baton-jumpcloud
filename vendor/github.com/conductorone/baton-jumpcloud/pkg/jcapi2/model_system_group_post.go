...
// checks if the SystemGroupPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemGroupPost{}

// SystemGroupPost struct for SystemGroupPost
type SystemGroupPost struct {
...
type _SystemGroupPost SystemGroupPost
...
func (o SystemGroupPost) MarshalJSON() ([]byte, error) {
...
func (o SystemGroupPost) ToMap() (map[string]interface{}, error) {
...
func (o *SystemGroupPost) UnmarshalJSON(bytes []byte) (err error) {
	varSystemGroupPost := _SystemGroupPost{}

	if err = json.Unmarshal(bytes, &varSystemGroupPost); err == nil {
		*o = SystemGroupPost(varSystemGroupPost)
	}
...
type NullableSystemGroupPost struct {
	value *SystemGroupPost
	isSet bool
}

func (v NullableSystemGroupPost) Get() *SystemGroupPost {
	return v.value
}

func (v *NullableSystemGroupPost) Set(val *SystemGroupPost) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemGroupPost) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemGroupPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemGroupPost(val *SystemGroupPost) *NullableSystemGroupPost {
	return &NullableSystemGroupPost{value: val, isSet: true}
}

func (v NullableSystemGroupPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemGroupPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
