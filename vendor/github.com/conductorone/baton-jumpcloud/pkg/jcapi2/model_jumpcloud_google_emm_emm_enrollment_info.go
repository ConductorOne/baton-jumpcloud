...
// checks if the JumpcloudGoogleEmmEMMEnrollmentInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JumpcloudGoogleEmmEMMEnrollmentInfo{}

// JumpcloudGoogleEmmEMMEnrollmentInfo struct for JumpcloudGoogleEmmEMMEnrollmentInfo
type JumpcloudGoogleEmmEMMEnrollmentInfo struct {
...
type _JumpcloudGoogleEmmEMMEnrollmentInfo JumpcloudGoogleEmmEMMEnrollmentInfo
...
func NewJumpcloudGoogleEmmEMMEnrollmentInfo() *JumpcloudGoogleEmmEMMEnrollmentInfo {
	this := JumpcloudGoogleEmmEMMEnrollmentInfo{}
	return &this
}
...
// GetAppliedPolicyName returns the AppliedPolicyName field value if set, zero value otherwise.
func (o *JumpcloudGoogleEmmEMMEnrollmentInfo) GetAppliedPolicyName() string {
	if o == nil || IsNil(o.AppliedPolicyName) {
		var ret string
		return ret
	}
	return *o.AppliedPolicyName
}

// GetAppliedPolicyNameOk returns a tuple with the AppliedPolicyName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *JumpcloudGoogleEmmEMMEnrollmentInfo) GetAppliedPolicyNameOk() (*string, bool) {
	if o == nil || IsNil(o.AppliedPolicyName) {
		return nil, false
	}
	return o.AppliedPolicyName, true
}
...
// SetAppliedPolicyName gets a reference to the given string and assigns it to the AppliedPolicyName field.
func (o *JumpcloudGoogleEmmEMMEnrollmentInfo) SetAppliedPolicyName(v string) {
	o.AppliedPolicyName = &v
}

// GetAppliedPolicyVersion returns the AppliedPolicyVersion field value if set, zero value otherwise.
func (o *JumpcloudGoogleEmmEMMEnrollmentInfo) GetAppliedPolicyVersion() int64 {
	if o == nil || IsNil(o.AppliedPolicyVersion) {
		var ret int64
		return ret
	}
	return *o.AppliedPolicyVersion
}

// GetAppliedPolicyVersionOk returns a tuple with the AppliedPolicyVersion field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *JumpcloudGoogleEmmEMMEnrollmentInfo) GetAppliedPolicyVersionOk() (*int64, bool) {
	if o == nil || IsNil(o.AppliedPolicyVersion) {
		return nil, false
	}
	return o.AppliedPolicyVersion, true
}
...
// SetAppliedPolicyVersion gets a reference to the given int64 and assigns it to the AppliedPolicyVersion field.
func (o *JumpcloudGoogleEmmEMMEnrollmentInfo) SetAppliedPolicyVersion(v int64) {
	o.AppliedPolicyVersion = &v
}
...
func (o JumpcloudGoogleEmmEMMEnrollmentInfo) MarshalJSON() ([]byte, error) {
...
func (o JumpcloudGoogleEmmEMMEnrollmentInfo) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AppliedPolicyName) {
		toSerialize["appliedPolicyName"] = o.AppliedPolicyName
	}
	if !IsNil(o.AppliedPolicyVersion) {
		toSerialize["appliedPolicyVersion"] = o.AppliedPolicyVersion
	}
	if !IsNil(o.EnrollmentTime) {
		toSerialize["enrollmentTime"] = o.EnrollmentTime
	}
...
func (o *JumpcloudGoogleEmmEMMEnrollmentInfo) UnmarshalJSON(bytes []byte) (err error) {
	varJumpcloudGoogleEmmEMMEnrollmentInfo := _JumpcloudGoogleEmmEMMEnrollmentInfo{}

	if err = json.Unmarshal(bytes, &varJumpcloudGoogleEmmEMMEnrollmentInfo); err == nil {
		*o = JumpcloudGoogleEmmEMMEnrollmentInfo(varJumpcloudGoogleEmmEMMEnrollmentInfo)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "appliedPolicyName")
		delete(additionalProperties, "appliedPolicyVersion")
		delete(additionalProperties, "enrollmentTime")
...
type NullableJumpcloudGoogleEmmEMMEnrollmentInfo struct {
	value *JumpcloudGoogleEmmEMMEnrollmentInfo
	isSet bool
}

func (v NullableJumpcloudGoogleEmmEMMEnrollmentInfo) Get() *JumpcloudGoogleEmmEMMEnrollmentInfo {
	return v.value
}

func (v *NullableJumpcloudGoogleEmmEMMEnrollmentInfo) Set(val *JumpcloudGoogleEmmEMMEnrollmentInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableJumpcloudGoogleEmmEMMEnrollmentInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableJumpcloudGoogleEmmEMMEnrollmentInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJumpcloudGoogleEmmEMMEnrollmentInfo(val *JumpcloudGoogleEmmEMMEnrollmentInfo) *NullableJumpcloudGoogleEmmEMMEnrollmentInfo {
	return &NullableJumpcloudGoogleEmmEMMEnrollmentInfo{value: val, isSet: true}
}

func (v NullableJumpcloudGoogleEmmEMMEnrollmentInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJumpcloudGoogleEmmEMMEnrollmentInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
