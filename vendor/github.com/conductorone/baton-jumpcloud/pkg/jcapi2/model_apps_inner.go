...
// checks if the AppsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppsInner{}

// AppsInner struct for AppsInner
...
func (o AppsInner) MarshalJSON() ([]byte, error) {
...
func (o AppsInner) ToMap() (map[string]interface{}, error) {
...
func (o *AppsInner) UnmarshalJSON(bytes []byte) (err error) {
	varAppsInner := _AppsInner{}

	if err = json.Unmarshal(bytes, &varAppsInner); err == nil {
		*o = AppsInner(varAppsInner)
	}
...
type NullableAppsInner struct {
	value *AppsInner
	isSet bool
}

func (v NullableAppsInner) Get() *AppsInner {
	return v.value
}

func (v *NullableAppsInner) Set(val *AppsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableAppsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableAppsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppsInner(val *AppsInner) *NullableAppsInner {
	return &NullableAppsInner{value: val, isSet: true}
}

func (v NullableAppsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
