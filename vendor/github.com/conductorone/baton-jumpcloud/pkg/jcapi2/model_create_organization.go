...
type CreateOrganization struct {
	...
	MaxSystemUsers *int32 `json:"maxSystemUsers,omitempty"`
...
// GetMaxSystemUsers returns the MaxSystemUsers field value if set, zero value otherwise.
func (o *CreateOrganization) GetMaxSystemUsers() int32 {
	if o == nil || IsNil(o.MaxSystemUsers) {
		var ret int32
		return ret
	}
	return *o.MaxSystemUsers
}

// GetMaxSystemUsersOk returns a tuple with the MaxSystemUsers field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreateOrganization) GetMaxSystemUsersOk() (*int32, bool) {
	if o == nil || IsNil(o.MaxSystemUsers) {
		return nil, false
	}
	return o.MaxSystemUsers, true
}
...
// SetMaxSystemUsers gets a reference to the given int32 and assigns it to the MaxSystemUsers field.
...
func (o CreateOrganization) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MaxSystemUsers) {
		toSerialize["maxSystemUsers"] = o.MaxSystemUsers
	}
	if !IsNil(o.Name) {
...
func (o *CreateOrganization) UnmarshalJSON(bytes []byte) (err error) {
	varCreateOrganization := _CreateOrganization{}

	if err = json.Unmarshal(bytes, &varCreateOrganization); err == nil {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "maxSystemUsers")
