...
// LdapGroup An LDAP group object.
type LdapGroup struct {
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _LdapGroup LdapGroup
...
func (o *LdapGroup) UnmarshalJSON(bytes []byte) (err error) {
	varLdapGroup := _LdapGroup{}

	if err = json.Unmarshal(bytes, &varLdapGroup); err == nil {
		*o = LdapGroup(varLdapGroup)
	}
