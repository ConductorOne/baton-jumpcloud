...
// GetAnnualPrice returns the AnnualPrice field value
...
// GetAnnualPriceOk returns a tuple with the AnnualPrice field value
...
// SetAnnualPrice sets field value
...
// GetListPrice returns the ListPrice field value
...
// GetListPriceOk returns a tuple with the ListPrice field value
// and a boolean to check if the value has been set.
...
func (o *Subscription) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "annualPrice")
