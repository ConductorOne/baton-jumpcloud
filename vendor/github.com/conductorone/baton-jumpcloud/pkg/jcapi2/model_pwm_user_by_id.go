...
// checks if the PwmUserById type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PwmUserById{}

// PwmUserById struct for PwmUserById
type PwmUserById struct {
...
func (o PwmUserById) MarshalJSON() ([]byte, error) {
...
func (o PwmUserById) ToMap() (map[string]interface{}, error) {
...
func (o *PwmUserById) UnmarshalJSON(bytes []byte) (err error) {
	varPwmUserById := _PwmUserById{}

	if err = json.Unmarshal(bytes, &varPwmUserById); err == nil {
		*o = PwmUserById(varPwmUserById)
	}
...
type NullablePwmUserById struct {
	value *PwmUserById
	isSet bool
}

func (v NullablePwmUserById) Get() *PwmUserById {
	return v.value
}

func (v *NullablePwmUserById) Set(val *PwmUserById) {
	v.value = val
	v.isSet = true
}

func (v NullablePwmUserById) IsSet() bool {
	return v.isSet
}

func (v *NullablePwmUserById) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePwmUserById(val *PwmUserById) *NullablePwmUserById {
	return &NullablePwmUserById{value: val, isSet: true}
}

func (v NullablePwmUserById) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePwmUserById) UnmarshalJSON(src []byte) error {
	v.isSet = true
