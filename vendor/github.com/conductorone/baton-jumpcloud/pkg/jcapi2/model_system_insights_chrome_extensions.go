...
// checks if the SystemInsightsChromeExtensions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemInsightsChromeExtensions{}

// SystemInsightsChromeExtensions struct for SystemInsightsChromeExtensions
...
type _SystemInsightsChromeExtensions SystemInsightsChromeExtensions
...
func NewSystemInsightsChromeExtensions() *SystemInsightsChromeExtensions {
	this := SystemInsightsChromeExtensions{}
	return &this
}
...
// SetPersistent gets a reference to the given int32 and assigns it to the Persistent field.
...
func (o SystemInsightsChromeExtensions) MarshalJSON() ([]byte, error) {
...
func (o SystemInsightsChromeExtensions) ToMap() (map[string]interface{}, error) {
...
func (o *SystemInsightsChromeExtensions) UnmarshalJSON(bytes []byte) (err error) {
	varSystemInsightsChromeExtensions := _SystemInsightsChromeExtensions{}

	if err = json.Unmarshal(bytes, &varSystemInsightsChromeExtensions); err == nil {
		*o = SystemInsightsChromeExtensions(varSystemInsightsChromeExtensions)
	}
...
type NullableSystemInsightsChromeExtensions struct {
	value *SystemInsightsChromeExtensions
	isSet bool
}

func (v NullableSystemInsightsChromeExtensions) Get() *SystemInsightsChromeExtensions {
	return v.value
}

func (v *NullableSystemInsightsChromeExtensions) Set(val *SystemInsightsChromeExtensions) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemInsightsChromeExtensions) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemInsightsChromeExtensions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemInsightsChromeExtensions(val *SystemInsightsChromeExtensions) *NullableSystemInsightsChromeExtensions {
	return &NullableSystemInsightsChromeExtensions{value: val, isSet: true}
}

func (v NullableSystemInsightsChromeExtensions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemInsightsChromeExtensions) UnmarshalJSON(src []byte) error {
	v.isSet = true
