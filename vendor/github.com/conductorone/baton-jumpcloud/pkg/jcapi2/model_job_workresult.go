...
// checks if the JobWorkresult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JobWorkresult{}

// JobWorkresult struct for JobWorkresult
type JobWorkresult struct {
	CreatedAt *string `json:"createdAt,omitempty"`
	Id *string `json:"id,omitempty"`
	Meta map[string]interface{} `json:"meta,omitempty"`
	PersistedFields map[string]interface{} `json:"persistedFields,omitempty"`
...
type _JobWorkresult JobWorkresult
...
// GetPersistedFields returns the PersistedFields field value if set, zero value otherwise.
func (o *JobWorkresult) GetPersistedFields() map[string]interface{} {
	if o == nil || IsNil(o.PersistedFields) {
		var ret map[string]interface{}
		return ret
	}
	return o.PersistedFields
}

// GetPersistedFieldsOk returns a tuple with the PersistedFields field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *JobWorkresult) GetPersistedFieldsOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.PersistedFields) {
		return map[string]interface{}{}, false
	}
	return o.PersistedFields, true
}
...
// SetPersistedFields gets a reference to the given map[string]interface{} and assigns it to the PersistedFields field.
...
// and a boolean to check if the value has been set.
func (o *JobWorkresult) GetStatusMsgOk() (*string, bool) {
	if o == nil || IsNil(o.StatusMsg) {
		return nil, false
	}
...
func (o JobWorkresult) MarshalJSON() ([]byte, error) {
...
func (o JobWorkresult) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PersistedFields) {
		toSerialize["persistedFields"] = o.PersistedFields
	}
	if !IsNil(o.Status) {
...
func (o *JobWorkresult) UnmarshalJSON(bytes []byte) (err error) {
	varJobWorkresult := _JobWorkresult{}

	if err = json.Unmarshal(bytes, &varJobWorkresult); err == nil {
		*o = JobWorkresult(varJobWorkresult)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "persistedFields")
...
type NullableJobWorkresult struct {
	value *JobWorkresult
	isSet bool
}

func (v NullableJobWorkresult) Get() *JobWorkresult {
	return v.value
}

func (v *NullableJobWorkresult) Set(val *JobWorkresult) {
	v.value = val
	v.isSet = true
}

func (v NullableJobWorkresult) IsSet() bool {
	return v.isSet
}

func (v *NullableJobWorkresult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJobWorkresult(val *JobWorkresult) *NullableJobWorkresult {
	return &NullableJobWorkresult{value: val, isSet: true}
}

func (v NullableJobWorkresult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJobWorkresult) UnmarshalJSON(src []byte) error {
	v.isSet = true
