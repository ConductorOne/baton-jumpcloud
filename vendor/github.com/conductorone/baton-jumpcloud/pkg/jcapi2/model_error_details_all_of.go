...
// checks if the ErrorDetailsAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorDetailsAllOf{}
...
type _ErrorDetailsAllOf ErrorDetailsAllOf
...
func (o *ErrorDetailsAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varErrorDetailsAllOf := _ErrorDetailsAllOf{}

	if err = json.Unmarshal(bytes, &varErrorDetailsAllOf); err == nil {
		*o = ErrorDetailsAllOf(varErrorDetailsAllOf)
	}
...
func NewNullableErrorDetailsAllOf(val *ErrorDetailsAllOf) *NullableErrorDetailsAllOf {
	return &NullableErrorDetailsAllOf{value: val, isSet: true}
}
