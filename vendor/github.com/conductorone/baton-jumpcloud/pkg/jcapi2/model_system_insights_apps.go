...
type _SystemInsightsApps SystemInsightsApps
...
func (o *SystemInsightsApps) UnmarshalJSON(bytes []byte) (err error) {
	varSystemInsightsApps := _SystemInsightsApps{}

	if err = json.Unmarshal(bytes, &varSystemInsightsApps); err == nil {
		*o = SystemInsightsApps(varSystemInsightsApps)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "applescript_enabled")
		delete(additionalProperties, "bundle_executable")
		delete(additionalProperties, "bundle_identifier")
		delete(additionalProperties, "bundle_name")
		delete(additionalProperties, "bundle_package_type")
		delete(additionalProperties, "bundle_short_version")
		...
		delete(additionalProperties, "info_string")
		delete(additionalProperties, "last_opened_time")
		delete(additionalProperties, "minimum_system_version")
