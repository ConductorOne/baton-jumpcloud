...
func (o *SystemGroup) UnmarshalJSON(bytes []byte) (err error) {
	varSystemGroup := _SystemGroup{}

	if err = json.Unmarshal(bytes, &varSystemGroup); err == nil {
		*o = SystemGroup(varSystemGroup)
	}
