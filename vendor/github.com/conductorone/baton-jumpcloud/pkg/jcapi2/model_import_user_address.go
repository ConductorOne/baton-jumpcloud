...
// checks if the ImportUserAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImportUserAddress{}

// ImportUserAddress struct for ImportUserAddress
type ImportUserAddress struct {
...
type _ImportUserAddress ImportUserAddress
...
func (o ImportUserAddress) MarshalJSON() ([]byte, error) {
...
func (o ImportUserAddress) ToMap() (map[string]interface{}, error) {
...
func (o *ImportUserAddress) UnmarshalJSON(bytes []byte) (err error) {
	varImportUserAddress := _ImportUserAddress{}

	if err = json.Unmarshal(bytes, &varImportUserAddress); err == nil {
		*o = ImportUserAddress(varImportUserAddress)
	}
...
type NullableImportUserAddress struct {
	value *ImportUserAddress
	isSet bool
}

func (v NullableImportUserAddress) Get() *ImportUserAddress {
	return v.value
}

func (v *NullableImportUserAddress) Set(val *ImportUserAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableImportUserAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableImportUserAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImportUserAddress(val *ImportUserAddress) *NullableImportUserAddress {
	return &NullableImportUserAddress{value: val, isSet: true}
}

func (v NullableImportUserAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImportUserAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
