...
// checks if the PwmUserSharedFoldersResultsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PwmUserSharedFoldersResultsInner{}

// PwmUserSharedFoldersResultsInner struct for PwmUserSharedFoldersResultsInner
type PwmUserSharedFoldersResultsInner struct {
	AccessLevelId *string `json:"accessLevelId,omitempty"`
	AccessLevelName *string `json:"accessLevelName,omitempty"`
	CreatedAt string `json:"createdAt"`
	Id string `json:"id"`
	ItemsInFolder int32 `json:"itemsInFolder"`
	Name string `json:"name"`
	PasswordsScore *float32 `json:"passwordsScore,omitempty"`
	ScoreUpdatedAt *string `json:"scoreUpdatedAt,omitempty"`
	UsersWithAccess int32 `json:"usersWithAccess"`
	AdditionalProperties map[string]interface{}
}

type _PwmUserSharedFoldersResultsInner PwmUserSharedFoldersResultsInner
...
func NewPwmUserSharedFoldersResultsInner(createdAt string, id string, itemsInFolder int32, name string, usersWithAccess int32) *PwmUserSharedFoldersResultsInner {
	this := PwmUserSharedFoldersResultsInner{}
...
// GetAccessLevelId returns the AccessLevelId field value if set, zero value otherwise.
func (o *PwmUserSharedFoldersResultsInner) GetAccessLevelId() string {
	if o == nil || IsNil(o.AccessLevelId) {
		var ret string
		return ret
	}
	return *o.AccessLevelId
}

// GetAccessLevelIdOk returns a tuple with the AccessLevelId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PwmUserSharedFoldersResultsInner) GetAccessLevelIdOk() (*string, bool) {
	if o == nil || IsNil(o.AccessLevelId) {
		return nil, false
	}
	return o.AccessLevelId, true
}
...
// SetAccessLevelId gets a reference to the given string and assigns it to the AccessLevelId field.
...
// GetItemsInFolder returns the ItemsInFolder field value
func (o *PwmUserSharedFoldersResultsInner) GetItemsInFolder() int32 {
	...
	return o.ItemsInFolder
}

// GetItemsInFolderOk returns a tuple with the ItemsInFolder field value
// and a boolean to check if the value has been set.
func (o *PwmUserSharedFoldersResultsInner) GetItemsInFolderOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ItemsInFolder, true
}

// SetItemsInFolder sets field value
...
func (o PwmUserSharedFoldersResultsInner) MarshalJSON() ([]byte, error) {
...
func (o PwmUserSharedFoldersResultsInner) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AccessLevelId) {
		toSerialize["accessLevelId"] = o.AccessLevelId
	}
	...
	toSerialize["id"] = o.Id
	toSerialize["itemsInFolder"] = o.ItemsInFolder
	...
	toSerialize["usersWithAccess"] = o.UsersWithAccess
...
func (o *PwmUserSharedFoldersResultsInner) UnmarshalJSON(bytes []byte) (err error) {
	varPwmUserSharedFoldersResultsInner := _PwmUserSharedFoldersResultsInner{}

	if err = json.Unmarshal(bytes, &varPwmUserSharedFoldersResultsInner); err == nil {
		*o = PwmUserSharedFoldersResultsInner(varPwmUserSharedFoldersResultsInner)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "accessLevelId")
		delete(additionalProperties, "accessLevelName")
		delete(additionalProperties, "createdAt")
		delete(additionalProperties, "id")
		delete(additionalProperties, "itemsInFolder")
		delete(additionalProperties, "name")
		delete(additionalProperties, "passwordsScore")
		delete(additionalProperties, "scoreUpdatedAt")
		delete(additionalProperties, "usersWithAccess")
...
type NullablePwmUserSharedFoldersResultsInner struct {
	value *PwmUserSharedFoldersResultsInner
	isSet bool
}

func (v NullablePwmUserSharedFoldersResultsInner) Get() *PwmUserSharedFoldersResultsInner {
	return v.value
}

func (v *NullablePwmUserSharedFoldersResultsInner) Set(val *PwmUserSharedFoldersResultsInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePwmUserSharedFoldersResultsInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePwmUserSharedFoldersResultsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePwmUserSharedFoldersResultsInner(val *PwmUserSharedFoldersResultsInner) *NullablePwmUserSharedFoldersResultsInner {
	return &NullablePwmUserSharedFoldersResultsInner{value: val, isSet: true}
}

func (v NullablePwmUserSharedFoldersResultsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePwmUserSharedFoldersResultsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
