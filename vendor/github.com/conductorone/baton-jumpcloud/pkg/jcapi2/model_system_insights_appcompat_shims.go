...
// checks if the SystemInsightsAppcompatShims type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemInsightsAppcompatShims{}

// SystemInsightsAppcompatShims struct for SystemInsightsAppcompatShims
type SystemInsightsAppcompatShims struct {
	CollectionTime *string `json:"collection_time,omitempty"`
	Description *string `json:"description,omitempty"`
	Executable *string `json:"executable,omitempty"`
	InstallTime *float32 `json:"install_time,omitempty"`
	Path *string `json:"path,omitempty"`
	SdbId *string `json:"sdb_id,omitempty"`
	SystemId *string `json:"system_id,omitempty"`
	Type *string `json:"type,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _SystemInsightsAppcompatShims SystemInsightsAppcompatShims
...
func NewSystemInsightsAppcompatShims() *SystemInsightsAppcompatShims {
	this := SystemInsightsAppcompatShims{}
	return &this
}
...
// SetInstallTime gets a reference to the given float32 and assigns it to the InstallTime field.
...
// GetSdbId returns the SdbId field value if set, zero value otherwise.
func (o *SystemInsightsAppcompatShims) GetSdbId() string {
	if o == nil || IsNil(o.SdbId) {
		var ret string
		return ret
	}
	return *o.SdbId
...
// GetSdbIdOk returns a tuple with the SdbId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SystemInsightsAppcompatShims) GetSdbIdOk() (*string, bool) {
	if o == nil || IsNil(o.SdbId) {
		return nil, false
	}
	return o.SdbId, true
...
// SetSdbId gets a reference to the given string and assigns it to the SdbId field.
...
func (o *SystemInsightsAppcompatShims) SetType(v string) {
	o.Type = &v
}

func (o SystemInsightsAppcompatShims) MarshalJSON() ([]byte, error) {
...
func (o SystemInsightsAppcompatShims) ToMap() (map[string]interface{}, error) {
...
func (o *SystemInsightsAppcompatShims) UnmarshalJSON(bytes []byte) (err error) {
	varSystemInsightsAppcompatShims := _SystemInsightsAppcompatShims{}

	if err = json.Unmarshal(bytes, &varSystemInsightsAppcompatShims); err == nil {
		*o = SystemInsightsAppcompatShims(varSystemInsightsAppcompatShims)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "sdb_id")
...
type NullableSystemInsightsAppcompatShims struct {
	value *SystemInsightsAppcompatShims
	isSet bool
}

func (v NullableSystemInsightsAppcompatShims) Get() *SystemInsightsAppcompatShims {
	return v.value
}

func (v *NullableSystemInsightsAppcompatShims) Set(val *SystemInsightsAppcompatShims) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemInsightsAppcompatShims) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemInsightsAppcompatShims) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemInsightsAppcompatShims(val *SystemInsightsAppcompatShims) *NullableSystemInsightsAppcompatShims {
	return &NullableSystemInsightsAppcompatShims{value: val, isSet: true}
}

func (v NullableSystemInsightsAppcompatShims) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemInsightsAppcompatShims) UnmarshalJSON(src []byte) error {
	v.isSet = true
