...
type _CloudInsightsAccountGet CloudInsightsAccountGet
...
func (o *CloudInsightsAccountGet) UnmarshalJSON(bytes []byte) (err error) {
	varCloudInsightsAccountGet := _CloudInsightsAccountGet{}

	if err = json.Unmarshal(bytes, &varCloudInsightsAccountGet); err == nil {
		*o = CloudInsightsAccountGet(varCloudInsightsAccountGet)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "awsAccountIsActivated")
		delete(additionalProperties, "awsAccountIsValidated")
		delete(additionalProperties, "awsAccountRegion")
		delete(additionalProperties, "awsAccountRoleArn")
		delete(additionalProperties, "awsAccountRoleExternalId")
		delete(additionalProperties, "createdAt")
		delete(additionalProperties, "lastEventReceivedAt")
		delete(additionalProperties, "objectId")
		delete(additionalProperties, "organizationObjectId")
		delete(additionalProperties, "sqsQueueName")
