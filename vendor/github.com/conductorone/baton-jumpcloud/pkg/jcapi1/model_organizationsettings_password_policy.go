...
// checks if the OrganizationsettingsPasswordPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationsettingsPasswordPolicy{}
...
type _OrganizationsettingsPasswordPolicy OrganizationsettingsPasswordPolicy
...
func NewOrganizationsettingsPasswordPolicy() *OrganizationsettingsPasswordPolicy {
	this := OrganizationsettingsPasswordPolicy{}
	return &this
}
...
func (o *OrganizationsettingsPasswordPolicy) GetEnableRecoveryEmail() bool {
	if o == nil || IsNil(o.EnableRecoveryEmail) {
		var ret bool
		return ret
	}
	return *o.EnableRecoveryEmail
}

// GetEnableRecoveryEmailOk returns a tuple with the EnableRecoveryEmail field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OrganizationsettingsPasswordPolicy) GetEnableRecoveryEmailOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableRecoveryEmail) {
		return nil, false
	}
	return o.EnableRecoveryEmail, true
}
...
func (o *OrganizationsettingsPasswordPolicy) GetEnableResetLockoutCounter() bool {
	if o == nil || IsNil(o.EnableResetLockoutCounter) {
		var ret bool
		return ret
	}
	return *o.EnableResetLockoutCounter
}

// GetEnableResetLockoutCounterOk returns a tuple with the EnableResetLockoutCounter field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OrganizationsettingsPasswordPolicy) GetEnableResetLockoutCounterOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableResetLockoutCounter) {
		return nil, false
	}
	return o.EnableResetLockoutCounter, true
}
...
func (o *OrganizationsettingsPasswordPolicy) GetResetLockoutCounterMinutes() int32 {
	if o == nil || IsNil(o.ResetLockoutCounterMinutes) {
		var ret int32
		return ret
	}
	return *o.ResetLockoutCounterMinutes
}

// GetResetLockoutCounterMinutesOk returns a tuple with the ResetLockoutCounterMinutes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OrganizationsettingsPasswordPolicy) GetResetLockoutCounterMinutesOk() (*int32, bool) {
	if o == nil || IsNil(o.ResetLockoutCounterMinutes) {
		return nil, false
	}
	return o.ResetLockoutCounterMinutes, true
}
...
func (o *OrganizationsettingsPasswordPolicy) SetResetLockoutCounterMinutes(v int32) {
	o.ResetLockoutCounterMinutes = &v
}
...
func (o OrganizationsettingsPasswordPolicy) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.EnableRecoveryEmail) {
		toSerialize["enableRecoveryEmail"] = o.EnableRecoveryEmail
	}
	if !IsNil(o.EnableResetLockoutCounter) {
		toSerialize["enableResetLockoutCounter"] = o.EnableResetLockoutCounter
	}
	...
	if !IsNil(o.ResetLockoutCounterMinutes) {
		toSerialize["resetLockoutCounterMinutes"] = o.ResetLockoutCounterMinutes
	}
...
func (o *OrganizationsettingsPasswordPolicy) UnmarshalJSON(bytes []byte) (err error) {
	varOrganizationsettingsPasswordPolicy := _OrganizationsettingsPasswordPolicy{}

	if err = json.Unmarshal(bytes, &varOrganizationsettingsPasswordPolicy); err == nil {
		*o = OrganizationsettingsPasswordPolicy(varOrganizationsettingsPasswordPolicy)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "enableRecoveryEmail")
		delete(additionalProperties, "enableResetLockoutCounter")
		...
		delete(additionalProperties, "resetLockoutCounterMinutes")
...
type NullableOrganizationsettingsPasswordPolicy struct {
	value *OrganizationsettingsPasswordPolicy
	isSet bool
}
...
func NewNullableOrganizationsettingsPasswordPolicy(val *OrganizationsettingsPasswordPolicy) *NullableOrganizationsettingsPasswordPolicy {
	return &NullableOrganizationsettingsPasswordPolicy{value: val, isSet: true}
}
