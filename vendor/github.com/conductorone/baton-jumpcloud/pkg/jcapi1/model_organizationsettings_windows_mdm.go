...
// checks if the OrganizationsettingsWindowsMDM type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationsettingsWindowsMDM{}
...
type _OrganizationsettingsWindowsMDM OrganizationsettingsWindowsMDM
...
func (o *OrganizationsettingsWindowsMDM) UnmarshalJSON(bytes []byte) (err error) {
	varOrganizationsettingsWindowsMDM := _OrganizationsettingsWindowsMDM{}

	if err = json.Unmarshal(bytes, &varOrganizationsettingsWindowsMDM); err == nil {
		*o = OrganizationsettingsWindowsMDM(varOrganizationsettingsWindowsMDM)
	}
...
type NullableOrganizationsettingsWindowsMDM struct {
	value *OrganizationsettingsWindowsMDM
	isSet bool
}
...
func NewNullableOrganizationsettingsWindowsMDM(val *OrganizationsettingsWindowsMDM) *NullableOrganizationsettingsWindowsMDM {
	return &NullableOrganizationsettingsWindowsMDM{value: val, isSet: true}
}
