...
// checks if the SystemusersResetmfaRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemusersResetmfaRequest{}
...
type _SystemusersResetmfaRequest SystemusersResetmfaRequest
...
func NewSystemusersResetmfaRequest() *SystemusersResetmfaRequest {
	this := SystemusersResetmfaRequest{}
	return &this
}
...
func (o *SystemusersResetmfaRequest) GetExclusionDays() float32 {
	if o == nil || IsNil(o.ExclusionDays) {
		var ret float32
		return ret
	}
	return *o.ExclusionDays
}

// GetExclusionDaysOk returns a tuple with the ExclusionDays field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SystemusersResetmfaRequest) GetExclusionDaysOk() (*float32, bool) {
	if o == nil || IsNil(o.ExclusionDays) {
		return nil, false
	}
	return o.ExclusionDays, true
}
...
func (o *SystemusersResetmfaRequest) GetExclusionUntil() time.Time {
	if o == nil || IsNil(o.ExclusionUntil) {
		var ret time.Time
		return ret
	}
	return *o.ExclusionUntil
}

// GetExclusionUntilOk returns a tuple with the ExclusionUntil field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SystemusersResetmfaRequest) GetExclusionUntilOk() (*time.Time, bool) {
	if o == nil || IsNil(o.ExclusionUntil) {
		return nil, false
	}
	return o.ExclusionUntil, true
}
...
func (o SystemusersResetmfaRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ExclusionDays) {
		toSerialize["exclusionDays"] = o.ExclusionDays
	}
	if !IsNil(o.ExclusionUntil) {
		toSerialize["exclusionUntil"] = o.ExclusionUntil
	}
...
func (o *SystemusersResetmfaRequest) UnmarshalJSON(bytes []byte) (err error) {
	varSystemusersResetmfaRequest := _SystemusersResetmfaRequest{}

	if err = json.Unmarshal(bytes, &varSystemusersResetmfaRequest); err == nil {
		*o = SystemusersResetmfaRequest(varSystemusersResetmfaRequest)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "exclusion")
		delete(additionalProperties, "exclusionDays")
		delete(additionalProperties, "exclusionUntil")
...
type NullableSystemusersResetmfaRequest struct {
	value *SystemusersResetmfaRequest
	isSet bool
}
...
func NewNullableSystemusersResetmfaRequest(val *SystemusersResetmfaRequest) *NullableSystemusersResetmfaRequest {
	return &NullableSystemusersResetmfaRequest{value: val, isSet: true}
}
