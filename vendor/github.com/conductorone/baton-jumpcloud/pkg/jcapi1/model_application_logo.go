...
// checks if the ApplicationLogo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationLogo{}
...
type _ApplicationLogo ApplicationLogo
...
func (o *ApplicationLogo) UnmarshalJSON(bytes []byte) (err error) {
	varApplicationLogo := _ApplicationLogo{}

	if err = json.Unmarshal(bytes, &varApplicationLogo); err == nil {
		*o = ApplicationLogo(varApplicationLogo)
	}
...
func NewNullableApplicationLogo(val *ApplicationLogo) *NullableApplicationLogo {
	return &NullableApplicationLogo{value: val, isSet: true}
}
