...
func (r ManagedServiceProviderApiAdminTotpresetBeginRequest) Execute() (*http.Response, error) {
	return r.ApiService.AdminTotpresetBeginExecute(r)
}
...
func (a *ManagedServiceProviderApiService) AdminTotpresetBeginExecute(r ManagedServiceProviderApiAdminTotpresetBeginRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ManagedServiceProviderApiService.AdminTotpresetBegin")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/users/resettotp/{id}"
...
func (a *ManagedServiceProviderApiService) OrganizationListExecute(r ManagedServiceProviderApiOrganizationListRequest) (*Organizationslist, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ManagedServiceProviderApiService.OrganizationList")
	if err != nil {
	...
	if r.sortIgnoreCase != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "sortIgnoreCase", r.sortIgnoreCase, "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (a *ManagedServiceProviderApiService) UsersPutExecute(r ManagedServiceProviderApiUsersPutRequest) (*Userreturn, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ManagedServiceProviderApiService.UsersPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ManagedServiceProviderApiUsersReactivateGetRequest) Execute() (*http.Response, error) {
	return r.ApiService.UsersReactivateGetExecute(r)
}
...
func (a *ManagedServiceProviderApiService) UsersReactivateGetExecute(r ManagedServiceProviderApiUsersReactivateGetRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ManagedServiceProviderApiService.UsersReactivateGet")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/users/reactivate/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
