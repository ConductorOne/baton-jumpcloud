...
// checks if the SystemOsVersionDetail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemOsVersionDetail{}
...
type _SystemOsVersionDetail SystemOsVersionDetail
...
func (o *SystemOsVersionDetail) UnmarshalJSON(bytes []byte) (err error) {
	varSystemOsVersionDetail := _SystemOsVersionDetail{}

	if err = json.Unmarshal(bytes, &varSystemOsVersionDetail); err == nil {
		*o = SystemOsVersionDetail(varSystemOsVersionDetail)
	}
...
func NewNullableSystemOsVersionDetail(val *SystemOsVersionDetail) *NullableSystemOsVersionDetail {
	return &NullableSystemOsVersionDetail{value: val, isSet: true}
}
