...
// checks if the ApplicationConfigAcsUrlTooltipVariables type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationConfigAcsUrlTooltipVariables{}
...
type _ApplicationConfigAcsUrlTooltipVariables ApplicationConfigAcsUrlTooltipVariables
...
func NewApplicationConfigAcsUrlTooltipVariables() *ApplicationConfigAcsUrlTooltipVariables {
	this := ApplicationConfigAcsUrlTooltipVariables{}
	return &this
}
...
func (o *ApplicationConfigAcsUrlTooltipVariables) UnmarshalJSON(bytes []byte) (err error) {
	varApplicationConfigAcsUrlTooltipVariables := _ApplicationConfigAcsUrlTooltipVariables{}

	if err = json.Unmarshal(bytes, &varApplicationConfigAcsUrlTooltipVariables); err == nil {
		*o = ApplicationConfigAcsUrlTooltipVariables(varApplicationConfigAcsUrlTooltipVariables)
	}
...
type NullableApplicationConfigAcsUrlTooltipVariables struct {
	value *ApplicationConfigAcsUrlTooltipVariables
	isSet bool
}
...
func NewNullableApplicationConfigAcsUrlTooltipVariables(val *ApplicationConfigAcsUrlTooltipVariables) *NullableApplicationConfigAcsUrlTooltipVariables {
	return &NullableApplicationConfigAcsUrlTooltipVariables{value: val, isSet: true}
}
