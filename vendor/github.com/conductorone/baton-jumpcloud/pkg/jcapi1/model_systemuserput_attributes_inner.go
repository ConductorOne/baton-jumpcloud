...
// checks if the SystemuserputAttributesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemuserputAttributesInner{}
...
type _SystemuserputAttributesInner SystemuserputAttributesInner
...
func NewSystemuserputAttributesInner() *SystemuserputAttributesInner {
	this := SystemuserputAttributesInner{}
	return &this
}
...
func (o *SystemuserputAttributesInner) UnmarshalJSON(bytes []byte) (err error) {
	varSystemuserputAttributesInner := _SystemuserputAttributesInner{}

	if err = json.Unmarshal(bytes, &varSystemuserputAttributesInner); err == nil {
		*o = SystemuserputAttributesInner(varSystemuserputAttributesInner)
	}
...
type NullableSystemuserputAttributesInner struct {
	value *SystemuserputAttributesInner
	isSet bool
}
...
func NewNullableSystemuserputAttributesInner(val *SystemuserputAttributesInner) *NullableSystemuserputAttributesInner {
	return &NullableSystemuserputAttributesInner{value: val, isSet: true}
}
