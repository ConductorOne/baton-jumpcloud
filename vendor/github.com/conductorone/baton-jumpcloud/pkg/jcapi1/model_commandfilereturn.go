...
// checks if the Commandfilereturn type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Commandfilereturn{}
...
type _Commandfilereturn Commandfilereturn
...
func (o *Commandfilereturn) GetResults() []CommandfilereturnResultsInner {
	if o == nil || IsNil(o.Results) {
		var ret []CommandfilereturnResultsInner
		return ret
	}
	return o.Results
}
...
func (o *Commandfilereturn) UnmarshalJSON(bytes []byte) (err error) {
	varCommandfilereturn := _Commandfilereturn{}

	if err = json.Unmarshal(bytes, &varCommandfilereturn); err == nil {
		*o = Commandfilereturn(varCommandfilereturn)
	}
...
func NewNullableCommandfilereturn(val *Commandfilereturn) *NullableCommandfilereturn {
	return &NullableCommandfilereturn{value: val, isSet: true}
}
