...
func (r OrganizationsApiOrganizationPutRequest) Body(body OrganizationPutRequest) OrganizationsApiOrganizationPutRequest {
	r.body = &body
	return r
}

func (r OrganizationsApiOrganizationPutRequest) Execute() (*Organization, *http.Response, error) {
	return r.ApiService.OrganizationPutExecute(r)
}
...
func (a *OrganizationsApiService) OrganizationPutExecute(r OrganizationsApiOrganizationPutRequest) (*Organization, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrganizationsApiService.OrganizationPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
