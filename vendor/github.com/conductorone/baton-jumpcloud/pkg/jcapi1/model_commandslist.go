...
// checks if the Commandslist type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Commandslist{}
...
type _Commandslist Commandslist
...
func (o *Commandslist) GetResults() []CommandslistResultsInner {
	if o == nil || IsNil(o.Results) {
		var ret []CommandslistResultsInner
		return ret
	}
	return o.Results
}
...
func (o *Commandslist) UnmarshalJSON(bytes []byte) (err error) {
	varCommandslist := _Commandslist{}

	if err = json.Unmarshal(bytes, &varCommandslist); err == nil {
		*o = Commandslist(varCommandslist)
	}
...
func NewNullableCommandslist(val *Commandslist) *NullableCommandslist {
	return &NullableCommandslist{value: val, isSet: true}
}
