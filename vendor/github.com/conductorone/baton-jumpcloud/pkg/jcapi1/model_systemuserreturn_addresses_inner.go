...
// checks if the SystemuserreturnAddressesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemuserreturnAddressesInner{}
...
type _SystemuserreturnAddressesInner SystemuserreturnAddressesInner
...
func NewSystemuserreturnAddressesInner() *SystemuserreturnAddressesInner {
	this := SystemuserreturnAddressesInner{}
	return &this
}
...
func (o *SystemuserreturnAddressesInner) UnmarshalJSON(bytes []byte) (err error) {
	varSystemuserreturnAddressesInner := _SystemuserreturnAddressesInner{}

	if err = json.Unmarshal(bytes, &varSystemuserreturnAddressesInner); err == nil {
		*o = SystemuserreturnAddressesInner(varSystemuserreturnAddressesInner)
	}
...
type NullableSystemuserreturnAddressesInner struct {
	value *SystemuserreturnAddressesInner
	isSet bool
}
...
func NewNullableSystemuserreturnAddressesInner(val *SystemuserreturnAddressesInner) *NullableSystemuserreturnAddressesInner {
	return &NullableSystemuserreturnAddressesInner{value: val, isSet: true}
}
