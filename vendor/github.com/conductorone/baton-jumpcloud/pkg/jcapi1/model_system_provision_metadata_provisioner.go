...
// checks if the SystemProvisionMetadataProvisioner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemProvisionMetadataProvisioner{}
...
type _SystemProvisionMetadataProvisioner SystemProvisionMetadataProvisioner
...
func NewSystemProvisionMetadataProvisioner() *SystemProvisionMetadataProvisioner {
	this := SystemProvisionMetadataProvisioner{}
	var type_ string = "administrator"
	this.Type = &type_
	return &this
}
...
func (o *SystemProvisionMetadataProvisioner) GetProvisionerId() string {
	if o == nil || IsNil(o.ProvisionerId) {
		var ret string
		return ret
	}
	return *o.ProvisionerId
}
...
func (o SystemProvisionMetadataProvisioner) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ProvisionerId) {
		toSerialize["provisionerId"] = o.ProvisionerId
	}
	if !IsNil(o.Type) {
...
func (o *SystemProvisionMetadataProvisioner) UnmarshalJSON(bytes []byte) (err error) {
	varSystemProvisionMetadataProvisioner := _SystemProvisionMetadataProvisioner{}

	if err = json.Unmarshal(bytes, &varSystemProvisionMetadataProvisioner); err == nil {
		*o = SystemProvisionMetadataProvisioner(varSystemProvisionMetadataProvisioner)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "provisionerId")
...
type NullableSystemProvisionMetadataProvisioner struct {
	value *SystemProvisionMetadataProvisioner
	isSet bool
}
...
func NewNullableSystemProvisionMetadataProvisioner(val *SystemProvisionMetadataProvisioner) *NullableSystemProvisionMetadataProvisioner {
	return &NullableSystemProvisionMetadataProvisioner{value: val, isSet: true}
}
