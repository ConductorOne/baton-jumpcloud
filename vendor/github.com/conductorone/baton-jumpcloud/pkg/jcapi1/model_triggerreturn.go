...
// checks if the Triggerreturn type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Triggerreturn{}
...
type _Triggerreturn Triggerreturn
...
func (o *Triggerreturn) UnmarshalJSON(bytes []byte) (err error) {
	varTriggerreturn := _Triggerreturn{}

	if err = json.Unmarshal(bytes, &varTriggerreturn); err == nil {
		*o = Triggerreturn(varTriggerreturn)
	}
...
func NewNullableTriggerreturn(val *Triggerreturn) *NullableTriggerreturn {
	return &NullableTriggerreturn{value: val, isSet: true}
}
