...
// checks if the SystemputAgentBoundMessagesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemputAgentBoundMessagesInner{}
...
type _SystemputAgentBoundMessagesInner SystemputAgentBoundMessagesInner
...
func NewSystemputAgentBoundMessagesInner() *SystemputAgentBoundMessagesInner {
	this := SystemputAgentBoundMessagesInner{}
	return &this
}
...
func (o *SystemputAgentBoundMessagesInner) UnmarshalJSON(bytes []byte) (err error) {
	varSystemputAgentBoundMessagesInner := _SystemputAgentBoundMessagesInner{}

	if err = json.Unmarshal(bytes, &varSystemputAgentBoundMessagesInner); err == nil {
		*o = SystemputAgentBoundMessagesInner(varSystemputAgentBoundMessagesInner)
	}
...
type NullableSystemputAgentBoundMessagesInner struct {
	value *SystemputAgentBoundMessagesInner
	isSet bool
}
...
func NewNullableSystemputAgentBoundMessagesInner(val *SystemputAgentBoundMessagesInner) *NullableSystemputAgentBoundMessagesInner {
	return &NullableSystemputAgentBoundMessagesInner{value: val, isSet: true}
}
