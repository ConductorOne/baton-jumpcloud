...
func (v *MfaEnrollmentStatus) UnmarshalJSON(src []byte) error {
	...
	enumTypeValue := MfaEnrollmentStatus(value)
	for _, existing := range AllowedMfaEnrollmentStatusEnumValues {
	...
	return fmt.Errorf("%+v is not a valid MfaEnrollmentStatus", value)
}

// NewMfaEnrollmentStatusFromValue returns a pointer to a valid MfaEnrollmentStatus
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewMfaEnrollmentStatusFromValue(v string) (*MfaEnrollmentStatus, error) {
	ev := MfaEnrollmentStatus(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for MfaEnrollmentStatus: valid values are %v", v, AllowedMfaEnrollmentStatusEnumValues)
	}
}
...
func NewNullableMfaEnrollmentStatus(val *MfaEnrollmentStatus) *NullableMfaEnrollmentStatus {
	return &NullableMfaEnrollmentStatus{value: val, isSet: true}
}
