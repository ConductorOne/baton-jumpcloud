...
// checks if the OrganizationsettingsUserPortal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationsettingsUserPortal{}
...
type _OrganizationsettingsUserPortal OrganizationsettingsUserPortal
...
func NewOrganizationsettingsUserPortal() *OrganizationsettingsUserPortal {
	this := OrganizationsettingsUserPortal{}
	return &this
}
...
func (o *OrganizationsettingsUserPortal) GetIdleSessionDurationMinutes() int32 {
	if o == nil || IsNil(o.IdleSessionDurationMinutes) {
		var ret int32
		return ret
	}
	return *o.IdleSessionDurationMinutes
}

// GetIdleSessionDurationMinutesOk returns a tuple with the IdleSessionDurationMinutes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OrganizationsettingsUserPortal) GetIdleSessionDurationMinutesOk() (*int32, bool) {
	if o == nil || IsNil(o.IdleSessionDurationMinutes) {
		return nil, false
	}
	return o.IdleSessionDurationMinutes, true
}
...
func (o *OrganizationsettingsUserPortal) SetIdleSessionDurationMinutes(v int32) {
	o.IdleSessionDurationMinutes = &v
}
...
func (o OrganizationsettingsUserPortal) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IdleSessionDurationMinutes) {
		toSerialize["idleSessionDurationMinutes"] = o.IdleSessionDurationMinutes
	}
...
func (o *OrganizationsettingsUserPortal) UnmarshalJSON(bytes []byte) (err error) {
	varOrganizationsettingsUserPortal := _OrganizationsettingsUserPortal{}

	if err = json.Unmarshal(bytes, &varOrganizationsettingsUserPortal); err == nil {
		*o = OrganizationsettingsUserPortal(varOrganizationsettingsUserPortal)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "idleSessionDurationMinutes")
...
type NullableOrganizationsettingsUserPortal struct {
	value *OrganizationsettingsUserPortal
	isSet bool
}
...
func NewNullableOrganizationsettingsUserPortal(val *OrganizationsettingsUserPortal) *NullableOrganizationsettingsUserPortal {
	return &NullableOrganizationsettingsUserPortal{value: val, isSet: true}
}
