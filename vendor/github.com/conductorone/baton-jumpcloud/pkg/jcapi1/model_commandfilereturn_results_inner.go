...
// checks if the CommandfilereturnResultsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommandfilereturnResultsInner{}
...
type _CommandfilereturnResultsInner CommandfilereturnResultsInner
...
func NewCommandfilereturnResultsInner() *CommandfilereturnResultsInner {
	this := CommandfilereturnResultsInner{}
	return &this
}
...
func (o *CommandfilereturnResultsInner) UnmarshalJSON(bytes []byte) (err error) {
	varCommandfilereturnResultsInner := _CommandfilereturnResultsInner{}

	if err = json.Unmarshal(bytes, &varCommandfilereturnResultsInner); err == nil {
		*o = CommandfilereturnResultsInner(varCommandfilereturnResultsInner)
	}
...
type NullableCommandfilereturnResultsInner struct {
	value *CommandfilereturnResultsInner
	isSet bool
}
...
func NewNullableCommandfilereturnResultsInner(val *CommandfilereturnResultsInner) *NullableCommandfilereturnResultsInner {
	return &NullableCommandfilereturnResultsInner{value: val, isSet: true}
}
