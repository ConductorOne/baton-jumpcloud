...
// checks if the SuggestionCounts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SuggestionCounts{}

// SuggestionCounts struct for SuggestionCounts
...
type _SuggestionCounts SuggestionCounts
...
func (o SuggestionCounts) MarshalJSON() ([]byte, error) {
...
func (o SuggestionCounts) ToMap() (map[string]interface{}, error) {
...
func (o *SuggestionCounts) UnmarshalJSON(bytes []byte) (err error) {
	varSuggestionCounts := _SuggestionCounts{}

	if err = json.Unmarshal(bytes, &varSuggestionCounts); err == nil {
		*o = SuggestionCounts(varSuggestionCounts)
	}
...
type NullableSuggestionCounts struct {
	value *SuggestionCounts
	isSet bool
}

func (v NullableSuggestionCounts) Get() *SuggestionCounts {
	return v.value
}

func (v *NullableSuggestionCounts) Set(val *SuggestionCounts) {
	v.value = val
	v.isSet = true
}

func (v NullableSuggestionCounts) IsSet() bool {
	return v.isSet
}

func (v *NullableSuggestionCounts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSuggestionCounts(val *SuggestionCounts) *NullableSuggestionCounts {
	return &NullableSuggestionCounts{value: val, isSet: true}
}

func (v NullableSuggestionCounts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSuggestionCounts) UnmarshalJSON(src []byte) error {
	v.isSet = true
