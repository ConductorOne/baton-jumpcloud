...
// checks if the LdapserversPatch200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LdapserversPatch200Response{}

// LdapserversPatch200Response struct for LdapserversPatch200Response
type LdapserversPatch200Response struct {
...
type _LdapserversPatch200Response LdapserversPatch200Response
...
func NewLdapserversPatch200Response() *LdapserversPatch200Response {
	this := LdapserversPatch200Response{}
	return &this
}
...
// SetUserLockoutAction gets a reference to the given LdapServerAction and assigns it to the UserLockoutAction field.
...
// SetUserPasswordExpirationAction gets a reference to the given LdapServerAction and assigns it to the UserPasswordExpirationAction field.
func (o *LdapserversPatch200Response) SetUserPasswordExpirationAction(v LdapServerAction) {
	o.UserPasswordExpirationAction = &v
}

func (o LdapserversPatch200Response) MarshalJSON() ([]byte, error) {
...
func (o LdapserversPatch200Response) ToMap() (map[string]interface{}, error) {
...
func (o *LdapserversPatch200Response) UnmarshalJSON(bytes []byte) (err error) {
	varLdapserversPatch200Response := _LdapserversPatch200Response{}

	if err = json.Unmarshal(bytes, &varLdapserversPatch200Response); err == nil {
		*o = LdapserversPatch200Response(varLdapserversPatch200Response)
	}
...
type NullableLdapserversPatch200Response struct {
	value *LdapserversPatch200Response
	isSet bool
}

func (v NullableLdapserversPatch200Response) Get() *LdapserversPatch200Response {
	return v.value
}

func (v *NullableLdapserversPatch200Response) Set(val *LdapserversPatch200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableLdapserversPatch200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableLdapserversPatch200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLdapserversPatch200Response(val *LdapserversPatch200Response) *NullableLdapserversPatch200Response {
	return &NullableLdapserversPatch200Response{value: val, isSet: true}
}

func (v NullableLdapserversPatch200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLdapserversPatch200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
