...
// checks if the PolicyWithDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PolicyWithDetails{}

// PolicyWithDetails An instance of a policy template.
...
type _PolicyWithDetails PolicyWithDetails
...
// SetTemplate gets a reference to the given PolicyTemplate and assigns it to the Template field.
...
// SetValues gets a reference to the given []PolicyValue and assigns it to the Values field.
func (o *PolicyWithDetails) SetValues(v []PolicyValue) {
	o.Values = v
}

func (o PolicyWithDetails) MarshalJSON() ([]byte, error) {
...
func (o PolicyWithDetails) ToMap() (map[string]interface{}, error) {
...
func (o *PolicyWithDetails) UnmarshalJSON(bytes []byte) (err error) {
	varPolicyWithDetails := _PolicyWithDetails{}

	if err = json.Unmarshal(bytes, &varPolicyWithDetails); err == nil {
		*o = PolicyWithDetails(varPolicyWithDetails)
	}
...
type NullablePolicyWithDetails struct {
	value *PolicyWithDetails
	isSet bool
}

func (v NullablePolicyWithDetails) Get() *PolicyWithDetails {
	return v.value
}

func (v *NullablePolicyWithDetails) Set(val *PolicyWithDetails) {
	v.value = val
	v.isSet = true
}

func (v NullablePolicyWithDetails) IsSet() bool {
	return v.isSet
}

func (v *NullablePolicyWithDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePolicyWithDetails(val *PolicyWithDetails) *NullablePolicyWithDetails {
	return &NullablePolicyWithDetails{value: val, isSet: true}
}

func (v NullablePolicyWithDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePolicyWithDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
