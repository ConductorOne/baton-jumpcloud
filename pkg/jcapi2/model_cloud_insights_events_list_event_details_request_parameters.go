...
type _CloudInsightsEventsListEventDetailsRequestParameters CloudInsightsEventsListEventDetailsRequestParameters
...
func (o *CloudInsightsEventsListEventDetailsRequestParameters) UnmarshalJSON(bytes []byte) (err error) {
	varCloudInsightsEventsListEventDetailsRequestParameters := _CloudInsightsEventsListEventDetailsRequestParameters{}

	if err = json.Unmarshal(bytes, &varCloudInsightsEventsListEventDetailsRequestParameters); err == nil {
		*o = CloudInsightsEventsListEventDetailsRequestParameters(varCloudInsightsEventsListEventDetailsRequestParameters)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "certificateArn")
		delete(additionalProperties, "cluster")
		delete(additionalProperties, "complianceTypes")
		delete(additionalProperties, "configRuleName")
		delete(additionalProperties, "durationSeconds")
		delete(additionalProperties, "encryptionAlgorithm")
		delete(additionalProperties, "encryptionContext")
		delete(additionalProperties, "externalId")
		delete(additionalProperties, "include")
		delete(additionalProperties, "includeDeletedResponses")
		delete(additionalProperties, "includePublic")
		delete(additionalProperties, "includeShared")
		...
		delete(additionalProperties, "principalArn")
		delete(additionalProperties, "resourceType")
		delete(additionalProperties, "resultToken")
		delete(additionalProperties, "roleArn")
		delete(additionalProperties, "roleSessionName")
		delete(additionalProperties, "sAMLAssertionID")
		delete(additionalProperties, "services")
		delete(additionalProperties, "status")
		delete(additionalProperties, "testMode")
