...
// checks if the WorkdayFields type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkdayFields{}

// WorkdayFields struct for WorkdayFields
...
type _WorkdayFields WorkdayFields
...
func (o WorkdayFields) MarshalJSON() ([]byte, error) {
...
func (o WorkdayFields) ToMap() (map[string]interface{}, error) {
...
func (o *WorkdayFields) UnmarshalJSON(bytes []byte) (err error) {
	varWorkdayFields := _WorkdayFields{}

	if err = json.Unmarshal(bytes, &varWorkdayFields); err == nil {
		*o = WorkdayFields(varWorkdayFields)
	}
...
type NullableWorkdayFields struct {
	value *WorkdayFields
	isSet bool
}

func (v NullableWorkdayFields) Get() *WorkdayFields {
	return v.value
}

func (v *NullableWorkdayFields) Set(val *WorkdayFields) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkdayFields) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkdayFields) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkdayFields(val *WorkdayFields) *NullableWorkdayFields {
	return &NullableWorkdayFields{value: val, isSet: true}
}

func (v NullableWorkdayFields) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkdayFields) UnmarshalJSON(src []byte) error {
	v.isSet = true
