...
// checks if the BulkUserUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkUserUpdate{}

// BulkUserUpdate See [V1 system user update](https://docs.jumpcloud.com/api/1.0/index.html#operation/systemusers_put) for full list of attributes.
...
type _BulkUserUpdate BulkUserUpdate
...
func (o BulkUserUpdate) MarshalJSON() ([]byte, error) {
...
func (o BulkUserUpdate) ToMap() (map[string]interface{}, error) {
...
func (o *BulkUserUpdate) UnmarshalJSON(bytes []byte) (err error) {
	varBulkUserUpdate := _BulkUserUpdate{}

	if err = json.Unmarshal(bytes, &varBulkUserUpdate); err == nil {
		*o = BulkUserUpdate(varBulkUserUpdate)
	}
...
type NullableBulkUserUpdate struct {
	value *BulkUserUpdate
	isSet bool
}

func (v NullableBulkUserUpdate) Get() *BulkUserUpdate {
	return v.value
}

func (v *NullableBulkUserUpdate) Set(val *BulkUserUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkUserUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkUserUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkUserUpdate(val *BulkUserUpdate) *NullableBulkUserUpdate {
	return &NullableBulkUserUpdate{value: val, isSet: true}
}

func (v NullableBulkUserUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkUserUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
