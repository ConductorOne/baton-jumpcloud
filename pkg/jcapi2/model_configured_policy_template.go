...
// checks if the ConfiguredPolicyTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfiguredPolicyTemplate{}

// ConfiguredPolicyTemplate struct for ConfiguredPolicyTemplate
type ConfiguredPolicyTemplate struct {
	Id *string `json:"id,omitempty"`
	Name *string `json:"name,omitempty"`
	PolicyTemplateId *string `json:"policyTemplateId,omitempty"`
	Values []ConfiguredPolicyTemplateValue `json:"values,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ConfiguredPolicyTemplate ConfiguredPolicyTemplate
...
func (o *ConfiguredPolicyTemplate) GetValues() []ConfiguredPolicyTemplateValue {
	if o == nil || IsNil(o.Values) {
		var ret []ConfiguredPolicyTemplateValue
		return ret
	}
	return o.Values
}
...
// SetValues gets a reference to the given []ConfiguredPolicyTemplateValue and assigns it to the Values field.
func (o *ConfiguredPolicyTemplate) SetValues(v []ConfiguredPolicyTemplateValue) {
	o.Values = v
}

func (o ConfiguredPolicyTemplate) MarshalJSON() ([]byte, error) {
...
func (o ConfiguredPolicyTemplate) ToMap() (map[string]interface{}, error) {
...
func (o *ConfiguredPolicyTemplate) UnmarshalJSON(bytes []byte) (err error) {
	varConfiguredPolicyTemplate := _ConfiguredPolicyTemplate{}

	if err = json.Unmarshal(bytes, &varConfiguredPolicyTemplate); err == nil {
		*o = ConfiguredPolicyTemplate(varConfiguredPolicyTemplate)
	}
...
type NullableConfiguredPolicyTemplate struct {
	value *ConfiguredPolicyTemplate
	isSet bool
}

func (v NullableConfiguredPolicyTemplate) Get() *ConfiguredPolicyTemplate {
	return v.value
}

func (v *NullableConfiguredPolicyTemplate) Set(val *ConfiguredPolicyTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableConfiguredPolicyTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableConfiguredPolicyTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfiguredPolicyTemplate(val *ConfiguredPolicyTemplate) *NullableConfiguredPolicyTemplate {
	return &NullableConfiguredPolicyTemplate{value: val, isSet: true}
}

func (v NullableConfiguredPolicyTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfiguredPolicyTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true
