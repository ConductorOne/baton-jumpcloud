...
*/
func (a *PolicyGroupsApiService) GraphPolicyGroupAssociationsList(ctx context.Context, groupId string) ApiGraphPolicyGroupAssociationsListRequest {
	return ApiGraphPolicyGroupAssociationsListRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
func (a *PolicyGroupsApiService) GraphPolicyGroupAssociationsListExecute(r ApiGraphPolicyGroupAssociationsListRequest) ([]GraphConnection, *http.Response, error) {
	var (
...
*/
func (a *PolicyGroupsApiService) GraphPolicyGroupAssociationsPost(ctx context.Context, groupId string) ApiGraphPolicyGroupAssociationsPostRequest {
	return ApiGraphPolicyGroupAssociationsPostRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
func (a *PolicyGroupsApiService) GraphPolicyGroupAssociationsPostExecute(r ApiGraphPolicyGroupAssociationsPostRequest) (*http.Response, error) {
	var (
...
*/
func (a *PolicyGroupsApiService) GraphPolicyGroupMembersList(ctx context.Context, groupId string) ApiGraphPolicyGroupMembersListRequest {
	return ApiGraphPolicyGroupMembersListRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
//  @return []GraphConnection
func (a *PolicyGroupsApiService) GraphPolicyGroupMembersListExecute(r ApiGraphPolicyGroupMembersListRequest) ([]GraphConnection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *PolicyGroupsApiService) GraphPolicyGroupMembersPost(ctx context.Context, groupId string) ApiGraphPolicyGroupMembersPostRequest {
	return ApiGraphPolicyGroupMembersPostRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
func (a *PolicyGroupsApiService) GraphPolicyGroupMembersPostExecute(r ApiGraphPolicyGroupMembersPostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *PolicyGroupsApiService) GraphPolicyGroupMembership(ctx context.Context, groupId string) ApiGraphPolicyGroupMembershipRequest {
	return ApiGraphPolicyGroupMembershipRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
func (a *PolicyGroupsApiService) GraphPolicyGroupMembershipExecute(r ApiGraphPolicyGroupMembershipRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *PolicyGroupsApiService) GraphPolicyGroupTraverseSystem(ctx context.Context, groupId string) ApiGraphPolicyGroupTraverseSystemRequest {
	return ApiGraphPolicyGroupTraverseSystemRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
//  @return []GraphObjectWithPaths
func (a *PolicyGroupsApiService) GraphPolicyGroupTraverseSystemExecute(r ApiGraphPolicyGroupTraverseSystemRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *PolicyGroupsApiService) GraphPolicyGroupTraverseSystemGroup(ctx context.Context, groupId string) ApiGraphPolicyGroupTraverseSystemGroupRequest {
	return ApiGraphPolicyGroupTraverseSystemGroupRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
//  @return []GraphObjectWithPaths
func (a *PolicyGroupsApiService) GraphPolicyGroupTraverseSystemGroupExecute(r ApiGraphPolicyGroupTraverseSystemGroupRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGroupsPolicyDeleteRequest struct {
	ctx context.Context
	ApiService *PolicyGroupsApiService
	id string
	xOrgId *string
...
// Organization identifier that can be obtained from console settings.
func (r ApiGroupsPolicyDeleteRequest) XOrgId(xOrgId string) ApiGroupsPolicyDeleteRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiGroupsPolicyDeleteRequest) Execute() (*PolicyGroup, *http.Response, error) {
...
```
 ...
 @return ApiGroupsPolicyDeleteRequest
*/
func (a *PolicyGroupsApiService) GroupsPolicyDelete(ctx context.Context, id string) ApiGroupsPolicyDeleteRequest {
	return ApiGroupsPolicyDeleteRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return PolicyGroup
func (a *PolicyGroupsApiService) GroupsPolicyDeleteExecute(r ApiGroupsPolicyDeleteRequest) (*PolicyGroup, *http.Response, error) {
	var (
...
type ApiGroupsPolicyGetRequest struct {
	ctx context.Context
	ApiService *PolicyGroupsApiService
	id string
	xOrgId *string
...
// Organization identifier that can be obtained from console settings.
func (r ApiGroupsPolicyGetRequest) XOrgId(xOrgId string) ApiGroupsPolicyGetRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiGroupsPolicyGetRequest) Execute() (*PolicyGroup, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id ObjectID of the Policy Group.
 @return ApiGroupsPolicyGetRequest
*/
func (a *PolicyGroupsApiService) GroupsPolicyGet(ctx context.Context, id string) ApiGroupsPolicyGetRequest {
	return ApiGroupsPolicyGetRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return PolicyGroup
func (a *PolicyGroupsApiService) GroupsPolicyGetExecute(r ApiGroupsPolicyGetRequest) (*PolicyGroup, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGroupsPolicyListRequest struct {
	ctx context.Context
	ApiService *PolicyGroupsApiService
	fields *[]string
	filter *[]string
...
func (r ApiGroupsPolicyListRequest) Fields(fields []string) ApiGroupsPolicyListRequest {
	r.fields = &fields
	return r
}

// A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
func (r ApiGroupsPolicyListRequest) Filter(filter []string) ApiGroupsPolicyListRequest {
	r.filter = &filter
	return r
}

// The number of records to return at once. Limited to 100.
func (r ApiGroupsPolicyListRequest) Limit(limit int32) ApiGroupsPolicyListRequest {
	r.limit = &limit
	return r
}

// The offset into the records to return.
func (r ApiGroupsPolicyListRequest) Skip(skip int32) ApiGroupsPolicyListRequest {
	r.skip = &skip
	return r
}

// The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. 
func (r ApiGroupsPolicyListRequest) Sort(sort []string) ApiGroupsPolicyListRequest {
	r.sort = &sort
	return r
}

// Organization identifier that can be obtained from console settings.
func (r ApiGroupsPolicyListRequest) XOrgId(xOrgId string) ApiGroupsPolicyListRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiGroupsPolicyListRequest) Execute() ([]PolicyGroup, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGroupsPolicyListRequest
*/
func (a *PolicyGroupsApiService) GroupsPolicyList(ctx context.Context) ApiGroupsPolicyListRequest {
	return ApiGroupsPolicyListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []PolicyGroup
func (a *PolicyGroupsApiService) GroupsPolicyListExecute(r ApiGroupsPolicyListRequest) ([]PolicyGroup, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGroupsPolicyPostRequest struct {
	ctx context.Context
	ApiService *PolicyGroupsApiService
	xOrgId *string
...
// Organization identifier that can be obtained from console settings.
func (r ApiGroupsPolicyPostRequest) XOrgId(xOrgId string) ApiGroupsPolicyPostRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiGroupsPolicyPostRequest) Body(body PolicyGroupData) ApiGroupsPolicyPostRequest {
	r.body = &body
	return r
}

func (r ApiGroupsPolicyPostRequest) Execute() (*PolicyGroup, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGroupsPolicyPostRequest
*/
func (a *PolicyGroupsApiService) GroupsPolicyPost(ctx context.Context) ApiGroupsPolicyPostRequest {
	return ApiGroupsPolicyPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return PolicyGroup
func (a *PolicyGroupsApiService) GroupsPolicyPostExecute(r ApiGroupsPolicyPostRequest) (*PolicyGroup, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGroupsPolicyPutRequest struct {
	ctx context.Context
	ApiService *PolicyGroupsApiService
	id string
	xOrgId *string
...
// Organization identifier that can be obtained from console settings.
func (r ApiGroupsPolicyPutRequest) XOrgId(xOrgId string) ApiGroupsPolicyPutRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiGroupsPolicyPutRequest) Body(body PolicyGroupData) ApiGroupsPolicyPutRequest {
	r.body = &body
	return r
}

func (r ApiGroupsPolicyPutRequest) Execute() (*PolicyGroup, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id ObjectID of the Policy Group.
 @return ApiGroupsPolicyPutRequest
*/
func (a *PolicyGroupsApiService) GroupsPolicyPut(ctx context.Context, id string) ApiGroupsPolicyPutRequest {
	return ApiGroupsPolicyPutRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return PolicyGroup
func (a *PolicyGroupsApiService) GroupsPolicyPutExecute(r ApiGroupsPolicyPutRequest) (*PolicyGroup, *http.Response, error) {
	var (
