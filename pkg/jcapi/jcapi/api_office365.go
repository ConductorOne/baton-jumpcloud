...
*/
func (a *Office365ApiService) GraphOffice365AssociationsList(ctx context.Context, office365Id string) ApiGraphOffice365AssociationsListRequest {
	return ApiGraphOffice365AssociationsListRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *Office365ApiService) GraphOffice365AssociationsListExecute(r ApiGraphOffice365AssociationsListRequest) ([]GraphConnection, *http.Response, error) {
	var (
...
*/
func (a *Office365ApiService) GraphOffice365AssociationsPost(ctx context.Context, office365Id string) ApiGraphOffice365AssociationsPostRequest {
	return ApiGraphOffice365AssociationsPostRequest{
		ApiService: a,
		ctx: ctx,
		office365Id: office365Id,
...
// Execute executes the request
func (a *Office365ApiService) GraphOffice365AssociationsPostExecute(r ApiGraphOffice365AssociationsPostRequest) (*http.Response, error) {
	var (
...
*/
func (a *Office365ApiService) GraphOffice365TraverseUser(ctx context.Context, office365Id string) ApiGraphOffice365TraverseUserRequest {
	return ApiGraphOffice365TraverseUserRequest{
		ApiService: a,
		ctx: ctx,
		office365Id: office365Id,
...
func (a *Office365ApiService) GraphOffice365TraverseUserExecute(r ApiGraphOffice365TraverseUserRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *Office365ApiService) GraphOffice365TraverseUserGroup(ctx context.Context, office365Id string) ApiGraphOffice365TraverseUserGroupRequest {
	return ApiGraphOffice365TraverseUserGroupRequest{
		ApiService: a,
		ctx: ctx,
		office365Id: office365Id,
...
// Execute executes the request
//  @return []GraphObjectWithPaths
func (a *Office365ApiService) GraphOffice365TraverseUserGroupExecute(r ApiGraphOffice365TraverseUserGroupRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiOffice365sGetRequest struct {
	ctx context.Context
	ApiService *Office365ApiService
	office365Id string
	xOrgId *string
...
// Organization identifier that can be obtained from console settings.
func (r ApiOffice365sGetRequest) XOrgId(xOrgId string) ApiOffice365sGetRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiOffice365sGetRequest) Execute() (*Office365, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param office365Id ObjectID of the Office 365 instance.
 @return ApiOffice365sGetRequest
*/
func (a *Office365ApiService) Office365sGet(ctx context.Context, office365Id string) ApiOffice365sGetRequest {
	return ApiOffice365sGetRequest{
		ApiService: a,
		ctx: ctx,
		office365Id: office365Id,
...
// Execute executes the request
//  @return Office365
func (a *Office365ApiService) Office365sGetExecute(r ApiOffice365sGetRequest) (*Office365, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiOffice365sListImportUsersRequest struct {
	ctx context.Context
	ApiService *Office365ApiService
	office365Id string
...
func (r ApiOffice365sListImportUsersRequest) ConsistencyLevel(consistencyLevel string) ApiOffice365sListImportUsersRequest {
...
func (r ApiOffice365sListImportUsersRequest) Top(top int32) ApiOffice365sListImportUsersRequest {
	r.top = &top
	return r
}

// Office 365 API token used to access the next page of results. See https://docs.microsoft.com/en-us/graph/paging.
func (r ApiOffice365sListImportUsersRequest) SkipToken(skipToken string) ApiOffice365sListImportUsersRequest {
...
func (r ApiOffice365sListImportUsersRequest) Filter(filter string) ApiOffice365sListImportUsersRequest {
	r.filter = &filter
	return r
}
...
func (r ApiOffice365sListImportUsersRequest) Search(search string) ApiOffice365sListImportUsersRequest {
	r.search = &search
	return r
}
...
func (r ApiOffice365sListImportUsersRequest) Orderby(orderby string) ApiOffice365sListImportUsersRequest {
	r.orderby = &orderby
	return r
}
...
func (r ApiOffice365sListImportUsersRequest) Count(count bool) ApiOffice365sListImportUsersRequest {
	r.count = &count
	return r
}

func (r ApiOffice365sListImportUsersRequest) Execute() (*Office365sListImportUsers200Response, *http.Response, error) {
...
Lists Office 365 users available for import.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param office365Id
 @return ApiOffice365sListImportUsersRequest
*/
func (a *Office365ApiService) Office365sListImportUsers(ctx context.Context, office365Id string) ApiOffice365sListImportUsersRequest {
	return ApiOffice365sListImportUsersRequest{
		ApiService: a,
		ctx: ctx,
		office365Id: office365Id,
...
func (a *Office365ApiService) Office365sListImportUsersExecute(r ApiOffice365sListImportUsersRequest) (*Office365sListImportUsers200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiOffice365sPatchRequest struct {
	ctx context.Context
	ApiService *Office365ApiService
	office365Id string
	xOrgId *string
...
// Organization identifier that can be obtained from console settings.
func (r ApiOffice365sPatchRequest) XOrgId(xOrgId string) ApiOffice365sPatchRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiOffice365sPatchRequest) Body(body Office365) ApiOffice365sPatchRequest {
	r.body = &body
	return r
}

func (r ApiOffice365sPatchRequest) Execute() (*Office365, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param office365Id ObjectID of the Office 365 instance.
 @return ApiOffice365sPatchRequest
*/
func (a *Office365ApiService) Office365sPatch(ctx context.Context, office365Id string) ApiOffice365sPatchRequest {
	return ApiOffice365sPatchRequest{
		ApiService: a,
		ctx: ctx,
		office365Id: office365Id,
...
// Execute executes the request
//  @return Office365
func (a *Office365ApiService) Office365sPatchExecute(r ApiOffice365sPatchRequest) (*Office365, *http.Response, error) {
	var (
...
type ApiTranslationRulesOffice365DeleteRequest struct {
	ctx context.Context
	ApiService *Office365ApiService
	office365Id string
	id string
...
func (r ApiTranslationRulesOffice365DeleteRequest) Execute() (*http.Response, error) {
...
curl -X DELETE https://console.jumpcloud.com/api/v2/office365s/{office365_id}/translationrules/{id} \
 ...
 @param office365Id
 @param id
 @return ApiTranslationRulesOffice365DeleteRequest
*/
func (a *Office365ApiService) TranslationRulesOffice365Delete(ctx context.Context, office365Id string, id string) ApiTranslationRulesOffice365DeleteRequest {
	return ApiTranslationRulesOffice365DeleteRequest{
		ApiService: a,
		ctx: ctx,
		office365Id: office365Id,
...
// Execute executes the request
func (a *Office365ApiService) TranslationRulesOffice365DeleteExecute(r ApiTranslationRulesOffice365DeleteRequest) (*http.Response, error) {
	var (
...
type ApiTranslationRulesOffice365GetRequest struct {
	ctx context.Context
	ApiService *Office365ApiService
	office365Id string
	id string
...
func (r ApiTranslationRulesOffice365GetRequest) Execute() (*Office365TranslationRule, *http.Response, error) {
...
```
 ...
 @param office365Id
 @param id
 @return ApiTranslationRulesOffice365GetRequest
*/
func (a *Office365ApiService) TranslationRulesOffice365Get(ctx context.Context, office365Id string, id string) ApiTranslationRulesOffice365GetRequest {
	return ApiTranslationRulesOffice365GetRequest{
		ApiService: a,
		ctx: ctx,
		office365Id: office365Id,
...
func (a *Office365ApiService) TranslationRulesOffice365GetExecute(r ApiTranslationRulesOffice365GetRequest) (*Office365TranslationRule, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiTranslationRulesOffice365ListRequest struct {
	ctx context.Context
	ApiService *Office365ApiService
	office365Id string
	fields *[]string
...
func (r ApiTranslationRulesOffice365ListRequest) Fields(fields []string) ApiTranslationRulesOffice365ListRequest {
	r.fields = &fields
	return r
}

// A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
func (r ApiTranslationRulesOffice365ListRequest) Filter(filter []string) ApiTranslationRulesOffice365ListRequest {
	r.filter = &filter
	return r
}

// The number of records to return at once. Limited to 100.
func (r ApiTranslationRulesOffice365ListRequest) Limit(limit int32) ApiTranslationRulesOffice365ListRequest {
	r.limit = &limit
	return r
}

// The offset into the records to return.
func (r ApiTranslationRulesOffice365ListRequest) Skip(skip int32) ApiTranslationRulesOffice365ListRequest {
	r.skip = &skip
	return r
}

// The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. 
func (r ApiTranslationRulesOffice365ListRequest) Sort(sort []string) ApiTranslationRulesOffice365ListRequest {
	r.sort = &sort
	return r
}

func (r ApiTranslationRulesOffice365ListRequest) Execute() ([]Office365TranslationRule, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param office365Id
 @return ApiTranslationRulesOffice365ListRequest
*/
func (a *Office365ApiService) TranslationRulesOffice365List(ctx context.Context, office365Id string) ApiTranslationRulesOffice365ListRequest {
	return ApiTranslationRulesOffice365ListRequest{
		ApiService: a,
		ctx: ctx,
		office365Id: office365Id,
...
// Execute executes the request
//  @return []Office365TranslationRule
func (a *Office365ApiService) TranslationRulesOffice365ListExecute(r ApiTranslationRulesOffice365ListRequest) ([]Office365TranslationRule, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiTranslationRulesOffice365PostRequest struct {
	ctx context.Context
	ApiService *Office365ApiService
	office365Id string
...
func (r ApiTranslationRulesOffice365PostRequest) Body(body Office365TranslationRuleRequest) ApiTranslationRulesOffice365PostRequest {
	r.body = &body
	return r
}

func (r ApiTranslationRulesOffice365PostRequest) Execute() (*Office365TranslationRule, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param office365Id
 @return ApiTranslationRulesOffice365PostRequest
*/
func (a *Office365ApiService) TranslationRulesOffice365Post(ctx context.Context, office365Id string) ApiTranslationRulesOffice365PostRequest {
	return ApiTranslationRulesOffice365PostRequest{
		ApiService: a,
		ctx: ctx,
		office365Id: office365Id,
...
// Execute executes the request
//  @return Office365TranslationRule
func (a *Office365ApiService) TranslationRulesOffice365PostExecute(r ApiTranslationRulesOffice365PostRequest) (*Office365TranslationRule, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
