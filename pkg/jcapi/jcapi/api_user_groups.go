...
*/
func (a *UserGroupsApiService) GraphUserGroupAssociationsList(ctx context.Context, groupId string) ApiGraphUserGroupAssociationsListRequest {
	return ApiGraphUserGroupAssociationsListRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
func (a *UserGroupsApiService) GraphUserGroupAssociationsListExecute(r ApiGraphUserGroupAssociationsListRequest) ([]GraphConnection, *http.Response, error) {
	var (
...
*/
func (a *UserGroupsApiService) GraphUserGroupAssociationsPost(ctx context.Context, groupId string) ApiGraphUserGroupAssociationsPostRequest {
	return ApiGraphUserGroupAssociationsPostRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
func (a *UserGroupsApiService) GraphUserGroupAssociationsPostExecute(r ApiGraphUserGroupAssociationsPostRequest) (*http.Response, error) {
	var (
...
*/
func (a *UserGroupsApiService) GraphUserGroupMembersList(ctx context.Context, groupId string) ApiGraphUserGroupMembersListRequest {
	return ApiGraphUserGroupMembersListRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
//  @return []GraphConnection
func (a *UserGroupsApiService) GraphUserGroupMembersListExecute(r ApiGraphUserGroupMembersListRequest) ([]GraphConnection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *UserGroupsApiService) GraphUserGroupMembersPost(ctx context.Context, groupId string) ApiGraphUserGroupMembersPostRequest {
	return ApiGraphUserGroupMembersPostRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
func (a *UserGroupsApiService) GraphUserGroupMembersPostExecute(r ApiGraphUserGroupMembersPostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *UserGroupsApiService) GraphUserGroupMembership(ctx context.Context, groupId string) ApiGraphUserGroupMembershipRequest {
	return ApiGraphUserGroupMembershipRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
func (a *UserGroupsApiService) GraphUserGroupMembershipExecute(r ApiGraphUserGroupMembershipRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *UserGroupsApiService) GraphUserGroupTraverseActiveDirectory(ctx context.Context, groupId string) ApiGraphUserGroupTraverseActiveDirectoryRequest {
	return ApiGraphUserGroupTraverseActiveDirectoryRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
//  @return []GraphObjectWithPaths
func (a *UserGroupsApiService) GraphUserGroupTraverseActiveDirectoryExecute(r ApiGraphUserGroupTraverseActiveDirectoryRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *UserGroupsApiService) GraphUserGroupTraverseApplication(ctx context.Context, groupId string) ApiGraphUserGroupTraverseApplicationRequest {
	return ApiGraphUserGroupTraverseApplicationRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
//  @return []GraphObjectWithPaths
func (a *UserGroupsApiService) GraphUserGroupTraverseApplicationExecute(r ApiGraphUserGroupTraverseApplicationRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *UserGroupsApiService) GraphUserGroupTraverseDirectory(ctx context.Context, groupId string) ApiGraphUserGroupTraverseDirectoryRequest {
	return ApiGraphUserGroupTraverseDirectoryRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
//  @return []GraphObjectWithPaths
func (a *UserGroupsApiService) GraphUserGroupTraverseDirectoryExecute(r ApiGraphUserGroupTraverseDirectoryRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *UserGroupsApiService) GraphUserGroupTraverseGSuite(ctx context.Context, groupId string) ApiGraphUserGroupTraverseGSuiteRequest {
	return ApiGraphUserGroupTraverseGSuiteRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
//  @return []GraphObjectWithPaths
func (a *UserGroupsApiService) GraphUserGroupTraverseGSuiteExecute(r ApiGraphUserGroupTraverseGSuiteRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *UserGroupsApiService) GraphUserGroupTraverseLdapServer(ctx context.Context, groupId string) ApiGraphUserGroupTraverseLdapServerRequest {
	return ApiGraphUserGroupTraverseLdapServerRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
//  @return []GraphObjectWithPaths
func (a *UserGroupsApiService) GraphUserGroupTraverseLdapServerExecute(r ApiGraphUserGroupTraverseLdapServerRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *UserGroupsApiService) GraphUserGroupTraverseOffice365(ctx context.Context, groupId string) ApiGraphUserGroupTraverseOffice365Request {
	return ApiGraphUserGroupTraverseOffice365Request{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
//  @return []GraphObjectWithPaths
func (a *UserGroupsApiService) GraphUserGroupTraverseOffice365Execute(r ApiGraphUserGroupTraverseOffice365Request) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *UserGroupsApiService) GraphUserGroupTraverseRadiusServer(ctx context.Context, groupId string) ApiGraphUserGroupTraverseRadiusServerRequest {
	return ApiGraphUserGroupTraverseRadiusServerRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
//  @return []GraphObjectWithPaths
func (a *UserGroupsApiService) GraphUserGroupTraverseRadiusServerExecute(r ApiGraphUserGroupTraverseRadiusServerRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *UserGroupsApiService) GraphUserGroupTraverseSystem(ctx context.Context, groupId string) ApiGraphUserGroupTraverseSystemRequest {
	return ApiGraphUserGroupTraverseSystemRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
//  @return []GraphObjectWithPaths
func (a *UserGroupsApiService) GraphUserGroupTraverseSystemExecute(r ApiGraphUserGroupTraverseSystemRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *UserGroupsApiService) GraphUserGroupTraverseSystemGroup(ctx context.Context, groupId string) ApiGraphUserGroupTraverseSystemGroupRequest {
	return ApiGraphUserGroupTraverseSystemGroupRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
//  @return []GraphObjectWithPaths
func (a *UserGroupsApiService) GraphUserGroupTraverseSystemGroupExecute(r ApiGraphUserGroupTraverseSystemGroupRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGroupsSuggestionsGetRequest struct {
	ctx context.Context
	ApiService *UserGroupsApiService
	groupId string
	xOrgId *string
...
// Organization identifier that can be obtained from console settings.
func (r ApiGroupsSuggestionsGetRequest) XOrgId(xOrgId string) ApiGroupsSuggestionsGetRequest {
	r.xOrgId = &xOrgId
	return r
}

// The number of records to return at once. Limited to 100.
func (r ApiGroupsSuggestionsGetRequest) Limit(limit int32) ApiGroupsSuggestionsGetRequest {
	r.limit = &limit
	return r
}

// The offset into the records to return.
func (r ApiGroupsSuggestionsGetRequest) Skip(skip int32) ApiGroupsSuggestionsGetRequest {
	r.skip = &skip
	return r
}

func (r ApiGroupsSuggestionsGetRequest) Execute() ([]MemberSuggestion, *http.Response, error) {
...
```
 ...
 @return ApiGroupsSuggestionsGetRequest
*/
func (a *UserGroupsApiService) GroupsSuggestionsGet(ctx context.Context, groupId string) ApiGroupsSuggestionsGetRequest {
	return ApiGroupsSuggestionsGetRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
func (a *UserGroupsApiService) GroupsSuggestionsGetExecute(r ApiGroupsSuggestionsGetRequest) ([]MemberSuggestion, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGroupsSuggestionsPostRequest struct {
	ctx context.Context
	ApiService *UserGroupsApiService
	groupId string
...
func (r ApiGroupsSuggestionsPostRequest) Body(body GroupsSuggestionsPostRequest) ApiGroupsSuggestionsPostRequest {
	r.body = &body
	return r
}

// Organization identifier that can be obtained from console settings.
func (r ApiGroupsSuggestionsPostRequest) XOrgId(xOrgId string) ApiGroupsSuggestionsPostRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiGroupsSuggestionsPostRequest) Execute() ([]MemberSuggestionsPostResult, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param groupId ID of the group
 @return ApiGroupsSuggestionsPostRequest
*/
func (a *UserGroupsApiService) GroupsSuggestionsPost(ctx context.Context, groupId string) ApiGroupsSuggestionsPostRequest {
	return ApiGroupsSuggestionsPostRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
func (a *UserGroupsApiService) GroupsSuggestionsPostExecute(r ApiGroupsSuggestionsPostRequest) ([]MemberSuggestionsPostResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGroupsUserDeleteRequest struct {
	ctx context.Context
	ApiService *UserGroupsApiService
	id string
	xOrgId *string
...
// Organization identifier that can be obtained from console settings.
func (r ApiGroupsUserDeleteRequest) XOrgId(xOrgId string) ApiGroupsUserDeleteRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiGroupsUserDeleteRequest) Execute() (*UserGroup, *http.Response, error) {
...
```
 ...
 @return ApiGroupsUserDeleteRequest
*/
func (a *UserGroupsApiService) GroupsUserDelete(ctx context.Context, id string) ApiGroupsUserDeleteRequest {
	return ApiGroupsUserDeleteRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return UserGroup
func (a *UserGroupsApiService) GroupsUserDeleteExecute(r ApiGroupsUserDeleteRequest) (*UserGroup, *http.Response, error) {
	var (
...
type ApiGroupsUserGetRequest struct {
	ctx context.Context
	ApiService *UserGroupsApiService
	id string
	xOrgId *string
...
// Organization identifier that can be obtained from console settings.
func (r ApiGroupsUserGetRequest) XOrgId(xOrgId string) ApiGroupsUserGetRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiGroupsUserGetRequest) Execute() (*UserGroup, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id ObjectID of the User Group.
 @return ApiGroupsUserGetRequest
*/
func (a *UserGroupsApiService) GroupsUserGet(ctx context.Context, id string) ApiGroupsUserGetRequest {
	return ApiGroupsUserGetRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return UserGroup
func (a *UserGroupsApiService) GroupsUserGetExecute(r ApiGroupsUserGetRequest) (*UserGroup, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGroupsUserListRequest struct {
	ctx context.Context
	ApiService *UserGroupsApiService
	fields *[]string
	filter *[]string
...
func (r ApiGroupsUserListRequest) Fields(fields []string) ApiGroupsUserListRequest {
	r.fields = &fields
	return r
}

// A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
func (r ApiGroupsUserListRequest) Filter(filter []string) ApiGroupsUserListRequest {
	r.filter = &filter
	return r
}

// The number of records to return at once. Limited to 100.
func (r ApiGroupsUserListRequest) Limit(limit int32) ApiGroupsUserListRequest {
	r.limit = &limit
	return r
}

// The offset into the records to return.
func (r ApiGroupsUserListRequest) Skip(skip int32) ApiGroupsUserListRequest {
	r.skip = &skip
	return r
}

// The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. 
func (r ApiGroupsUserListRequest) Sort(sort []string) ApiGroupsUserListRequest {
	r.sort = &sort
	return r
}

// Organization identifier that can be obtained from console settings.
func (r ApiGroupsUserListRequest) XOrgId(xOrgId string) ApiGroupsUserListRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiGroupsUserListRequest) Execute() ([]UserGroup, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGroupsUserListRequest
*/
func (a *UserGroupsApiService) GroupsUserList(ctx context.Context) ApiGroupsUserListRequest {
	return ApiGroupsUserListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []UserGroup
func (a *UserGroupsApiService) GroupsUserListExecute(r ApiGroupsUserListRequest) ([]UserGroup, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGroupsUserPostRequest struct {
	ctx context.Context
	ApiService *UserGroupsApiService
	xOrgId *string
	body *UserGroupPost
...
// Organization identifier that can be obtained from console settings.
func (r ApiGroupsUserPostRequest) XOrgId(xOrgId string) ApiGroupsUserPostRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiGroupsUserPostRequest) Body(body UserGroupPost) ApiGroupsUserPostRequest {
	r.body = &body
	return r
}

func (r ApiGroupsUserPostRequest) Execute() (*UserGroup, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGroupsUserPostRequest
*/
func (a *UserGroupsApiService) GroupsUserPost(ctx context.Context) ApiGroupsUserPostRequest {
	return ApiGroupsUserPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return UserGroup
func (a *UserGroupsApiService) GroupsUserPostExecute(r ApiGroupsUserPostRequest) (*UserGroup, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGroupsUserPutRequest struct {
	ctx context.Context
	ApiService *UserGroupsApiService
	id string
	xOrgId *string
...
// Organization identifier that can be obtained from console settings.
func (r ApiGroupsUserPutRequest) XOrgId(xOrgId string) ApiGroupsUserPutRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiGroupsUserPutRequest) Body(body UserGroupPut) ApiGroupsUserPutRequest {
	r.body = &body
	return r
}

func (r ApiGroupsUserPutRequest) Execute() (*UserGroup, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id ObjectID of the User Group.
 @return ApiGroupsUserPutRequest
*/
func (a *UserGroupsApiService) GroupsUserPut(ctx context.Context, id string) ApiGroupsUserPutRequest {
	return ApiGroupsUserPutRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return UserGroup
func (a *UserGroupsApiService) GroupsUserPutExecute(r ApiGroupsUserPutRequest) (*UserGroup, *http.Response, error) {
	var (
