...
*/
func (a *SoftwareAppsApiService) GraphSoftwareappsAssociationsList(ctx context.Context, softwareAppId string) ApiGraphSoftwareappsAssociationsListRequest {
	return ApiGraphSoftwareappsAssociationsListRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *SoftwareAppsApiService) GraphSoftwareappsAssociationsListExecute(r ApiGraphSoftwareappsAssociationsListRequest) ([]GraphConnection, *http.Response, error) {
	var (
...
*/
func (a *SoftwareAppsApiService) GraphSoftwareappsAssociationsPost(ctx context.Context, softwareAppId string) ApiGraphSoftwareappsAssociationsPostRequest {
	return ApiGraphSoftwareappsAssociationsPostRequest{
		ApiService: a,
		ctx: ctx,
		softwareAppId: softwareAppId,
...
// Execute executes the request
func (a *SoftwareAppsApiService) GraphSoftwareappsAssociationsPostExecute(r ApiGraphSoftwareappsAssociationsPostRequest) (*http.Response, error) {
	var (
...
*/
func (a *SoftwareAppsApiService) GraphSoftwareappsTraverseSystem(ctx context.Context, softwareAppId string) ApiGraphSoftwareappsTraverseSystemRequest {
	return ApiGraphSoftwareappsTraverseSystemRequest{
		ApiService: a,
		ctx: ctx,
		softwareAppId: softwareAppId,
...
func (a *SoftwareAppsApiService) GraphSoftwareappsTraverseSystemExecute(r ApiGraphSoftwareappsTraverseSystemRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *SoftwareAppsApiService) GraphSoftwareappsTraverseSystemGroup(ctx context.Context, softwareAppId string) ApiGraphSoftwareappsTraverseSystemGroupRequest {
	return ApiGraphSoftwareappsTraverseSystemGroupRequest{
		ApiService: a,
		ctx: ctx,
		softwareAppId: softwareAppId,
...
// Execute executes the request
//  @return []GraphObjectWithPaths
func (a *SoftwareAppsApiService) GraphSoftwareappsTraverseSystemGroupExecute(r ApiGraphSoftwareappsTraverseSystemGroupRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiSoftwareAppStatusesListRequest struct {
	ctx context.Context
	ApiService *SoftwareAppsApiService
	softwareAppId string
	xOrgId *string
...
// Organization identifier that can be obtained from console settings.
func (r ApiSoftwareAppStatusesListRequest) XOrgId(xOrgId string) ApiSoftwareAppStatusesListRequest {
	r.xOrgId = &xOrgId
	return r
}

// A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
func (r ApiSoftwareAppStatusesListRequest) Filter(filter []string) ApiSoftwareAppStatusesListRequest {
	r.filter = &filter
	return r
}

// The number of records to return at once. Limited to 100.
func (r ApiSoftwareAppStatusesListRequest) Limit(limit int32) ApiSoftwareAppStatusesListRequest {
	r.limit = &limit
	return r
}

// The offset into the records to return.
func (r ApiSoftwareAppStatusesListRequest) Skip(skip int32) ApiSoftwareAppStatusesListRequest {
	r.skip = &skip
	return r
}

// The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. 
func (r ApiSoftwareAppStatusesListRequest) Sort(sort []string) ApiSoftwareAppStatusesListRequest {
	r.sort = &sort
	return r
}

func (r ApiSoftwareAppStatusesListRequest) Execute() ([]SoftwareAppStatus, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param softwareAppId ObjectID of the Software App.
 @return ApiSoftwareAppStatusesListRequest
*/
func (a *SoftwareAppsApiService) SoftwareAppStatusesList(ctx context.Context, softwareAppId string) ApiSoftwareAppStatusesListRequest {
	return ApiSoftwareAppStatusesListRequest{
		ApiService: a,
		ctx: ctx,
		softwareAppId: softwareAppId,
...
func (a *SoftwareAppsApiService) SoftwareAppStatusesListExecute(r ApiSoftwareAppStatusesListRequest) ([]SoftwareAppStatus, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiSoftwareAppsDeleteRequest struct {
	ctx context.Context
	ApiService *SoftwareAppsApiService
	id string
	xOrgId *string
...
// Organization identifier that can be obtained from console settings.
func (r ApiSoftwareAppsDeleteRequest) XOrgId(xOrgId string) ApiSoftwareAppsDeleteRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiSoftwareAppsDeleteRequest) Execute() (*http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return ApiSoftwareAppsDeleteRequest
*/
func (a *SoftwareAppsApiService) SoftwareAppsDelete(ctx context.Context, id string) ApiSoftwareAppsDeleteRequest {
	return ApiSoftwareAppsDeleteRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *SoftwareAppsApiService) SoftwareAppsDeleteExecute(r ApiSoftwareAppsDeleteRequest) (*http.Response, error) {
	var (
...
type ApiSoftwareAppsGetRequest struct {
	ctx context.Context
	ApiService *SoftwareAppsApiService
	id string
	xOrgId *string
...
// Organization identifier that can be obtained from console settings.
func (r ApiSoftwareAppsGetRequest) XOrgId(xOrgId string) ApiSoftwareAppsGetRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiSoftwareAppsGetRequest) Execute() (*SoftwareApp, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return ApiSoftwareAppsGetRequest
*/
func (a *SoftwareAppsApiService) SoftwareAppsGet(ctx context.Context, id string) ApiSoftwareAppsGetRequest {
	return ApiSoftwareAppsGetRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return SoftwareApp
func (a *SoftwareAppsApiService) SoftwareAppsGetExecute(r ApiSoftwareAppsGetRequest) (*SoftwareApp, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiSoftwareAppsListRequest struct {
	ctx context.Context
	ApiService *SoftwareAppsApiService
	xOrgId *string
	filter *[]string
...
// Organization identifier that can be obtained from console settings.
func (r ApiSoftwareAppsListRequest) XOrgId(xOrgId string) ApiSoftwareAppsListRequest {
	r.xOrgId = &xOrgId
	return r
}

// A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
func (r ApiSoftwareAppsListRequest) Filter(filter []string) ApiSoftwareAppsListRequest {
	r.filter = &filter
	return r
}

// The number of records to return at once. Limited to 100.
func (r ApiSoftwareAppsListRequest) Limit(limit int32) ApiSoftwareAppsListRequest {
	r.limit = &limit
	return r
}

// The offset into the records to return.
func (r ApiSoftwareAppsListRequest) Skip(skip int32) ApiSoftwareAppsListRequest {
	r.skip = &skip
	return r
}

// The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. 
func (r ApiSoftwareAppsListRequest) Sort(sort []string) ApiSoftwareAppsListRequest {
	r.sort = &sort
	return r
}

func (r ApiSoftwareAppsListRequest) Execute() ([]SoftwareApp, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSoftwareAppsListRequest
*/
func (a *SoftwareAppsApiService) SoftwareAppsList(ctx context.Context) ApiSoftwareAppsListRequest {
	return ApiSoftwareAppsListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []SoftwareApp
func (a *SoftwareAppsApiService) SoftwareAppsListExecute(r ApiSoftwareAppsListRequest) ([]SoftwareApp, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiSoftwareAppsPostRequest struct {
	ctx context.Context
	ApiService *SoftwareAppsApiService
	xOrgId *string
	body *SoftwareApp
...
// Organization identifier that can be obtained from console settings.
func (r ApiSoftwareAppsPostRequest) XOrgId(xOrgId string) ApiSoftwareAppsPostRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiSoftwareAppsPostRequest) Body(body SoftwareApp) ApiSoftwareAppsPostRequest {
	r.body = &body
	return r
}

func (r ApiSoftwareAppsPostRequest) Execute() (*SoftwareApp, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSoftwareAppsPostRequest
*/
func (a *SoftwareAppsApiService) SoftwareAppsPost(ctx context.Context) ApiSoftwareAppsPostRequest {
	return ApiSoftwareAppsPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return SoftwareApp
func (a *SoftwareAppsApiService) SoftwareAppsPostExecute(r ApiSoftwareAppsPostRequest) (*SoftwareApp, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiSoftwareAppsReclaimLicensesRequest struct {
	ctx context.Context
	ApiService *SoftwareAppsApiService
	softwareAppId string
}

func (r ApiSoftwareAppsReclaimLicensesRequest) Execute() (*SoftwareAppReclaimLicenses, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param softwareAppId
 @return ApiSoftwareAppsReclaimLicensesRequest
*/
func (a *SoftwareAppsApiService) SoftwareAppsReclaimLicenses(ctx context.Context, softwareAppId string) ApiSoftwareAppsReclaimLicensesRequest {
	return ApiSoftwareAppsReclaimLicensesRequest{
		ApiService: a,
		ctx: ctx,
		softwareAppId: softwareAppId,
...
func (a *SoftwareAppsApiService) SoftwareAppsReclaimLicensesExecute(r ApiSoftwareAppsReclaimLicensesRequest) (*SoftwareAppReclaimLicenses, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiSoftwareAppsRetryInstallationRequest struct {
	ctx context.Context
	ApiService *SoftwareAppsApiService
	softwareAppId string
...
func (r ApiSoftwareAppsRetryInstallationRequest) Body(body SoftwareAppsRetryInstallationRequest) ApiSoftwareAppsRetryInstallationRequest {
	r.body = &body
	return r
}

func (r ApiSoftwareAppsRetryInstallationRequest) Execute() (*http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param softwareAppId
 @return ApiSoftwareAppsRetryInstallationRequest
*/
func (a *SoftwareAppsApiService) SoftwareAppsRetryInstallation(ctx context.Context, softwareAppId string) ApiSoftwareAppsRetryInstallationRequest {
	return ApiSoftwareAppsRetryInstallationRequest{
		ApiService: a,
		ctx: ctx,
		softwareAppId: softwareAppId,
...
// Execute executes the request
func (a *SoftwareAppsApiService) SoftwareAppsRetryInstallationExecute(r ApiSoftwareAppsRetryInstallationRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiSoftwareAppsUpdateRequest struct {
	ctx context.Context
	ApiService *SoftwareAppsApiService
	id string
	xOrgId *string
...
// Organization identifier that can be obtained from console settings.
func (r ApiSoftwareAppsUpdateRequest) XOrgId(xOrgId string) ApiSoftwareAppsUpdateRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiSoftwareAppsUpdateRequest) Body(body SoftwareApp) ApiSoftwareAppsUpdateRequest {
	r.body = &body
	return r
}

func (r ApiSoftwareAppsUpdateRequest) Execute() (*SoftwareApp, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return ApiSoftwareAppsUpdateRequest
*/
func (a *SoftwareAppsApiService) SoftwareAppsUpdate(ctx context.Context, id string) ApiSoftwareAppsUpdateRequest {
	return ApiSoftwareAppsUpdateRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return SoftwareApp
func (a *SoftwareAppsApiService) SoftwareAppsUpdateExecute(r ApiSoftwareAppsUpdateRequest) (*SoftwareApp, *http.Response, error) {
	var (
