...
func (r ApiGroupsListRequest) Filter(filter []string) ApiGroupsListRequest {
	r.filter = &filter
	return r
}
...
func (r ApiGroupsListRequest) Skip(skip int32) ApiGroupsListRequest {
	r.skip = &skip
	return r
}

// The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. 
func (r ApiGroupsListRequest) Sort(sort []string) ApiGroupsListRequest {
	r.sort = &sort
	return r
}

// Organization identifier that can be obtained from console settings.
func (r ApiGroupsListRequest) XOrgId(xOrgId string) ApiGroupsListRequest {
	r.xOrgId = &xOrgId
	return r
}
...
func (r ApiGroupsListRequest) XUnfilteredTotalCount(xUnfilteredTotalCount int32) ApiGroupsListRequest {
	r.xUnfilteredTotalCount = &xUnfilteredTotalCount
	return r
}

func (r ApiGroupsListRequest) Execute() ([]Group, *http.Response, error) {
	return r.ApiService.GroupsListExecute(r)
}

/*
GroupsList List All Groups
...
//  @return []Group
func (a *GroupsApiService) GroupsListExecute(r ApiGroupsListRequest) ([]Group, *http.Response, error) {
	var (
	...
	if r.xUnfilteredTotalCount != nil {
		parameterAddToHeaderOrQuery(localVarHeaderParams, "x-unfiltered-total-count", r.xUnfilteredTotalCount, "")
	}
	if r.ctx != nil {
