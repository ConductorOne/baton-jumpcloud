...
func (r ApiSubscriptionsGetRequest) Execute() ([]Subscription, *http.Response, error) {
...
//  @return []Subscription
func (a *SubscriptionsApiService) SubscriptionsGetExecute(r ApiSubscriptionsGetRequest) ([]Subscription, *http.Response, error) {
	var (
