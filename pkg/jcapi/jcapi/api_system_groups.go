...
*/
func (a *SystemGroupsApiService) GraphSystemGroupAssociationsList(ctx context.Context, groupId string) ApiGraphSystemGroupAssociationsListRequest {
	return ApiGraphSystemGroupAssociationsListRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
func (a *SystemGroupsApiService) GraphSystemGroupAssociationsListExecute(r ApiGraphSystemGroupAssociationsListRequest) ([]GraphConnection, *http.Response, error) {
	var (
...
*/
func (a *SystemGroupsApiService) GraphSystemGroupAssociationsPost(ctx context.Context, groupId string) ApiGraphSystemGroupAssociationsPostRequest {
	return ApiGraphSystemGroupAssociationsPostRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
func (a *SystemGroupsApiService) GraphSystemGroupAssociationsPostExecute(r ApiGraphSystemGroupAssociationsPostRequest) (*http.Response, error) {
	var (
...
*/
func (a *SystemGroupsApiService) GraphSystemGroupMembersList(ctx context.Context, groupId string) ApiGraphSystemGroupMembersListRequest {
	return ApiGraphSystemGroupMembersListRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
//  @return []GraphConnection
func (a *SystemGroupsApiService) GraphSystemGroupMembersListExecute(r ApiGraphSystemGroupMembersListRequest) ([]GraphConnection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *SystemGroupsApiService) GraphSystemGroupMembersPost(ctx context.Context, groupId string) ApiGraphSystemGroupMembersPostRequest {
	return ApiGraphSystemGroupMembersPostRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
func (a *SystemGroupsApiService) GraphSystemGroupMembersPostExecute(r ApiGraphSystemGroupMembersPostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *SystemGroupsApiService) GraphSystemGroupMembership(ctx context.Context, groupId string) ApiGraphSystemGroupMembershipRequest {
	return ApiGraphSystemGroupMembershipRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
func (a *SystemGroupsApiService) GraphSystemGroupMembershipExecute(r ApiGraphSystemGroupMembershipRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *SystemGroupsApiService) GraphSystemGroupTraversePolicy(ctx context.Context, groupId string) ApiGraphSystemGroupTraversePolicyRequest {
	return ApiGraphSystemGroupTraversePolicyRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
//  @return []GraphObjectWithPaths
func (a *SystemGroupsApiService) GraphSystemGroupTraversePolicyExecute(r ApiGraphSystemGroupTraversePolicyRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *SystemGroupsApiService) GraphSystemGroupTraversePolicyGroup(ctx context.Context, groupId string) ApiGraphSystemGroupTraversePolicyGroupRequest {
	return ApiGraphSystemGroupTraversePolicyGroupRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
//  @return []GraphObjectWithPaths
func (a *SystemGroupsApiService) GraphSystemGroupTraversePolicyGroupExecute(r ApiGraphSystemGroupTraversePolicyGroupRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *SystemGroupsApiService) GraphSystemGroupTraverseUser(ctx context.Context, groupId string) ApiGraphSystemGroupTraverseUserRequest {
	return ApiGraphSystemGroupTraverseUserRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
//  @return []GraphObjectWithPaths
func (a *SystemGroupsApiService) GraphSystemGroupTraverseUserExecute(r ApiGraphSystemGroupTraverseUserRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *SystemGroupsApiService) GraphSystemGroupTraverseUserGroup(ctx context.Context, groupId string) ApiGraphSystemGroupTraverseUserGroupRequest {
	return ApiGraphSystemGroupTraverseUserGroupRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
//  @return []GraphObjectWithPaths
func (a *SystemGroupsApiService) GraphSystemGroupTraverseUserGroupExecute(r ApiGraphSystemGroupTraverseUserGroupRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGroupsSystemDeleteRequest struct {
	ctx context.Context
	ApiService *SystemGroupsApiService
	id string
	xOrgId *string
...
// Organization identifier that can be obtained from console settings.
func (r ApiGroupsSystemDeleteRequest) XOrgId(xOrgId string) ApiGroupsSystemDeleteRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiGroupsSystemDeleteRequest) Execute() (*SystemGroup, *http.Response, error) {
...
```
 ...
 @return ApiGroupsSystemDeleteRequest
*/
func (a *SystemGroupsApiService) GroupsSystemDelete(ctx context.Context, id string) ApiGroupsSystemDeleteRequest {
	return ApiGroupsSystemDeleteRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return SystemGroup
func (a *SystemGroupsApiService) GroupsSystemDeleteExecute(r ApiGroupsSystemDeleteRequest) (*SystemGroup, *http.Response, error) {
	var (
...
type ApiGroupsSystemGetRequest struct {
	ctx context.Context
	ApiService *SystemGroupsApiService
	id string
	xOrgId *string
...
// Organization identifier that can be obtained from console settings.
func (r ApiGroupsSystemGetRequest) XOrgId(xOrgId string) ApiGroupsSystemGetRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiGroupsSystemGetRequest) Execute() (*SystemGroup, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id ObjectID of the System Group.
 @return ApiGroupsSystemGetRequest
*/
func (a *SystemGroupsApiService) GroupsSystemGet(ctx context.Context, id string) ApiGroupsSystemGetRequest {
	return ApiGroupsSystemGetRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return SystemGroup
func (a *SystemGroupsApiService) GroupsSystemGetExecute(r ApiGroupsSystemGetRequest) (*SystemGroup, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGroupsSystemListRequest struct {
	ctx context.Context
	ApiService *SystemGroupsApiService
	fields *[]string
	filter *[]string
...
func (r ApiGroupsSystemListRequest) Fields(fields []string) ApiGroupsSystemListRequest {
	r.fields = &fields
	return r
}

// A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
func (r ApiGroupsSystemListRequest) Filter(filter []string) ApiGroupsSystemListRequest {
	r.filter = &filter
	return r
}

// The number of records to return at once. Limited to 100.
func (r ApiGroupsSystemListRequest) Limit(limit int32) ApiGroupsSystemListRequest {
	r.limit = &limit
	return r
}

// The offset into the records to return.
func (r ApiGroupsSystemListRequest) Skip(skip int32) ApiGroupsSystemListRequest {
	r.skip = &skip
	return r
}

// The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. 
func (r ApiGroupsSystemListRequest) Sort(sort []string) ApiGroupsSystemListRequest {
	r.sort = &sort
	return r
}

// Organization identifier that can be obtained from console settings.
func (r ApiGroupsSystemListRequest) XOrgId(xOrgId string) ApiGroupsSystemListRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiGroupsSystemListRequest) Execute() ([]SystemGroup, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGroupsSystemListRequest
*/
func (a *SystemGroupsApiService) GroupsSystemList(ctx context.Context) ApiGroupsSystemListRequest {
	return ApiGroupsSystemListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []SystemGroup
func (a *SystemGroupsApiService) GroupsSystemListExecute(r ApiGroupsSystemListRequest) ([]SystemGroup, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGroupsSystemPostRequest struct {
	ctx context.Context
	ApiService *SystemGroupsApiService
	xOrgId *string
...
// Organization identifier that can be obtained from console settings.
func (r ApiGroupsSystemPostRequest) XOrgId(xOrgId string) ApiGroupsSystemPostRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiGroupsSystemPostRequest) Body(body SystemGroupPost) ApiGroupsSystemPostRequest {
	r.body = &body
	return r
}

func (r ApiGroupsSystemPostRequest) Execute() (*SystemGroup, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGroupsSystemPostRequest
*/
func (a *SystemGroupsApiService) GroupsSystemPost(ctx context.Context) ApiGroupsSystemPostRequest {
	return ApiGroupsSystemPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return SystemGroup
func (a *SystemGroupsApiService) GroupsSystemPostExecute(r ApiGroupsSystemPostRequest) (*SystemGroup, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGroupsSystemPutRequest struct {
	ctx context.Context
	ApiService *SystemGroupsApiService
	id string
	xOrgId *string
...
// Organization identifier that can be obtained from console settings.
func (r ApiGroupsSystemPutRequest) XOrgId(xOrgId string) ApiGroupsSystemPutRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiGroupsSystemPutRequest) Body(body SystemGroupPut) ApiGroupsSystemPutRequest {
	r.body = &body
	return r
}

func (r ApiGroupsSystemPutRequest) Execute() (*SystemGroup, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id ObjectID of the System Group.
 @return ApiGroupsSystemPutRequest
*/
func (a *SystemGroupsApiService) GroupsSystemPut(ctx context.Context, id string) ApiGroupsSystemPutRequest {
	return ApiGroupsSystemPutRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return SystemGroup
func (a *SystemGroupsApiService) GroupsSystemPutExecute(r ApiGroupsSystemPutRequest) (*SystemGroup, *http.Response, error) {
	var (
