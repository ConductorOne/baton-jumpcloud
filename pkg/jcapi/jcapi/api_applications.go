...
type ApiApplicationsDeleteLogoRequest struct {
	ctx context.Context
...
func (r ApiApplicationsDeleteLogoRequest) XOrgId(xOrgId string) ApiApplicationsDeleteLogoRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiApplicationsDeleteLogoRequest) Execute() (*http.Response, error) {
...
Deletes the specified image from an application
 ...
 @param applicationId
 @return ApiApplicationsDeleteLogoRequest
*/
func (a *ApplicationsApiService) ApplicationsDeleteLogo(ctx context.Context, applicationId string) ApiApplicationsDeleteLogoRequest {
	return ApiApplicationsDeleteLogoRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *ApplicationsApiService) ApplicationsDeleteLogoExecute(r ApiApplicationsDeleteLogoRequest) (*http.Response, error) {
	var (
...
// Organization identifier that can be obtained from console settings.
func (r ApiApplicationsGetRequest) XOrgId(xOrgId string) ApiApplicationsGetRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiApplicationsGetRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
*/
func (a *ApplicationsApiService) ApplicationsGet(ctx context.Context, applicationId string) ApiApplicationsGetRequest {
	return ApiApplicationsGetRequest{
		ApiService: a,
		ctx: ctx,
		applicationId: applicationId,
...
func (a *ApplicationsApiService) ApplicationsGetExecute(r ApiApplicationsGetRequest) (map[string]interface{}, *http.Response, error) {
	var (
...
type ApiApplicationsPostLogoRequest struct {
	ctx context.Context
	ApiService *ApplicationsApiService
	applicationId string
	xOrgId *string
...
// Organization identifier that can be obtained from console settings.
func (r ApiApplicationsPostLogoRequest) XOrgId(xOrgId string) ApiApplicationsPostLogoRequest {
	r.xOrgId = &xOrgId
	return r
}

// The file to upload.
func (r ApiApplicationsPostLogoRequest) Image(image *os.File) ApiApplicationsPostLogoRequest {
	r.image = image
	return r
}

func (r ApiApplicationsPostLogoRequest) Execute() (*http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param applicationId
 @return ApiApplicationsPostLogoRequest
*/
func (a *ApplicationsApiService) ApplicationsPostLogo(ctx context.Context, applicationId string) ApiApplicationsPostLogoRequest {
	return ApiApplicationsPostLogoRequest{
		ApiService: a,
		ctx: ctx,
		applicationId: applicationId,
...
// Execute executes the request
func (a *ApplicationsApiService) ApplicationsPostLogoExecute(r ApiApplicationsPostLogoRequest) (*http.Response, error) {
	var (
...
*/
func (a *ApplicationsApiService) GraphApplicationAssociationsList(ctx context.Context, applicationId string) ApiGraphApplicationAssociationsListRequest {
	return ApiGraphApplicationAssociationsListRequest{
		ApiService: a,
		ctx: ctx,
		applicationId: applicationId,
...
func (a *ApplicationsApiService) GraphApplicationAssociationsListExecute(r ApiGraphApplicationAssociationsListRequest) ([]GraphConnection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *ApplicationsApiService) GraphApplicationAssociationsPost(ctx context.Context, applicationId string) ApiGraphApplicationAssociationsPostRequest {
	return ApiGraphApplicationAssociationsPostRequest{
		ApiService: a,
		ctx: ctx,
		applicationId: applicationId,
...
// Execute executes the request
func (a *ApplicationsApiService) GraphApplicationAssociationsPostExecute(r ApiGraphApplicationAssociationsPostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *ApplicationsApiService) GraphApplicationTraverseUser(ctx context.Context, applicationId string) ApiGraphApplicationTraverseUserRequest {
	return ApiGraphApplicationTraverseUserRequest{
		ApiService: a,
		ctx: ctx,
		applicationId: applicationId,
...
func (a *ApplicationsApiService) GraphApplicationTraverseUserExecute(r ApiGraphApplicationTraverseUserRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *ApplicationsApiService) GraphApplicationTraverseUserGroup(ctx context.Context, applicationId string) ApiGraphApplicationTraverseUserGroupRequest {
	return ApiGraphApplicationTraverseUserGroupRequest{
		ApiService: a,
		ctx: ctx,
		applicationId: applicationId,
...
// Execute executes the request
//  @return []GraphObjectWithPaths
func (a *ApplicationsApiService) GraphApplicationTraverseUserGroupExecute(r ApiGraphApplicationTraverseUserGroupRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
// Organization identifier that can be obtained from console settings.
func (r ApiImportCreateRequest) XOrgId(xOrgId string) ApiImportCreateRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiImportCreateRequest) Body(body ImportUsersRequest) ApiImportCreateRequest {
	r.body = &body
	return r
}

func (r ApiImportCreateRequest) Execute() (*JobId, *http.Response, error) {
...
*/
func (a *ApplicationsApiService) ImportCreate(ctx context.Context, applicationId string) ApiImportCreateRequest {
	return ApiImportCreateRequest{
		ApiService: a,
		ctx: ctx,
		applicationId: applicationId,
...
// Execute executes the request
//  @return JobId
func (a *ApplicationsApiService) ImportCreateExecute(r ApiImportCreateRequest) (*JobId, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiImportUsersRequest struct {
	ctx context.Context
	ApiService *ApplicationsApiService
	applicationId string
	filter *string
...
func (r ApiImportUsersRequest) Filter(filter string) ApiImportUsersRequest {
	r.filter = &filter
	return r
}

// URL query to merge with the service provider request
func (r ApiImportUsersRequest) Query(query string) ApiImportUsersRequest {
	r.query = &query
	return r
}

// Sort users by supported fields
func (r ApiImportUsersRequest) Sort(sort string) ApiImportUsersRequest {
	r.sort = &sort
	return r
}

func (r ApiImportUsersRequest) SortOrder(sortOrder string) ApiImportUsersRequest {
	r.sortOrder = &sortOrder
	return r
}

// Organization identifier that can be obtained from console settings.
func (r ApiImportUsersRequest) XOrgId(xOrgId string) ApiImportUsersRequest {
	r.xOrgId = &xOrgId
	return r
}

// The number of records to return at once. Limited to 100.
func (r ApiImportUsersRequest) Limit(limit int32) ApiImportUsersRequest {
	r.limit = &limit
	return r
}

// The offset into the records to return.
func (r ApiImportUsersRequest) Skip(skip int32) ApiImportUsersRequest {
	r.skip = &skip
	return r
}

func (r ApiImportUsersRequest) Execute() (*ImportUsersResponse, *http.Response, error) {
...
Get a list of users to import from an Application IdM service provider.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param applicationId ObjectID of the Application.
 @return ApiImportUsersRequest
*/
func (a *ApplicationsApiService) ImportUsers(ctx context.Context, applicationId string) ApiImportUsersRequest {
	return ApiImportUsersRequest{
		ApiService: a,
		ctx: ctx,
		applicationId: applicationId,
...
func (a *ApplicationsApiService) ImportUsersExecute(r ApiImportUsersRequest) (*ImportUsersResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
