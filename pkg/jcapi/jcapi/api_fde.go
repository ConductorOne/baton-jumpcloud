...
*/
func (a *FdeApiService) SystemsGetFDEKey(ctx context.Context, systemId string) ApiSystemsGetFDEKeyRequest {
	return ApiSystemsGetFDEKeyRequest{
		ApiService: a,
		ctx: ctx,
		systemId: systemId,
...
//  @return Systemfdekey
func (a *FdeApiService) SystemsGetFDEKeyExecute(r ApiSystemsGetFDEKeyRequest) (*Systemfdekey, *http.Response, error) {
	var (
