...
*/
func (a *Office365ImportApiService) Office365sListImportUsers(ctx context.Context, office365Id string) ApiOffice365sListImportUsersRequest {
	return ApiOffice365sListImportUsersRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *Office365ImportApiService) Office365sListImportUsersExecute(r ApiOffice365sListImportUsersRequest) (*Office365sListImportUsers200Response, *http.Response, error) {
	var (
