...
type ApiBulkUserStatesCreateRequest struct {
	ctx context.Context
...
func (r ApiBulkUserStatesCreateRequest) XOrgId(xOrgId string) ApiBulkUserStatesCreateRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiBulkUserStatesCreateRequest) Body(body BulkScheduledStatechangeCreate) ApiBulkUserStatesCreateRequest {
	r.body = &body
	return r
}

func (r ApiBulkUserStatesCreateRequest) Execute() ([]ScheduledUserstateResult, *http.Response, error) {
...
```
 ...
 @return ApiBulkUserStatesCreateRequest
*/
func (a *BulkJobRequestsApiService) BulkUserStatesCreate(ctx context.Context) ApiBulkUserStatesCreateRequest {
	return ApiBulkUserStatesCreateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *BulkJobRequestsApiService) BulkUserStatesCreateExecute(r ApiBulkUserStatesCreateRequest) ([]ScheduledUserstateResult, *http.Response, error) {
	var (
...
type ApiBulkUserStatesDeleteRequest struct {
	ctx context.Context
	ApiService *BulkJobRequestsApiService
	id string
	xOrgId *string
...
// Organization identifier that can be obtained from console settings.
func (r ApiBulkUserStatesDeleteRequest) XOrgId(xOrgId string) ApiBulkUserStatesDeleteRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiBulkUserStatesDeleteRequest) Execute() (*http.Response, error) {
...
```
 ...
 @return ApiBulkUserStatesDeleteRequest
*/
func (a *BulkJobRequestsApiService) BulkUserStatesDelete(ctx context.Context, id string) ApiBulkUserStatesDeleteRequest {
	return ApiBulkUserStatesDeleteRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *BulkJobRequestsApiService) BulkUserStatesDeleteExecute(r ApiBulkUserStatesDeleteRequest) (*http.Response, error) {
	var (
...
type ApiBulkUserStatesGetNextScheduledRequest struct {
	ctx context.Context
	ApiService *BulkJobRequestsApiService
	users *[]string
	limit *int32
...
func (r ApiBulkUserStatesGetNextScheduledRequest) Users(users []string) ApiBulkUserStatesGetNextScheduledRequest {
	r.users = &users
	return r
}

// The number of records to return at once. Limited to 100.
func (r ApiBulkUserStatesGetNextScheduledRequest) Limit(limit int32) ApiBulkUserStatesGetNextScheduledRequest {
	r.limit = &limit
	return r
}

// The offset into the records to return.
func (r ApiBulkUserStatesGetNextScheduledRequest) Skip(skip int32) ApiBulkUserStatesGetNextScheduledRequest {
	r.skip = &skip
	return r
}

func (r ApiBulkUserStatesGetNextScheduledRequest) Execute() (*BulkUserStatesGetNextScheduled200Response, *http.Response, error) {
...
upcoming activation event _and_ the next upcoming suspension event.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiBulkUserStatesGetNextScheduledRequest
*/
func (a *BulkJobRequestsApiService) BulkUserStatesGetNextScheduled(ctx context.Context) ApiBulkUserStatesGetNextScheduledRequest {
	return ApiBulkUserStatesGetNextScheduledRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *BulkJobRequestsApiService) BulkUserStatesGetNextScheduledExecute(r ApiBulkUserStatesGetNextScheduledRequest) (*BulkUserStatesGetNextScheduled200Response, *http.Response, error) {
	var (
...
type ApiBulkUserStatesListRequest struct {
	ctx context.Context
	ApiService *BulkJobRequestsApiService
	limit *int32
	filter *[]string
...
// The number of records to return at once. Limited to 100.
func (r ApiBulkUserStatesListRequest) Limit(limit int32) ApiBulkUserStatesListRequest {
	r.limit = &limit
	return r
}

// A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
func (r ApiBulkUserStatesListRequest) Filter(filter []string) ApiBulkUserStatesListRequest {
	r.filter = &filter
	return r
}

// The offset into the records to return.
func (r ApiBulkUserStatesListRequest) Skip(skip int32) ApiBulkUserStatesListRequest {
	r.skip = &skip
	return r
}

// Organization identifier that can be obtained from console settings.
func (r ApiBulkUserStatesListRequest) XOrgId(xOrgId string) ApiBulkUserStatesListRequest {
	r.xOrgId = &xOrgId
	return r
}

// The systemuser id to filter by.
func (r ApiBulkUserStatesListRequest) Userid(userid string) ApiBulkUserStatesListRequest {
	r.userid = &userid
	return r
}

func (r ApiBulkUserStatesListRequest) Execute() ([]ScheduledUserstateResult, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiBulkUserStatesListRequest
*/
func (a *BulkJobRequestsApiService) BulkUserStatesList(ctx context.Context) ApiBulkUserStatesListRequest {
	return ApiBulkUserStatesListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []ScheduledUserstateResult
func (a *BulkJobRequestsApiService) BulkUserStatesListExecute(r ApiBulkUserStatesListRequest) ([]ScheduledUserstateResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiBulkUsersCreateRequest struct {
	ctx context.Context
	ApiService *BulkJobRequestsApiService
	xOrgId *string
...
// Organization identifier that can be obtained from console settings.
func (r ApiBulkUsersCreateRequest) XOrgId(xOrgId string) ApiBulkUsersCreateRequest {
	r.xOrgId = &xOrgId
	return r
}
...
func (r ApiBulkUsersCreateRequest) CreationSource(creationSource string) ApiBulkUsersCreateRequest {
	r.creationSource = &creationSource
	return r
}

func (r ApiBulkUsersCreateRequest) Body(body []BulkUserCreate) ApiBulkUsersCreateRequest {
	r.body = &body
	return r
}

func (r ApiBulkUsersCreateRequest) Execute() (*JobId, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiBulkUsersCreateRequest
*/
func (a *BulkJobRequestsApiService) BulkUsersCreate(ctx context.Context) ApiBulkUsersCreateRequest {
	return ApiBulkUsersCreateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return JobId
func (a *BulkJobRequestsApiService) BulkUsersCreateExecute(r ApiBulkUsersCreateRequest) (*JobId, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiBulkUsersCreateResultsRequest struct {
	ctx context.Context
	ApiService *BulkJobRequestsApiService
	jobId string
	limit *int32
...
// The number of records to return at once. Limited to 100.
func (r ApiBulkUsersCreateResultsRequest) Limit(limit int32) ApiBulkUsersCreateResultsRequest {
	r.limit = &limit
	return r
}

// The offset into the records to return.
func (r ApiBulkUsersCreateResultsRequest) Skip(skip int32) ApiBulkUsersCreateResultsRequest {
	r.skip = &skip
	return r
}

// Organization identifier that can be obtained from console settings.
func (r ApiBulkUsersCreateResultsRequest) XOrgId(xOrgId string) ApiBulkUsersCreateResultsRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiBulkUsersCreateResultsRequest) Execute() ([]JobWorkresult, *http.Response, error) {
...
curl -X GET \
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param jobId
 @return ApiBulkUsersCreateResultsRequest
*/
func (a *BulkJobRequestsApiService) BulkUsersCreateResults(ctx context.Context, jobId string) ApiBulkUsersCreateResultsRequest {
	return ApiBulkUsersCreateResultsRequest{
		ApiService: a,
		ctx: ctx,
		jobId: jobId,
...
func (a *BulkJobRequestsApiService) BulkUsersCreateResultsExecute(r ApiBulkUsersCreateResultsRequest) ([]JobWorkresult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiBulkUsersUpdateRequest struct {
	ctx context.Context
	ApiService *BulkJobRequestsApiService
	xOrgId *string
	body *[]BulkUserUpdate
...
// Organization identifier that can be obtained from console settings.
func (r ApiBulkUsersUpdateRequest) XOrgId(xOrgId string) ApiBulkUsersUpdateRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiBulkUsersUpdateRequest) Body(body []BulkUserUpdate) ApiBulkUsersUpdateRequest {
	r.body = &body
	return r
}

func (r ApiBulkUsersUpdateRequest) Execute() (*JobId, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiBulkUsersUpdateRequest
*/
func (a *BulkJobRequestsApiService) BulkUsersUpdate(ctx context.Context) ApiBulkUsersUpdateRequest {
	return ApiBulkUsersUpdateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return JobId
func (a *BulkJobRequestsApiService) BulkUsersUpdateExecute(r ApiBulkUsersUpdateRequest) (*JobId, *http.Response, error) {
	var (
