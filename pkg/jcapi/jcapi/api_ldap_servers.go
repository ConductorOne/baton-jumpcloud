...
*/
func (a *LDAPServersApiService) GraphLdapServerAssociationsList(ctx context.Context, ldapserverId string) ApiGraphLdapServerAssociationsListRequest {
	return ApiGraphLdapServerAssociationsListRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *LDAPServersApiService) GraphLdapServerAssociationsListExecute(r ApiGraphLdapServerAssociationsListRequest) ([]GraphConnection, *http.Response, error) {
	var (
...
*/
func (a *LDAPServersApiService) GraphLdapServerAssociationsPost(ctx context.Context, ldapserverId string) ApiGraphLdapServerAssociationsPostRequest {
	return ApiGraphLdapServerAssociationsPostRequest{
		ApiService: a,
		ctx: ctx,
		ldapserverId: ldapserverId,
...
// Execute executes the request
func (a *LDAPServersApiService) GraphLdapServerAssociationsPostExecute(r ApiGraphLdapServerAssociationsPostRequest) (*http.Response, error) {
	var (
...
*/
func (a *LDAPServersApiService) GraphLdapServerTraverseUser(ctx context.Context, ldapserverId string) ApiGraphLdapServerTraverseUserRequest {
	return ApiGraphLdapServerTraverseUserRequest{
		ApiService: a,
		ctx: ctx,
		ldapserverId: ldapserverId,
...
func (a *LDAPServersApiService) GraphLdapServerTraverseUserExecute(r ApiGraphLdapServerTraverseUserRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *LDAPServersApiService) GraphLdapServerTraverseUserGroup(ctx context.Context, ldapserverId string) ApiGraphLdapServerTraverseUserGroupRequest {
	return ApiGraphLdapServerTraverseUserGroupRequest{
		ApiService: a,
		ctx: ctx,
		ldapserverId: ldapserverId,
...
// Execute executes the request
//  @return []GraphObjectWithPaths
func (a *LDAPServersApiService) GraphLdapServerTraverseUserGroupExecute(r ApiGraphLdapServerTraverseUserGroupRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
// Organization identifier that can be obtained from console settings.
func (r ApiLdapserversGetRequest) XOrgId(xOrgId string) ApiLdapserversGetRequest {
	r.xOrgId = &xOrgId
	return r
}
...
*/
func (a *LDAPServersApiService) LdapserversGet(ctx context.Context, id string) ApiLdapserversGetRequest {
	return ApiLdapserversGetRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return LdapServer
func (a *LDAPServersApiService) LdapserversGetExecute(r ApiLdapserversGetRequest) (*LdapServer, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiLdapserversListRequest struct {
	ctx context.Context
	ApiService *LDAPServersApiService
	fields *[]string
	filter *[]string
...
func (r ApiLdapserversListRequest) Fields(fields []string) ApiLdapserversListRequest {
	r.fields = &fields
	return r
}

// A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
func (r ApiLdapserversListRequest) Filter(filter []string) ApiLdapserversListRequest {
	r.filter = &filter
	return r
}

// The number of records to return at once. Limited to 100.
func (r ApiLdapserversListRequest) Limit(limit int32) ApiLdapserversListRequest {
	r.limit = &limit
	return r
}

// The offset into the records to return.
func (r ApiLdapserversListRequest) Skip(skip int32) ApiLdapserversListRequest {
	r.skip = &skip
	return r
}

// The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. 
func (r ApiLdapserversListRequest) Sort(sort []string) ApiLdapserversListRequest {
	r.sort = &sort
	return r
}

// Organization identifier that can be obtained from console settings.
func (r ApiLdapserversListRequest) XOrgId(xOrgId string) ApiLdapserversListRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiLdapserversListRequest) Execute() ([]LdapServer, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiLdapserversListRequest
*/
func (a *LDAPServersApiService) LdapserversList(ctx context.Context) ApiLdapserversListRequest {
	return ApiLdapserversListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []LdapServer
func (a *LDAPServersApiService) LdapserversListExecute(r ApiLdapserversListRequest) ([]LdapServer, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiLdapserversPatchRequest struct {
	ctx context.Context
	ApiService *LDAPServersApiService
	id string
	xOrgId *string
...
// Organization identifier that can be obtained from console settings.
func (r ApiLdapserversPatchRequest) XOrgId(xOrgId string) ApiLdapserversPatchRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiLdapserversPatchRequest) Body(body LdapserversPatchRequest) ApiLdapserversPatchRequest {
	r.body = &body
	return r
}

func (r ApiLdapserversPatchRequest) Execute() (*LdapserversPatch200Response, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id Unique identifier of the LDAP server.
 @return ApiLdapserversPatchRequest
*/
func (a *LDAPServersApiService) LdapserversPatch(ctx context.Context, id string) ApiLdapserversPatchRequest {
	return ApiLdapserversPatchRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *LDAPServersApiService) LdapserversPatchExecute(r ApiLdapserversPatchRequest) (*LdapserversPatch200Response, *http.Response, error) {
	var (
