...
*/
func (a *PolicytemplatesApiService) PolicytemplatesGet(ctx context.Context, id string) ApiPolicytemplatesGetRequest {
	return ApiPolicytemplatesGetRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *PolicytemplatesApiService) PolicytemplatesGetExecute(r ApiPolicytemplatesGetRequest) (*PolicyTemplateWithDetails, *http.Response, error) {
	var (
...
*/
func (a *PolicytemplatesApiService) PolicytemplatesList(ctx context.Context) ApiPolicytemplatesListRequest {
	return ApiPolicytemplatesListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *PolicytemplatesApiService) PolicytemplatesListExecute(r ApiPolicytemplatesListRequest) ([]PolicyTemplate, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
