...
type ApiCommandsCancelQueuedCommandsByWorkflowInstanceIdRequest struct {
	ctx context.Context
...
func (r ApiCommandsCancelQueuedCommandsByWorkflowInstanceIdRequest) XOrgId(xOrgId string) ApiCommandsCancelQueuedCommandsByWorkflowInstanceIdRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiCommandsCancelQueuedCommandsByWorkflowInstanceIdRequest) Execute() (*http.Response, error) {
...
```
 ...
 @return ApiCommandsCancelQueuedCommandsByWorkflowInstanceIdRequest
*/
func (a *CommandsApiService) CommandsCancelQueuedCommandsByWorkflowInstanceId(ctx context.Context, workflowInstanceId string) ApiCommandsCancelQueuedCommandsByWorkflowInstanceIdRequest {
	return ApiCommandsCancelQueuedCommandsByWorkflowInstanceIdRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *CommandsApiService) CommandsCancelQueuedCommandsByWorkflowInstanceIdExecute(r ApiCommandsCancelQueuedCommandsByWorkflowInstanceIdRequest) (*http.Response, error) {
	var (
...
type ApiCommandsGetQueuedCommandsByWorkflowRequest struct {
	ctx context.Context
	ApiService *CommandsApiService
	xOrgId *string
	limit *int32
...
// Organization identifier that can be obtained from console settings.
func (r ApiCommandsGetQueuedCommandsByWorkflowRequest) XOrgId(xOrgId string) ApiCommandsGetQueuedCommandsByWorkflowRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r ApiCommandsGetQueuedCommandsByWorkflowRequest) Limit(limit int32) ApiCommandsGetQueuedCommandsByWorkflowRequest {
	r.limit = &limit
	return r
}

// A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
func (r ApiCommandsGetQueuedCommandsByWorkflowRequest) Filter(filter []string) ApiCommandsGetQueuedCommandsByWorkflowRequest {
	r.filter = &filter
	return r
}

// The offset into the records to return.
func (r ApiCommandsGetQueuedCommandsByWorkflowRequest) Skip(skip int32) ApiCommandsGetQueuedCommandsByWorkflowRequest {
	r.skip = &skip
	return r
}

func (r ApiCommandsGetQueuedCommandsByWorkflowRequest) Execute() (*QueuedCommandList, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCommandsGetQueuedCommandsByWorkflowRequest
*/
func (a *CommandsApiService) CommandsGetQueuedCommandsByWorkflow(ctx context.Context) ApiCommandsGetQueuedCommandsByWorkflowRequest {
	return ApiCommandsGetQueuedCommandsByWorkflowRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *CommandsApiService) CommandsGetQueuedCommandsByWorkflowExecute(r ApiCommandsGetQueuedCommandsByWorkflowRequest) (*QueuedCommandList, *http.Response, error) {
	var (
...
*/
func (a *CommandsApiService) GraphCommandAssociationsList(ctx context.Context, commandId string) ApiGraphCommandAssociationsListRequest {
	return ApiGraphCommandAssociationsListRequest{
		ApiService: a,
		ctx: ctx,
		commandId: commandId,
...
func (a *CommandsApiService) GraphCommandAssociationsListExecute(r ApiGraphCommandAssociationsListRequest) ([]GraphConnection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *CommandsApiService) GraphCommandAssociationsPost(ctx context.Context, commandId string) ApiGraphCommandAssociationsPostRequest {
	return ApiGraphCommandAssociationsPostRequest{
		ApiService: a,
		ctx: ctx,
		commandId: commandId,
...
// Execute executes the request
func (a *CommandsApiService) GraphCommandAssociationsPostExecute(r ApiGraphCommandAssociationsPostRequest) (*http.Response, error) {
	var (
...
*/
func (a *CommandsApiService) GraphCommandTraverseSystem(ctx context.Context, commandId string) ApiGraphCommandTraverseSystemRequest {
	return ApiGraphCommandTraverseSystemRequest{
		ApiService: a,
		ctx: ctx,
		commandId: commandId,
...
func (a *CommandsApiService) GraphCommandTraverseSystemExecute(r ApiGraphCommandTraverseSystemRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *CommandsApiService) GraphCommandTraverseSystemGroup(ctx context.Context, commandId string) ApiGraphCommandTraverseSystemGroupRequest {
	return ApiGraphCommandTraverseSystemGroupRequest{
		ApiService: a,
		ctx: ctx,
		commandId: commandId,
...
// Execute executes the request
//  @return []GraphObjectWithPaths
func (a *CommandsApiService) GraphCommandTraverseSystemGroupExecute(r ApiGraphCommandTraverseSystemGroupRequest) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
