...
*/
func (a *GSuiteImportApiService) GsuitesListImportJumpcloudUsers(ctx context.Context, gsuiteId string) ApiGsuitesListImportJumpcloudUsersRequest {
	return ApiGsuitesListImportJumpcloudUsersRequest{
		ApiService: a,
		ctx: ctx,
		gsuiteId: gsuiteId,
...
func (a *GSuiteImportApiService) GsuitesListImportJumpcloudUsersExecute(r ApiGsuitesListImportJumpcloudUsersRequest) (*GsuitesListImportJumpcloudUsers200Response, *http.Response, error) {
	var (
...
*/
func (a *GSuiteImportApiService) GsuitesListImportUsers(ctx context.Context, gsuiteId string) ApiGsuitesListImportUsersRequest {
	return ApiGsuitesListImportUsersRequest{
		ApiService: a,
		ctx: ctx,
		gsuiteId: gsuiteId,
...
func (a *GSuiteImportApiService) GsuitesListImportUsersExecute(r ApiGsuitesListImportUsersRequest) (*GsuitesListImportUsers200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
