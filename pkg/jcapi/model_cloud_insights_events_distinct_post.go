...
// checks if the CloudInsightsEventsDistinctPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudInsightsEventsDistinctPost{}

// CloudInsightsEventsDistinctPost Properties of a Cloud Insights events distinct POST request object
type CloudInsightsEventsDistinctPost struct {
	...
	StartTime CloudInsightsEventsDistinctPostEndTime `json:"startTime"`
	AdditionalProperties map[string]interface{}
}

type _CloudInsightsEventsDistinctPost CloudInsightsEventsDistinctPost
...
func NewCloudInsightsEventsDistinctPost(awsAccounts []string, startTime CloudInsightsEventsDistinctPostEndTime) *CloudInsightsEventsDistinctPost {
	this := CloudInsightsEventsDistinctPost{}
...
// GetAwsAccounts returns the AwsAccounts field value
...
// GetAwsAccountsOk returns a tuple with the AwsAccounts field value
...
// SetAwsAccounts sets field value
...
func (o CloudInsightsEventsDistinctPost) MarshalJSON() ([]byte, error) {
...
func (o CloudInsightsEventsDistinctPost) ToMap() (map[string]interface{}, error) {
...
func (o *CloudInsightsEventsDistinctPost) UnmarshalJSON(bytes []byte) (err error) {
	varCloudInsightsEventsDistinctPost := _CloudInsightsEventsDistinctPost{}

	if err = json.Unmarshal(bytes, &varCloudInsightsEventsDistinctPost); err == nil {
		*o = CloudInsightsEventsDistinctPost(varCloudInsightsEventsDistinctPost)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "awsAccounts")
		delete(additionalProperties, "endTime")
		delete(additionalProperties, "field")
		delete(additionalProperties, "npeFilter")
...
type NullableCloudInsightsEventsDistinctPost struct {
	value *CloudInsightsEventsDistinctPost
	isSet bool
}

func (v NullableCloudInsightsEventsDistinctPost) Get() *CloudInsightsEventsDistinctPost {
	return v.value
}

func (v *NullableCloudInsightsEventsDistinctPost) Set(val *CloudInsightsEventsDistinctPost) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudInsightsEventsDistinctPost) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudInsightsEventsDistinctPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudInsightsEventsDistinctPost(val *CloudInsightsEventsDistinctPost) *NullableCloudInsightsEventsDistinctPost {
	return &NullableCloudInsightsEventsDistinctPost{value: val, isSet: true}
}

func (v NullableCloudInsightsEventsDistinctPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudInsightsEventsDistinctPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
