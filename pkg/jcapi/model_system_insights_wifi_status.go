...
// checks if the SystemInsightsWifiStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemInsightsWifiStatus{}

// SystemInsightsWifiStatus struct for SystemInsightsWifiStatus
type SystemInsightsWifiStatus struct {
	Bssid *string `json:"bssid,omitempty"`
	Channel *float32 `json:"channel,omitempty"`
	ChannelBand *float32 `json:"channel_band,omitempty"`
	ChannelWidth *float32 `json:"channel_width,omitempty"`
	...
	TransmitRate *string `json:"transmit_rate,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _SystemInsightsWifiStatus SystemInsightsWifiStatus
...
// SetChannel gets a reference to the given float32 and assigns it to the Channel field.
func (o *SystemInsightsWifiStatus) SetChannel(v float32) {
	o.Channel = &v
}

// GetChannelBand returns the ChannelBand field value if set, zero value otherwise.
func (o *SystemInsightsWifiStatus) GetChannelBand() float32 {
	if o == nil || IsNil(o.ChannelBand) {
		var ret float32
		return ret
	}
	return *o.ChannelBand
}

// GetChannelBandOk returns a tuple with the ChannelBand field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SystemInsightsWifiStatus) GetChannelBandOk() (*float32, bool) {
	if o == nil || IsNil(o.ChannelBand) {
		return nil, false
	}
	return o.ChannelBand, true
}
...
// SetChannelBand gets a reference to the given float32 and assigns it to the ChannelBand field.
...
// SetChannelWidth gets a reference to the given float32 and assigns it to the ChannelWidth field.
...
func (o *SystemInsightsWifiStatus) HasSecurityType() bool {
	if o != nil && !IsNil(o.SecurityType) {
		return true
	}
...
// GetTransmitRate returns the TransmitRate field value if set, zero value otherwise.
func (o *SystemInsightsWifiStatus) GetTransmitRate() string {
	if o == nil || IsNil(o.TransmitRate) {
		var ret string
		return ret
	}
	return *o.TransmitRate
}

// GetTransmitRateOk returns a tuple with the TransmitRate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SystemInsightsWifiStatus) GetTransmitRateOk() (*string, bool) {
	if o == nil || IsNil(o.TransmitRate) {
		return nil, false
	}
	return o.TransmitRate, true
}
...
// SetTransmitRate gets a reference to the given string and assigns it to the TransmitRate field.
func (o *SystemInsightsWifiStatus) SetTransmitRate(v string) {
	o.TransmitRate = &v
}

func (o SystemInsightsWifiStatus) MarshalJSON() ([]byte, error) {
...
func (o SystemInsightsWifiStatus) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ChannelBand) {
		toSerialize["channel_band"] = o.ChannelBand
	}
	...
	if !IsNil(o.TransmitRate) {
		toSerialize["transmit_rate"] = o.TransmitRate
	}
...
func (o *SystemInsightsWifiStatus) UnmarshalJSON(bytes []byte) (err error) {
	varSystemInsightsWifiStatus := _SystemInsightsWifiStatus{}

	if err = json.Unmarshal(bytes, &varSystemInsightsWifiStatus); err == nil {
		*o = SystemInsightsWifiStatus(varSystemInsightsWifiStatus)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "channel_band")
		...
		delete(additionalProperties, "transmit_rate")
...
type NullableSystemInsightsWifiStatus struct {
	value *SystemInsightsWifiStatus
	isSet bool
}

func (v NullableSystemInsightsWifiStatus) Get() *SystemInsightsWifiStatus {
	return v.value
}

func (v *NullableSystemInsightsWifiStatus) Set(val *SystemInsightsWifiStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemInsightsWifiStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemInsightsWifiStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemInsightsWifiStatus(val *SystemInsightsWifiStatus) *NullableSystemInsightsWifiStatus {
	return &NullableSystemInsightsWifiStatus{value: val, isSet: true}
}

func (v NullableSystemInsightsWifiStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemInsightsWifiStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
