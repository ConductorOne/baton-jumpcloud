...
// checks if the AuthInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthInput{}
...
// SetBasic gets a reference to the given AuthInputBasic and assigns it to the Basic field.
...
// SetOauth gets a reference to the given AuthInputOauth and assigns it to the Oauth field.
func (o *AuthInput) SetOauth(v AuthInputOauth) {
	o.Oauth = &v
}

func (o AuthInput) MarshalJSON() ([]byte, error) {
...
func (o AuthInput) ToMap() (map[string]interface{}, error) {
...
func (o *AuthInput) UnmarshalJSON(bytes []byte) (err error) {
	varAuthInput := _AuthInput{}

	if err = json.Unmarshal(bytes, &varAuthInput); err == nil {
		*o = AuthInput(varAuthInput)
	}
