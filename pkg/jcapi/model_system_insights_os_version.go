...
// checks if the SystemInsightsOsVersion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemInsightsOsVersion{}

// SystemInsightsOsVersion struct for SystemInsightsOsVersion
...
type _SystemInsightsOsVersion SystemInsightsOsVersion
...
// GetPlatformLike returns the PlatformLike field value if set, zero value otherwise.
func (o *SystemInsightsOsVersion) GetPlatformLike() string {
	if o == nil || IsNil(o.PlatformLike) {
		var ret string
		return ret
	}
	return *o.PlatformLike
}

// GetPlatformLikeOk returns a tuple with the PlatformLike field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SystemInsightsOsVersion) GetPlatformLikeOk() (*string, bool) {
	if o == nil || IsNil(o.PlatformLike) {
		return nil, false
	}
	return o.PlatformLike, true
}
...
// SetPlatformLike gets a reference to the given string and assigns it to the PlatformLike field.
...
func (o SystemInsightsOsVersion) MarshalJSON() ([]byte, error) {
...
func (o SystemInsightsOsVersion) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PlatformLike) {
		toSerialize["platform_like"] = o.PlatformLike
	}
	if !IsNil(o.SystemId) {
...
func (o *SystemInsightsOsVersion) UnmarshalJSON(bytes []byte) (err error) {
	varSystemInsightsOsVersion := _SystemInsightsOsVersion{}

	if err = json.Unmarshal(bytes, &varSystemInsightsOsVersion); err == nil {
		*o = SystemInsightsOsVersion(varSystemInsightsOsVersion)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "platform_like")
...
type NullableSystemInsightsOsVersion struct {
	value *SystemInsightsOsVersion
	isSet bool
}

func (v NullableSystemInsightsOsVersion) Get() *SystemInsightsOsVersion {
	return v.value
}

func (v *NullableSystemInsightsOsVersion) Set(val *SystemInsightsOsVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemInsightsOsVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemInsightsOsVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemInsightsOsVersion(val *SystemInsightsOsVersion) *NullableSystemInsightsOsVersion {
	return &NullableSystemInsightsOsVersion{value: val, isSet: true}
}

func (v NullableSystemInsightsOsVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemInsightsOsVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
