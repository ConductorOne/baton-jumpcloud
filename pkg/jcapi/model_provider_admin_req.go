...
// checks if the ProviderAdminReq type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProviderAdminReq{}

// ProviderAdminReq struct for ProviderAdminReq
type ProviderAdminReq struct {
	BindNoOrgs *bool `json:"bindNoOrgs,omitempty"`
...
type _ProviderAdminReq ProviderAdminReq
...
func NewProviderAdminReq(email string) *ProviderAdminReq {
	this := ProviderAdminReq{}
	var bindNoOrgs bool = false
...
// GetBindNoOrgs returns the BindNoOrgs field value if set, zero value otherwise.
func (o *ProviderAdminReq) GetBindNoOrgs() bool {
	if o == nil || IsNil(o.BindNoOrgs) {
		var ret bool
		return ret
	}
	return *o.BindNoOrgs
...
// GetBindNoOrgsOk returns a tuple with the BindNoOrgs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProviderAdminReq) GetBindNoOrgsOk() (*bool, bool) {
	if o == nil || IsNil(o.BindNoOrgs) {
		return nil, false
	}
	return o.BindNoOrgs, true
}
...
// SetBindNoOrgs gets a reference to the given bool and assigns it to the BindNoOrgs field.
...
func (o ProviderAdminReq) MarshalJSON() ([]byte, error) {
...
func (o ProviderAdminReq) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.BindNoOrgs) {
		toSerialize["bindNoOrgs"] = o.BindNoOrgs
	}
...
func (o *ProviderAdminReq) UnmarshalJSON(bytes []byte) (err error) {
	varProviderAdminReq := _ProviderAdminReq{}

	if err = json.Unmarshal(bytes, &varProviderAdminReq); err == nil {
		*o = ProviderAdminReq(varProviderAdminReq)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "bindNoOrgs")
...
type NullableProviderAdminReq struct {
	value *ProviderAdminReq
	isSet bool
}

func (v NullableProviderAdminReq) Get() *ProviderAdminReq {
	return v.value
}

func (v *NullableProviderAdminReq) Set(val *ProviderAdminReq) {
	v.value = val
	v.isSet = true
}

func (v NullableProviderAdminReq) IsSet() bool {
	return v.isSet
}

func (v *NullableProviderAdminReq) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProviderAdminReq(val *ProviderAdminReq) *NullableProviderAdminReq {
	return &NullableProviderAdminReq{value: val, isSet: true}
}

func (v NullableProviderAdminReq) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProviderAdminReq) UnmarshalJSON(src []byte) error {
	v.isSet = true
