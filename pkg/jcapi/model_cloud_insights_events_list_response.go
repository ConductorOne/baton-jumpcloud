...
// checks if the CloudInsightsEventsListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudInsightsEventsListResponse{}

// CloudInsightsEventsListResponse Properties of a Cloud Insights trail GET list response object
type CloudInsightsEventsListResponse struct {
	Events []CloudInsightsEventsListEvents `json:"events,omitempty"`
	SearchAfter map[string]interface{} `json:"searchAfter,omitempty"`
	TotalCount *float32 `json:"totalCount,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _CloudInsightsEventsListResponse CloudInsightsEventsListResponse
...
func NewCloudInsightsEventsListResponse() *CloudInsightsEventsListResponse {
	this := CloudInsightsEventsListResponse{}
	return &this
}
...
func (o *CloudInsightsEventsListResponse) GetEvents() []CloudInsightsEventsListEvents {
	if o == nil || IsNil(o.Events) {
		var ret []CloudInsightsEventsListEvents
		return ret
	}
	return o.Events
}
...
// SetEvents gets a reference to the given []CloudInsightsEventsListEvents and assigns it to the Events field.
...
func (o CloudInsightsEventsListResponse) MarshalJSON() ([]byte, error) {
...
func (o CloudInsightsEventsListResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CloudInsightsEventsListResponse) UnmarshalJSON(bytes []byte) (err error) {
	varCloudInsightsEventsListResponse := _CloudInsightsEventsListResponse{}

	if err = json.Unmarshal(bytes, &varCloudInsightsEventsListResponse); err == nil {
		*o = CloudInsightsEventsListResponse(varCloudInsightsEventsListResponse)
	}
...
type NullableCloudInsightsEventsListResponse struct {
	value *CloudInsightsEventsListResponse
	isSet bool
}

func (v NullableCloudInsightsEventsListResponse) Get() *CloudInsightsEventsListResponse {
	return v.value
}

func (v *NullableCloudInsightsEventsListResponse) Set(val *CloudInsightsEventsListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudInsightsEventsListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudInsightsEventsListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudInsightsEventsListResponse(val *CloudInsightsEventsListResponse) *NullableCloudInsightsEventsListResponse {
	return &NullableCloudInsightsEventsListResponse{value: val, isSet: true}
}

func (v NullableCloudInsightsEventsListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudInsightsEventsListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
