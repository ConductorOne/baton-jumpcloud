...
// checks if the BulkUserCreate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkUserCreate{}

// BulkUserCreate See [V1 system user creation](https://docs.jumpcloud.com/api/1.0/index.html#operation/systemusers_post) for full list of attributes.
...
type _BulkUserCreate BulkUserCreate
...
func (o BulkUserCreate) MarshalJSON() ([]byte, error) {
...
func (o BulkUserCreate) ToMap() (map[string]interface{}, error) {
...
func (o *BulkUserCreate) UnmarshalJSON(bytes []byte) (err error) {
	varBulkUserCreate := _BulkUserCreate{}

	if err = json.Unmarshal(bytes, &varBulkUserCreate); err == nil {
		*o = BulkUserCreate(varBulkUserCreate)
	}
...
type NullableBulkUserCreate struct {
	value *BulkUserCreate
	isSet bool
}

func (v NullableBulkUserCreate) Get() *BulkUserCreate {
	return v.value
}

func (v *NullableBulkUserCreate) Set(val *BulkUserCreate) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkUserCreate) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkUserCreate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkUserCreate(val *BulkUserCreate) *NullableBulkUserCreate {
	return &NullableBulkUserCreate{value: val, isSet: true}
}

func (v NullableBulkUserCreate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkUserCreate) UnmarshalJSON(src []byte) error {
	v.isSet = true
