...
type _CloudInsightsEventsListPost CloudInsightsEventsListPost
...
func (o *CloudInsightsEventsListPost) UnmarshalJSON(bytes []byte) (err error) {
	varCloudInsightsEventsListPost := _CloudInsightsEventsListPost{}

	if err = json.Unmarshal(bytes, &varCloudInsightsEventsListPost); err == nil {
		*o = CloudInsightsEventsListPost(varCloudInsightsEventsListPost)
	}
