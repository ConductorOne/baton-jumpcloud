...
// checks if the SyncroTicketingAlertConfigurationRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SyncroTicketingAlertConfigurationRequest{}

// SyncroTicketingAlertConfigurationRequest A SyncroTicketingAlertConfigurationRequest to update Syncro ticketing configuration.
type SyncroTicketingAlertConfigurationRequest struct {
...
type _SyncroTicketingAlertConfigurationRequest SyncroTicketingAlertConfigurationRequest
...
func NewSyncroTicketingAlertConfigurationRequest(problemType string, shouldCreateTickets bool) *SyncroTicketingAlertConfigurationRequest {
	this := SyncroTicketingAlertConfigurationRequest{}
...
func (o SyncroTicketingAlertConfigurationRequest) MarshalJSON() ([]byte, error) {
...
func (o SyncroTicketingAlertConfigurationRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SyncroTicketingAlertConfigurationRequest) UnmarshalJSON(bytes []byte) (err error) {
	varSyncroTicketingAlertConfigurationRequest := _SyncroTicketingAlertConfigurationRequest{}

	if err = json.Unmarshal(bytes, &varSyncroTicketingAlertConfigurationRequest); err == nil {
		*o = SyncroTicketingAlertConfigurationRequest(varSyncroTicketingAlertConfigurationRequest)
	}
...
type NullableSyncroTicketingAlertConfigurationRequest struct {
	value *SyncroTicketingAlertConfigurationRequest
	isSet bool
}

func (v NullableSyncroTicketingAlertConfigurationRequest) Get() *SyncroTicketingAlertConfigurationRequest {
	return v.value
}

func (v *NullableSyncroTicketingAlertConfigurationRequest) Set(val *SyncroTicketingAlertConfigurationRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSyncroTicketingAlertConfigurationRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSyncroTicketingAlertConfigurationRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyncroTicketingAlertConfigurationRequest(val *SyncroTicketingAlertConfigurationRequest) *NullableSyncroTicketingAlertConfigurationRequest {
	return &NullableSyncroTicketingAlertConfigurationRequest{value: val, isSet: true}
}

func (v NullableSyncroTicketingAlertConfigurationRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyncroTicketingAlertConfigurationRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
