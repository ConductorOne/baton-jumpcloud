...
// checks if the SyncroMappingResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SyncroMappingResponse{}

// SyncroMappingResponse Syncro mapping GET response
type SyncroMappingResponse struct {
...
type _SyncroMappingResponse SyncroMappingResponse
...
func (o SyncroMappingResponse) MarshalJSON() ([]byte, error) {
...
func (o SyncroMappingResponse) ToMap() (map[string]interface{}, error) {
...
func (o *SyncroMappingResponse) UnmarshalJSON(bytes []byte) (err error) {
	varSyncroMappingResponse := _SyncroMappingResponse{}

	if err = json.Unmarshal(bytes, &varSyncroMappingResponse); err == nil {
		*o = SyncroMappingResponse(varSyncroMappingResponse)
	}
...
type NullableSyncroMappingResponse struct {
	value *SyncroMappingResponse
	isSet bool
}

func (v NullableSyncroMappingResponse) Get() *SyncroMappingResponse {
	return v.value
}

func (v *NullableSyncroMappingResponse) Set(val *SyncroMappingResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSyncroMappingResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSyncroMappingResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyncroMappingResponse(val *SyncroMappingResponse) *NullableSyncroMappingResponse {
	return &NullableSyncroMappingResponse{value: val, isSet: true}
}

func (v NullableSyncroMappingResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyncroMappingResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
