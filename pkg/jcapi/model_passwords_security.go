...
// checks if the PasswordsSecurity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PasswordsSecurity{}

// PasswordsSecurity struct for PasswordsSecurity
type PasswordsSecurity struct {
...
type _PasswordsSecurity PasswordsSecurity
...
func (o PasswordsSecurity) MarshalJSON() ([]byte, error) {
...
func (o PasswordsSecurity) ToMap() (map[string]interface{}, error) {
...
func (o *PasswordsSecurity) UnmarshalJSON(bytes []byte) (err error) {
	varPasswordsSecurity := _PasswordsSecurity{}

	if err = json.Unmarshal(bytes, &varPasswordsSecurity); err == nil {
		*o = PasswordsSecurity(varPasswordsSecurity)
	}
...
type NullablePasswordsSecurity struct {
	value *PasswordsSecurity
	isSet bool
}

func (v NullablePasswordsSecurity) Get() *PasswordsSecurity {
	return v.value
}

func (v *NullablePasswordsSecurity) Set(val *PasswordsSecurity) {
	v.value = val
	v.isSet = true
}

func (v NullablePasswordsSecurity) IsSet() bool {
	return v.isSet
}

func (v *NullablePasswordsSecurity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePasswordsSecurity(val *PasswordsSecurity) *NullablePasswordsSecurity {
	return &NullablePasswordsSecurity{value: val, isSet: true}
}

func (v NullablePasswordsSecurity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePasswordsSecurity) UnmarshalJSON(src []byte) error {
	v.isSet = true
