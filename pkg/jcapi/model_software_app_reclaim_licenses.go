...
// checks if the SoftwareAppReclaimLicenses type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SoftwareAppReclaimLicenses{}

// SoftwareAppReclaimLicenses struct for SoftwareAppReclaimLicenses
type SoftwareAppReclaimLicenses struct {
	AssignedLicenses *int32 `json:"assignedLicenses,omitempty"`
	AvailableLicenses *int32 `json:"availableLicenses,omitempty"`
	ReclaimedLicenses *int32 `json:"reclaimedLicenses,omitempty"`
	TotalLicenses *int32 `json:"totalLicenses,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _SoftwareAppReclaimLicenses SoftwareAppReclaimLicenses
...
func NewSoftwareAppReclaimLicenses() *SoftwareAppReclaimLicenses {
	this := SoftwareAppReclaimLicenses{}
	return &this
}
...
// GetReclaimedLicenses returns the ReclaimedLicenses field value if set, zero value otherwise.
func (o *SoftwareAppReclaimLicenses) GetReclaimedLicenses() int32 {
	if o == nil || IsNil(o.ReclaimedLicenses) {
		var ret int32
		return ret
	}
	return *o.ReclaimedLicenses
}

// GetReclaimedLicensesOk returns a tuple with the ReclaimedLicenses field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SoftwareAppReclaimLicenses) GetReclaimedLicensesOk() (*int32, bool) {
	if o == nil || IsNil(o.ReclaimedLicenses) {
		return nil, false
	}
	return o.ReclaimedLicenses, true
}
...
// SetReclaimedLicenses gets a reference to the given int32 and assigns it to the ReclaimedLicenses field.
func (o *SoftwareAppReclaimLicenses) SetReclaimedLicenses(v int32) {
	o.ReclaimedLicenses = &v
}
...
func (o SoftwareAppReclaimLicenses) MarshalJSON() ([]byte, error) {
...
func (o SoftwareAppReclaimLicenses) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ReclaimedLicenses) {
		toSerialize["reclaimedLicenses"] = o.ReclaimedLicenses
	}
...
func (o *SoftwareAppReclaimLicenses) UnmarshalJSON(bytes []byte) (err error) {
	varSoftwareAppReclaimLicenses := _SoftwareAppReclaimLicenses{}

	if err = json.Unmarshal(bytes, &varSoftwareAppReclaimLicenses); err == nil {
		*o = SoftwareAppReclaimLicenses(varSoftwareAppReclaimLicenses)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "reclaimedLicenses")
...
type NullableSoftwareAppReclaimLicenses struct {
	value *SoftwareAppReclaimLicenses
	isSet bool
}

func (v NullableSoftwareAppReclaimLicenses) Get() *SoftwareAppReclaimLicenses {
	return v.value
}

func (v *NullableSoftwareAppReclaimLicenses) Set(val *SoftwareAppReclaimLicenses) {
	v.value = val
	v.isSet = true
}

func (v NullableSoftwareAppReclaimLicenses) IsSet() bool {
	return v.isSet
}

func (v *NullableSoftwareAppReclaimLicenses) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSoftwareAppReclaimLicenses(val *SoftwareAppReclaimLicenses) *NullableSoftwareAppReclaimLicenses {
	return &NullableSoftwareAppReclaimLicenses{value: val, isSet: true}
}

func (v NullableSoftwareAppReclaimLicenses) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSoftwareAppReclaimLicenses) UnmarshalJSON(src []byte) error {
	v.isSet = true
