...
// checks if the SystemInsightsSafariExtensions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemInsightsSafariExtensions{}

// SystemInsightsSafariExtensions struct for SystemInsightsSafariExtensions
...
type _SystemInsightsSafariExtensions SystemInsightsSafariExtensions
...
func NewSystemInsightsSafariExtensions() *SystemInsightsSafariExtensions {
	this := SystemInsightsSafariExtensions{}
	return &this
}
...
func (o *SystemInsightsSafariExtensions) GetName() string {
...
func (o SystemInsightsSafariExtensions) MarshalJSON() ([]byte, error) {
...
func (o SystemInsightsSafariExtensions) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DeveloperId) {
		toSerialize["developer_id"] = o.DeveloperId
	}
...
func (o *SystemInsightsSafariExtensions) UnmarshalJSON(bytes []byte) (err error) {
	varSystemInsightsSafariExtensions := _SystemInsightsSafariExtensions{}

	if err = json.Unmarshal(bytes, &varSystemInsightsSafariExtensions); err == nil {
		*o = SystemInsightsSafariExtensions(varSystemInsightsSafariExtensions)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "developer_id")
		...
		delete(additionalProperties, "update_url")
...
type NullableSystemInsightsSafariExtensions struct {
	value *SystemInsightsSafariExtensions
	isSet bool
}

func (v NullableSystemInsightsSafariExtensions) Get() *SystemInsightsSafariExtensions {
	return v.value
}

func (v *NullableSystemInsightsSafariExtensions) Set(val *SystemInsightsSafariExtensions) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemInsightsSafariExtensions) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemInsightsSafariExtensions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemInsightsSafariExtensions(val *SystemInsightsSafariExtensions) *NullableSystemInsightsSafariExtensions {
	return &NullableSystemInsightsSafariExtensions{value: val, isSet: true}
}

func (v NullableSystemInsightsSafariExtensions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemInsightsSafariExtensions) UnmarshalJSON(src []byte) error {
	v.isSet = true
