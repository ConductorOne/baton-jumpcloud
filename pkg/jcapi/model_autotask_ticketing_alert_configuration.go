...
// checks if the AutotaskTicketingAlertConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AutotaskTicketingAlertConfiguration{}

// AutotaskTicketingAlertConfiguration An AutotaskTicketingAlertConfiguration object requires a queueId if the destination is queue. If the destination is resource, resource.id and resource.role.id are required.
type AutotaskTicketingAlertConfiguration struct {
...
type _AutotaskTicketingAlertConfiguration AutotaskTicketingAlertConfiguration
...
func NewAutotaskTicketingAlertConfiguration() *AutotaskTicketingAlertConfiguration {
	this := AutotaskTicketingAlertConfiguration{}
	return &this
}
...
func (o AutotaskTicketingAlertConfiguration) MarshalJSON() ([]byte, error) {
...
func (o AutotaskTicketingAlertConfiguration) ToMap() (map[string]interface{}, error) {
...
func (o *AutotaskTicketingAlertConfiguration) UnmarshalJSON(bytes []byte) (err error) {
	varAutotaskTicketingAlertConfiguration := _AutotaskTicketingAlertConfiguration{}

	if err = json.Unmarshal(bytes, &varAutotaskTicketingAlertConfiguration); err == nil {
		*o = AutotaskTicketingAlertConfiguration(varAutotaskTicketingAlertConfiguration)
	}
...
type NullableAutotaskTicketingAlertConfiguration struct {
	value *AutotaskTicketingAlertConfiguration
	isSet bool
}

func (v NullableAutotaskTicketingAlertConfiguration) Get() *AutotaskTicketingAlertConfiguration {
	return v.value
}

func (v *NullableAutotaskTicketingAlertConfiguration) Set(val *AutotaskTicketingAlertConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableAutotaskTicketingAlertConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableAutotaskTicketingAlertConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAutotaskTicketingAlertConfiguration(val *AutotaskTicketingAlertConfiguration) *NullableAutotaskTicketingAlertConfiguration {
	return &NullableAutotaskTicketingAlertConfiguration{value: val, isSet: true}
}

func (v NullableAutotaskTicketingAlertConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAutotaskTicketingAlertConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
