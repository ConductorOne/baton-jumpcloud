...
func (r GroupsApiGroupsListRequest) Filter(filter []string) GroupsApiGroupsListRequest {
	r.filter = &filter
	return r
}
...
func (r GroupsApiGroupsListRequest) Skip(skip int32) GroupsApiGroupsListRequest {
	r.skip = &skip
	return r
}

// The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. 
func (r GroupsApiGroupsListRequest) Sort(sort []string) GroupsApiGroupsListRequest {
	r.sort = &sort
	return r
}

// Organization identifier that can be obtained from console settings.
func (r GroupsApiGroupsListRequest) XOrgId(xOrgId string) GroupsApiGroupsListRequest {
	r.xOrgId = &xOrgId
	return r
}
...
func (r GroupsApiGroupsListRequest) XUnfilteredTotalCount(xUnfilteredTotalCount int32) GroupsApiGroupsListRequest {
