...
// checks if the SystemInsightsManagedPolicies type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemInsightsManagedPolicies{}

// SystemInsightsManagedPolicies struct for SystemInsightsManagedPolicies
...
type _SystemInsightsManagedPolicies SystemInsightsManagedPolicies
...
func NewSystemInsightsManagedPolicies() *SystemInsightsManagedPolicies {
	this := SystemInsightsManagedPolicies{}
	return &this
}
...
func (o *SystemInsightsManagedPolicies) SetCollectionTime(v string) {
	o.CollectionTime = &v
}
...
// SetManual gets a reference to the given int32 and assigns it to the Manual field.
...
func (o SystemInsightsManagedPolicies) MarshalJSON() ([]byte, error) {
...
func (o SystemInsightsManagedPolicies) ToMap() (map[string]interface{}, error) {
...
func (o *SystemInsightsManagedPolicies) UnmarshalJSON(bytes []byte) (err error) {
	varSystemInsightsManagedPolicies := _SystemInsightsManagedPolicies{}

	if err = json.Unmarshal(bytes, &varSystemInsightsManagedPolicies); err == nil {
		*o = SystemInsightsManagedPolicies(varSystemInsightsManagedPolicies)
	}
...
type NullableSystemInsightsManagedPolicies struct {
	value *SystemInsightsManagedPolicies
	isSet bool
}

func (v NullableSystemInsightsManagedPolicies) Get() *SystemInsightsManagedPolicies {
	return v.value
}

func (v *NullableSystemInsightsManagedPolicies) Set(val *SystemInsightsManagedPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemInsightsManagedPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemInsightsManagedPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemInsightsManagedPolicies(val *SystemInsightsManagedPolicies) *NullableSystemInsightsManagedPolicies {
	return &NullableSystemInsightsManagedPolicies{value: val, isSet: true}
}

func (v NullableSystemInsightsManagedPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemInsightsManagedPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
