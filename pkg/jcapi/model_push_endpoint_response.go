...
// checks if the PushEndpointResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PushEndpointResponse{}

// PushEndpointResponse A push endpoint response from the auth service.
type PushEndpointResponse struct {
	Device *PushEndpointResponseDevice `json:"device,omitempty"`
...
type _PushEndpointResponse PushEndpointResponse
...
func (o *PushEndpointResponse) GetDevice() PushEndpointResponseDevice {
	if o == nil || IsNil(o.Device) {
		var ret PushEndpointResponseDevice
		return ret
	}
	return *o.Device
}
...
// SetDevice gets a reference to the given PushEndpointResponseDevice and assigns it to the Device field.
...
func (o PushEndpointResponse) MarshalJSON() ([]byte, error) {
...
func (o PushEndpointResponse) ToMap() (map[string]interface{}, error) {
...
func (o *PushEndpointResponse) UnmarshalJSON(bytes []byte) (err error) {
	varPushEndpointResponse := _PushEndpointResponse{}

	if err = json.Unmarshal(bytes, &varPushEndpointResponse); err == nil {
		*o = PushEndpointResponse(varPushEndpointResponse)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "lastUsedDate")
...
type NullablePushEndpointResponse struct {
	value *PushEndpointResponse
	isSet bool
}

func (v NullablePushEndpointResponse) Get() *PushEndpointResponse {
	return v.value
}

func (v *NullablePushEndpointResponse) Set(val *PushEndpointResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePushEndpointResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePushEndpointResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePushEndpointResponse(val *PushEndpointResponse) *NullablePushEndpointResponse {
	return &NullablePushEndpointResponse{value: val, isSet: true}
}

func (v NullablePushEndpointResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePushEndpointResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
