...
type Provider struct {
	DisallowOrgCreation *bool `json:"disallowOrgCreation,omitempty"`
...
// GetDisallowOrgCreation returns the DisallowOrgCreation field value if set, zero value otherwise.
func (o *Provider) GetDisallowOrgCreation() bool {
	if o == nil || IsNil(o.DisallowOrgCreation) {
		var ret bool
		return ret
	}
	return *o.DisallowOrgCreation
}

// GetDisallowOrgCreationOk returns a tuple with the DisallowOrgCreation field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Provider) GetDisallowOrgCreationOk() (*bool, bool) {
	if o == nil || IsNil(o.DisallowOrgCreation) {
		return nil, false
	}
	return o.DisallowOrgCreation, true
}
...
// SetDisallowOrgCreation gets a reference to the given bool and assigns it to the DisallowOrgCreation field.
func (o *Provider) SetDisallowOrgCreation(v bool) {
	o.DisallowOrgCreation = &v
}
...
func (o Provider) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DisallowOrgCreation) {
		toSerialize["disallowOrgCreation"] = o.DisallowOrgCreation
	}
	if !IsNil(o.Id) {
		toSerialize["id"] = o.Id
	}
...
func (o *Provider) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "disallowOrgCreation")
