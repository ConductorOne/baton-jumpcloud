...
// checks if the SystemInsightsDiskInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemInsightsDiskInfo{}

// SystemInsightsDiskInfo struct for SystemInsightsDiskInfo
...
type _SystemInsightsDiskInfo SystemInsightsDiskInfo
...
func (o *SystemInsightsDiskInfo) HasDiskIndex() bool {
	if o != nil && !IsNil(o.DiskIndex) {
		return true
	}
...
func (o *SystemInsightsDiskInfo) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
// GetPnpDeviceId returns the PnpDeviceId field value if set, zero value otherwise.
func (o *SystemInsightsDiskInfo) GetPnpDeviceId() string {
	if o == nil || IsNil(o.PnpDeviceId) {
		var ret string
		return ret
	}
	return *o.PnpDeviceId
}

// GetPnpDeviceIdOk returns a tuple with the PnpDeviceId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SystemInsightsDiskInfo) GetPnpDeviceIdOk() (*string, bool) {
	if o == nil || IsNil(o.PnpDeviceId) {
		return nil, false
	}
	return o.PnpDeviceId, true
}
...
// SetPnpDeviceId gets a reference to the given string and assigns it to the PnpDeviceId field.
...
func (o SystemInsightsDiskInfo) MarshalJSON() ([]byte, error) {
...
func (o SystemInsightsDiskInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DiskIndex) {
		toSerialize["disk_index"] = o.DiskIndex
	}
	if !IsNil(o.DiskSize) {
	...
	if !IsNil(o.PnpDeviceId) {
		toSerialize["pnp_device_id"] = o.PnpDeviceId
	}
	if !IsNil(o.Serial) {
...
func (o *SystemInsightsDiskInfo) UnmarshalJSON(bytes []byte) (err error) {
	varSystemInsightsDiskInfo := _SystemInsightsDiskInfo{}

	if err = json.Unmarshal(bytes, &varSystemInsightsDiskInfo); err == nil {
		*o = SystemInsightsDiskInfo(varSystemInsightsDiskInfo)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "disk_index")
		...
		delete(additionalProperties, "pnp_device_id")
...
type NullableSystemInsightsDiskInfo struct {
	value *SystemInsightsDiskInfo
	isSet bool
}

func (v NullableSystemInsightsDiskInfo) Get() *SystemInsightsDiskInfo {
	return v.value
}

func (v *NullableSystemInsightsDiskInfo) Set(val *SystemInsightsDiskInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemInsightsDiskInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemInsightsDiskInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemInsightsDiskInfo(val *SystemInsightsDiskInfo) *NullableSystemInsightsDiskInfo {
	return &NullableSystemInsightsDiskInfo{value: val, isSet: true}
}

func (v NullableSystemInsightsDiskInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemInsightsDiskInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
