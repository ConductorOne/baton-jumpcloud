...
// PolicyTemplate The shallow information about a Policy Template.
...
func (o *PolicyTemplate) GetDeliveryTypes() []string {
	if o == nil || IsNil(o.DeliveryTypes) {
		var ret []string
		return ret
	}
...
// SetDeliveryTypes gets a reference to the given []string and assigns it to the DeliveryTypes field.
...
func (o *PolicyTemplate) UnmarshalJSON(bytes []byte) (err error) {
	varPolicyTemplate := _PolicyTemplate{}

	if err = json.Unmarshal(bytes, &varPolicyTemplate); err == nil {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "deliveryTypes")
