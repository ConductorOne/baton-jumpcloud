...
// checks if the SystemInsightsGroups type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemInsightsGroups{}

// SystemInsightsGroups struct for SystemInsightsGroups
...
type _SystemInsightsGroups SystemInsightsGroups
...
// GetGroupSid returns the GroupSid field value if set, zero value otherwise.
func (o *SystemInsightsGroups) GetGroupSid() string {
	if o == nil || IsNil(o.GroupSid) {
		var ret string
		return ret
	}
	return *o.GroupSid
...
// SetGroupSid gets a reference to the given string and assigns it to the GroupSid field.
...
func (o SystemInsightsGroups) MarshalJSON() ([]byte, error) {
...
func (o SystemInsightsGroups) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.GroupSid) {
		toSerialize["group_sid"] = o.GroupSid
	}
...
func (o *SystemInsightsGroups) UnmarshalJSON(bytes []byte) (err error) {
	varSystemInsightsGroups := _SystemInsightsGroups{}

	if err = json.Unmarshal(bytes, &varSystemInsightsGroups); err == nil {
		*o = SystemInsightsGroups(varSystemInsightsGroups)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "group_sid")
...
type NullableSystemInsightsGroups struct {
	value *SystemInsightsGroups
	isSet bool
}

func (v NullableSystemInsightsGroups) Get() *SystemInsightsGroups {
	return v.value
}

func (v *NullableSystemInsightsGroups) Set(val *SystemInsightsGroups) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemInsightsGroups) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemInsightsGroups) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemInsightsGroups(val *SystemInsightsGroups) *NullableSystemInsightsGroups {
	return &NullableSystemInsightsGroups{value: val, isSet: true}
}

func (v NullableSystemInsightsGroups) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemInsightsGroups) UnmarshalJSON(src []byte) error {
	v.isSet = true
