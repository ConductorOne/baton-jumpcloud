...
type _SoftwareAppSettings SoftwareAppSettings
...
func (o *SoftwareAppSettings) UnmarshalJSON(bytes []byte) (err error) {
	varSoftwareAppSettings := _SoftwareAppSettings{}

	if err = json.Unmarshal(bytes, &varSoftwareAppSettings); err == nil {
		*o = SoftwareAppSettings(varSoftwareAppSettings)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "allowUpdateDelay")
		delete(additionalProperties, "appleVpp")
		delete(additionalProperties, "assetKind")
		delete(additionalProperties, "assetSha256Size")
		delete(additionalProperties, "assetSha256Strings")
		...
		delete(additionalProperties, "googleAndroid")
		delete(additionalProperties, "location")
		delete(additionalProperties, "locationObjectId")
		delete(additionalProperties, "packageId")
		delete(additionalProperties, "packageKind")
		delete(additionalProperties, "packageManager")
		delete(additionalProperties, "packageSubtitle")
