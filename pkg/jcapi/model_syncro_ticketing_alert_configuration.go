...
// checks if the SyncroTicketingAlertConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SyncroTicketingAlertConfiguration{}

// SyncroTicketingAlertConfiguration A SyncroTicketingAlertConfiguration object
type SyncroTicketingAlertConfiguration struct {
...
type _SyncroTicketingAlertConfiguration SyncroTicketingAlertConfiguration
...
func NewSyncroTicketingAlertConfiguration() *SyncroTicketingAlertConfiguration {
	this := SyncroTicketingAlertConfiguration{}
	return &this
}
...
func (o *SyncroTicketingAlertConfiguration) SetCategory(v string) {
	o.Category = &v
}
...
func (o *SyncroTicketingAlertConfiguration) HasUserId() bool {
	if o != nil && !IsNil(o.UserId) {
		return true
	}
...
func (o SyncroTicketingAlertConfiguration) MarshalJSON() ([]byte, error) {
...
func (o SyncroTicketingAlertConfiguration) ToMap() (map[string]interface{}, error) {
...
func (o *SyncroTicketingAlertConfiguration) UnmarshalJSON(bytes []byte) (err error) {
	varSyncroTicketingAlertConfiguration := _SyncroTicketingAlertConfiguration{}

	if err = json.Unmarshal(bytes, &varSyncroTicketingAlertConfiguration); err == nil {
		*o = SyncroTicketingAlertConfiguration(varSyncroTicketingAlertConfiguration)
	}
...
type NullableSyncroTicketingAlertConfiguration struct {
	value *SyncroTicketingAlertConfiguration
	isSet bool
}

func (v NullableSyncroTicketingAlertConfiguration) Get() *SyncroTicketingAlertConfiguration {
	return v.value
}

func (v *NullableSyncroTicketingAlertConfiguration) Set(val *SyncroTicketingAlertConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableSyncroTicketingAlertConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableSyncroTicketingAlertConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyncroTicketingAlertConfiguration(val *SyncroTicketingAlertConfiguration) *NullableSyncroTicketingAlertConfiguration {
	return &NullableSyncroTicketingAlertConfiguration{value: val, isSet: true}
}

func (v NullableSyncroTicketingAlertConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyncroTicketingAlertConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
