...
type _ConnectWiseMappingResponse ConnectWiseMappingResponse
...
func (o *ConnectWiseMappingResponse) UnmarshalJSON(bytes []byte) (err error) {
	varConnectWiseMappingResponse := _ConnectWiseMappingResponse{}

	if err = json.Unmarshal(bytes, &varConnectWiseMappingResponse); err == nil {
		*o = ConnectWiseMappingResponse(varConnectWiseMappingResponse)
	}
