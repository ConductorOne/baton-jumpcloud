...
// checks if the SystemInsightsUserassist type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemInsightsUserassist{}

// SystemInsightsUserassist struct for SystemInsightsUserassist
type SystemInsightsUserassist struct {
	CollectionTime *string `json:"collection_time,omitempty"`
	Count *float32 `json:"count,omitempty"`
	LastExecutionTime *float32 `json:"last_execution_time,omitempty"`
...
type _SystemInsightsUserassist SystemInsightsUserassist
...
func (o SystemInsightsUserassist) MarshalJSON() ([]byte, error) {
...
func (o SystemInsightsUserassist) ToMap() (map[string]interface{}, error) {
...
func (o *SystemInsightsUserassist) UnmarshalJSON(bytes []byte) (err error) {
	varSystemInsightsUserassist := _SystemInsightsUserassist{}

	if err = json.Unmarshal(bytes, &varSystemInsightsUserassist); err == nil {
		*o = SystemInsightsUserassist(varSystemInsightsUserassist)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "last_execution_time")
...
type NullableSystemInsightsUserassist struct {
	value *SystemInsightsUserassist
	isSet bool
}

func (v NullableSystemInsightsUserassist) Get() *SystemInsightsUserassist {
	return v.value
}

func (v *NullableSystemInsightsUserassist) Set(val *SystemInsightsUserassist) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemInsightsUserassist) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemInsightsUserassist) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemInsightsUserassist(val *SystemInsightsUserassist) *NullableSystemInsightsUserassist {
	return &NullableSystemInsightsUserassist{value: val, isSet: true}
}

func (v NullableSystemInsightsUserassist) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemInsightsUserassist) UnmarshalJSON(src []byte) error {
	v.isSet = true
