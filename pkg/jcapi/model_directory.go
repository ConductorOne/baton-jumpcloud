...
type Directory struct {
	...
	OAuthStatus map[string]interface{} `json:"oAuthStatus,omitempty"`
...
// SetOAuthStatus gets a reference to the given map[string]interface{} and assigns it to the OAuthStatus field.
...
func (o *Directory) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &varDirectory); err == nil {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "oAuthStatus")
