...
// checks if the SystemInsightsSharedResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemInsightsSharedResources{}

// SystemInsightsSharedResources struct for SystemInsightsSharedResources
...
type _SystemInsightsSharedResources SystemInsightsSharedResources
...
func NewSystemInsightsSharedResources() *SystemInsightsSharedResources {
	this := SystemInsightsSharedResources{}
	return &this
}
...
// GetAllowMaximum returns the AllowMaximum field value if set, zero value otherwise.
func (o *SystemInsightsSharedResources) GetAllowMaximum() int32 {
	if o == nil || IsNil(o.AllowMaximum) {
		var ret int32
		return ret
	}
	return *o.AllowMaximum
}

// GetAllowMaximumOk returns a tuple with the AllowMaximum field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SystemInsightsSharedResources) GetAllowMaximumOk() (*int32, bool) {
	if o == nil || IsNil(o.AllowMaximum) {
		return nil, false
	}
	return o.AllowMaximum, true
}
...
// SetAllowMaximum gets a reference to the given int32 and assigns it to the AllowMaximum field.
...
// SetMaximumAllowed gets a reference to the given int32 and assigns it to the MaximumAllowed field.
...
func (o SystemInsightsSharedResources) MarshalJSON() ([]byte, error) {
...
func (o SystemInsightsSharedResources) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AllowMaximum) {
		toSerialize["allow_maximum"] = o.AllowMaximum
	}
	...
	if !IsNil(o.MaximumAllowed) {
		toSerialize["maximum_allowed"] = o.MaximumAllowed
	}
	if !IsNil(o.Name) {
...
func (o *SystemInsightsSharedResources) UnmarshalJSON(bytes []byte) (err error) {
	varSystemInsightsSharedResources := _SystemInsightsSharedResources{}

	if err = json.Unmarshal(bytes, &varSystemInsightsSharedResources); err == nil {
		*o = SystemInsightsSharedResources(varSystemInsightsSharedResources)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "allow_maximum")
		delete(additionalProperties, "collection_time")
		delete(additionalProperties, "description")
		delete(additionalProperties, "install_date")
		delete(additionalProperties, "maximum_allowed")
...
type NullableSystemInsightsSharedResources struct {
	value *SystemInsightsSharedResources
	isSet bool
}

func (v NullableSystemInsightsSharedResources) Get() *SystemInsightsSharedResources {
	return v.value
}

func (v *NullableSystemInsightsSharedResources) Set(val *SystemInsightsSharedResources) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemInsightsSharedResources) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemInsightsSharedResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemInsightsSharedResources(val *SystemInsightsSharedResources) *NullableSystemInsightsSharedResources {
	return &NullableSystemInsightsSharedResources{value: val, isSet: true}
}

func (v NullableSystemInsightsSharedResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemInsightsSharedResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
