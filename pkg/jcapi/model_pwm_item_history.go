...
// checks if the PwmItemHistory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PwmItemHistory{}

// PwmItemHistory struct for PwmItemHistory
type PwmItemHistory struct {
...
type _PwmItemHistory PwmItemHistory
...
func (o PwmItemHistory) MarshalJSON() ([]byte, error) {
...
func (o PwmItemHistory) ToMap() (map[string]interface{}, error) {
...
func (o *PwmItemHistory) UnmarshalJSON(bytes []byte) (err error) {
	varPwmItemHistory := _PwmItemHistory{}

	if err = json.Unmarshal(bytes, &varPwmItemHistory); err == nil {
		*o = PwmItemHistory(varPwmItemHistory)
	}
...
type NullablePwmItemHistory struct {
	value *PwmItemHistory
	isSet bool
}

func (v NullablePwmItemHistory) Get() *PwmItemHistory {
	return v.value
}

func (v *NullablePwmItemHistory) Set(val *PwmItemHistory) {
	v.value = val
	v.isSet = true
}

func (v NullablePwmItemHistory) IsSet() bool {
	return v.isSet
}

func (v *NullablePwmItemHistory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePwmItemHistory(val *PwmItemHistory) *NullablePwmItemHistory {
	return &NullablePwmItemHistory{value: val, isSet: true}
}

func (v NullablePwmItemHistory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePwmItemHistory) UnmarshalJSON(src []byte) error {
	v.isSet = true
