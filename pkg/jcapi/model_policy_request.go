...
// PolicyRequest An instance of a policy template.
...
// SetTemplate gets a reference to the given PolicyRequestTemplate and assigns it to the Template field.
...
func (o *PolicyRequest) UnmarshalJSON(bytes []byte) (err error) {
	varPolicyRequest := _PolicyRequest{}

	if err = json.Unmarshal(bytes, &varPolicyRequest); err == nil {
