...
// checks if the AutotaskMappingRequestDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AutotaskMappingRequestDataInner{}

// AutotaskMappingRequestDataInner struct for AutotaskMappingRequestDataInner
type AutotaskMappingRequestDataInner struct {
	Company AutotaskMappingRequestCompany `json:"company"`
	Contract map[string]interface{} `json:"contract,omitempty"`
	Delete *bool `json:"delete,omitempty"`
	Organization AutotaskMappingRequestOrganization `json:"organization"`
	Service map[string]interface{} `json:"service,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AutotaskMappingRequestDataInner AutotaskMappingRequestDataInner
...
func NewAutotaskMappingRequestDataInner(company AutotaskMappingRequestCompany, organization AutotaskMappingRequestOrganization) *AutotaskMappingRequestDataInner {
	this := AutotaskMappingRequestDataInner{}
...
func (o *AutotaskMappingRequestDataInner) GetCompany() AutotaskMappingRequestCompany {
	if o == nil {
		var ret AutotaskMappingRequestCompany
		return ret
	}
...
func (o *AutotaskMappingRequestDataInner) GetOrganization() AutotaskMappingRequestOrganization {
	if o == nil {
		var ret AutotaskMappingRequestOrganization
		return ret
	}
...
func (o AutotaskMappingRequestDataInner) MarshalJSON() ([]byte, error) {
...
func (o AutotaskMappingRequestDataInner) ToMap() (map[string]interface{}, error) {
...
func (o *AutotaskMappingRequestDataInner) UnmarshalJSON(bytes []byte) (err error) {
	varAutotaskMappingRequestDataInner := _AutotaskMappingRequestDataInner{}

	if err = json.Unmarshal(bytes, &varAutotaskMappingRequestDataInner); err == nil {
		*o = AutotaskMappingRequestDataInner(varAutotaskMappingRequestDataInner)
	}
...
type NullableAutotaskMappingRequestDataInner struct {
	value *AutotaskMappingRequestDataInner
	isSet bool
}

func (v NullableAutotaskMappingRequestDataInner) Get() *AutotaskMappingRequestDataInner {
	return v.value
}

func (v *NullableAutotaskMappingRequestDataInner) Set(val *AutotaskMappingRequestDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableAutotaskMappingRequestDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableAutotaskMappingRequestDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAutotaskMappingRequestDataInner(val *AutotaskMappingRequestDataInner) *NullableAutotaskMappingRequestDataInner {
	return &NullableAutotaskMappingRequestDataInner{value: val, isSet: true}
}

func (v NullableAutotaskMappingRequestDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAutotaskMappingRequestDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
