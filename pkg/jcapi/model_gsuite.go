...
// checks if the Gsuite type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Gsuite{}

// Gsuite struct for Gsuite
type Gsuite struct {
...
func (o Gsuite) ToMap() (map[string]interface{}, error) {
...
func (o *Gsuite) UnmarshalJSON(bytes []byte) (err error) {
	varGsuite := _Gsuite{}

	if err = json.Unmarshal(bytes, &varGsuite); err == nil {
		*o = Gsuite(varGsuite)
	}
...
type NullableGsuite struct {
	value *Gsuite
	isSet bool
}

func (v NullableGsuite) Get() *Gsuite {
	return v.value
}

func (v *NullableGsuite) Set(val *Gsuite) {
	v.value = val
	v.isSet = true
}

func (v NullableGsuite) IsSet() bool {
	return v.isSet
}

func (v *NullableGsuite) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGsuite(val *Gsuite) *NullableGsuite {
	return &NullableGsuite{value: val, isSet: true}
}

func (v NullableGsuite) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGsuite) UnmarshalJSON(src []byte) error {
	v.isSet = true
