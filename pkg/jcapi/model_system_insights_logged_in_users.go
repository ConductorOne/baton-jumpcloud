...
// checks if the SystemInsightsLoggedInUsers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemInsightsLoggedInUsers{}

// SystemInsightsLoggedInUsers struct for SystemInsightsLoggedInUsers
...
type _SystemInsightsLoggedInUsers SystemInsightsLoggedInUsers
...
func NewSystemInsightsLoggedInUsers() *SystemInsightsLoggedInUsers {
	this := SystemInsightsLoggedInUsers{}
	return &this
}
...
func (o SystemInsightsLoggedInUsers) MarshalJSON() ([]byte, error) {
...
func (o SystemInsightsLoggedInUsers) ToMap() (map[string]interface{}, error) {
...
func (o *SystemInsightsLoggedInUsers) UnmarshalJSON(bytes []byte) (err error) {
	varSystemInsightsLoggedInUsers := _SystemInsightsLoggedInUsers{}

	if err = json.Unmarshal(bytes, &varSystemInsightsLoggedInUsers); err == nil {
		*o = SystemInsightsLoggedInUsers(varSystemInsightsLoggedInUsers)
	}
...
type NullableSystemInsightsLoggedInUsers struct {
	value *SystemInsightsLoggedInUsers
	isSet bool
}

func (v NullableSystemInsightsLoggedInUsers) Get() *SystemInsightsLoggedInUsers {
	return v.value
}

func (v *NullableSystemInsightsLoggedInUsers) Set(val *SystemInsightsLoggedInUsers) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemInsightsLoggedInUsers) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemInsightsLoggedInUsers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemInsightsLoggedInUsers(val *SystemInsightsLoggedInUsers) *NullableSystemInsightsLoggedInUsers {
	return &NullableSystemInsightsLoggedInUsers{value: val, isSet: true}
}

func (v NullableSystemInsightsLoggedInUsers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemInsightsLoggedInUsers) UnmarshalJSON(src []byte) error {
	v.isSet = true
