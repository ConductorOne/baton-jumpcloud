...
// checks if the AuthnPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthnPolicy{}

// AuthnPolicy This represents an authentication policy.  See the details of each field for valid values and restrictions.
type AuthnPolicy struct {
	...
	Effect *AuthnPolicyEffect `json:"effect,omitempty"`
	Id *string `json:"id,omitempty"`
	Name *string `json:"name,omitempty"`
	Targets *AuthnPolicyTargets `json:"targets,omitempty"`
	Type *AuthnPolicyType `json:"type,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AuthnPolicy AuthnPolicy
...
func NewAuthnPolicy() *AuthnPolicy {
	this := AuthnPolicy{}
	var type_ AuthnPolicyType = AUTHNPOLICYTYPE_USER_PORTAL
	this.Type = &type_
	return &this
}
...
// SetEffect gets a reference to the given AuthnPolicyEffect and assigns it to the Effect field.
...
// SetTargets gets a reference to the given AuthnPolicyTargets and assigns it to the Targets field.
...
// SetType gets a reference to the given AuthnPolicyType and assigns it to the Type field.
func (o *AuthnPolicy) SetType(v AuthnPolicyType) {
	o.Type = &v
}

func (o AuthnPolicy) MarshalJSON() ([]byte, error) {
...
func (o AuthnPolicy) ToMap() (map[string]interface{}, error) {
...
func (o *AuthnPolicy) UnmarshalJSON(bytes []byte) (err error) {
	varAuthnPolicy := _AuthnPolicy{}

	if err = json.Unmarshal(bytes, &varAuthnPolicy); err == nil {
		*o = AuthnPolicy(varAuthnPolicy)
	}
...
type NullableAuthnPolicy struct {
	value *AuthnPolicy
	isSet bool
}

func (v NullableAuthnPolicy) Get() *AuthnPolicy {
	return v.value
}

func (v *NullableAuthnPolicy) Set(val *AuthnPolicy) {
	v.value = val
	v.isSet = true
}

func (v NullableAuthnPolicy) IsSet() bool {
	return v.isSet
}

func (v *NullableAuthnPolicy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuthnPolicy(val *AuthnPolicy) *NullableAuthnPolicy {
	return &NullableAuthnPolicy{value: val, isSet: true}
}

func (v NullableAuthnPolicy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuthnPolicy) UnmarshalJSON(src []byte) error {
	v.isSet = true
