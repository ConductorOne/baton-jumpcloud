...
// Administrator struct for Administrator
type Administrator struct {
	...
	OrganizationAccessTotal *float32 `json:"organizationAccessTotal,omitempty"`
...
// GetOrganizationAccessTotal returns the OrganizationAccessTotal field value if set, zero value otherwise.
func (o *Administrator) GetOrganizationAccessTotal() float32 {
	if o == nil || IsNil(o.OrganizationAccessTotal) {
		var ret float32
		return ret
	}
	return *o.OrganizationAccessTotal
}

// GetOrganizationAccessTotalOk returns a tuple with the OrganizationAccessTotal field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Administrator) GetOrganizationAccessTotalOk() (*float32, bool) {
	if o == nil || IsNil(o.OrganizationAccessTotal) {
		return nil, false
	}
	return o.OrganizationAccessTotal, true
}
...
// SetOrganizationAccessTotal gets a reference to the given float32 and assigns it to the OrganizationAccessTotal field.
func (o *Administrator) SetOrganizationAccessTotal(v float32) {
	o.OrganizationAccessTotal = &v
}
...
func (o Administrator) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.OrganizationAccessTotal) {
		toSerialize["organizationAccessTotal"] = o.OrganizationAccessTotal
	}
...
func (o *Administrator) UnmarshalJSON(bytes []byte) (err error) {
	varAdministrator := _Administrator{}

	if err = json.Unmarshal(bytes, &varAdministrator); err == nil {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "organizationAccessTotal")
