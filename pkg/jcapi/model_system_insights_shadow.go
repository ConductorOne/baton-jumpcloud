...
type _SystemInsightsShadow SystemInsightsShadow
...
func (o *SystemInsightsShadow) UnmarshalJSON(bytes []byte) (err error) {
	varSystemInsightsShadow := _SystemInsightsShadow{}

	if err = json.Unmarshal(bytes, &varSystemInsightsShadow); err == nil {
		*o = SystemInsightsShadow(varSystemInsightsShadow)
	}
