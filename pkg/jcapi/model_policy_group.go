...
// checks if the PolicyGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PolicyGroup{}
...
func (o PolicyGroup) ToMap() (map[string]interface{}, error) {
...
func (o *PolicyGroup) UnmarshalJSON(bytes []byte) (err error) {
	varPolicyGroup := _PolicyGroup{}

	if err = json.Unmarshal(bytes, &varPolicyGroup); err == nil {
		*o = PolicyGroup(varPolicyGroup)
	}
