...
// checks if the WorkdayWorker type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkdayWorker{}

// WorkdayWorker struct for WorkdayWorker
...
type _WorkdayWorker WorkdayWorker
...
func (o WorkdayWorker) MarshalJSON() ([]byte, error) {
...
func (o WorkdayWorker) ToMap() (map[string]interface{}, error) {
...
func (o *WorkdayWorker) UnmarshalJSON(bytes []byte) (err error) {
	varWorkdayWorker := _WorkdayWorker{}

	if err = json.Unmarshal(bytes, &varWorkdayWorker); err == nil {
		*o = WorkdayWorker(varWorkdayWorker)
	}
...
type NullableWorkdayWorker struct {
	value *WorkdayWorker
	isSet bool
}

func (v NullableWorkdayWorker) Get() *WorkdayWorker {
	return v.value
}

func (v *NullableWorkdayWorker) Set(val *WorkdayWorker) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkdayWorker) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkdayWorker) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkdayWorker(val *WorkdayWorker) *NullableWorkdayWorker {
	return &NullableWorkdayWorker{value: val, isSet: true}
}

func (v NullableWorkdayWorker) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkdayWorker) UnmarshalJSON(src []byte) error {
	v.isSet = true
