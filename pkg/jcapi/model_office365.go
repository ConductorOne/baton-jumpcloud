...
// checks if the Office365 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Office365{}

// Office365 struct for Office365
...
// GetGroupsEnabled returns the GroupsEnabled field value if set, zero value otherwise.
func (o *Office365) GetGroupsEnabled() bool {
	if o == nil || IsNil(o.GroupsEnabled) {
		var ret bool
		return ret
	}
	return *o.GroupsEnabled
}

// GetGroupsEnabledOk returns a tuple with the GroupsEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Office365) GetGroupsEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.GroupsEnabled) {
		return nil, false
	}
	return o.GroupsEnabled, true
}
...
// SetGroupsEnabled gets a reference to the given bool and assigns it to the GroupsEnabled field.
...
func (o Office365) MarshalJSON() ([]byte, error) {
...
func (o Office365) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.GroupsEnabled) {
		toSerialize["groupsEnabled"] = o.GroupsEnabled
	}
	// skip: id is readOnly
	if !IsNil(o.Name) {
		toSerialize["name"] = o.Name
	}
	// skip: userLockoutAction is readOnly
	// skip: userPasswordExpirationAction is readOnly
...
func (o *Office365) UnmarshalJSON(bytes []byte) (err error) {
	varOffice365 := _Office365{}

	if err = json.Unmarshal(bytes, &varOffice365); err == nil {
		*o = Office365(varOffice365)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "groupsEnabled")
...
type NullableOffice365 struct {
	value *Office365
	isSet bool
}

func (v NullableOffice365) Get() *Office365 {
	return v.value
}

func (v *NullableOffice365) Set(val *Office365) {
	v.value = val
	v.isSet = true
}

func (v NullableOffice365) IsSet() bool {
	return v.isSet
}

func (v *NullableOffice365) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOffice365(val *Office365) *NullableOffice365 {
	return &NullableOffice365{value: val, isSet: true}
}

func (v NullableOffice365) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOffice365) UnmarshalJSON(src []byte) error {
	v.isSet = true
