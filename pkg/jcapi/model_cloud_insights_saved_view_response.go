...
// checks if the CloudInsightsSavedViewResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudInsightsSavedViewResponse{}

// CloudInsightsSavedViewResponse Properties of a Cloud Insights saved view object
type CloudInsightsSavedViewResponse struct {
	Columns []string `json:"columns,omitempty"`
	ExcludeNonPersonEntities *bool `json:"excludeNonPersonEntities,omitempty"`
	Filters []CloudInsightsSavedViewBaseFiltersInner `json:"filters,omitempty"`
...
type _CloudInsightsSavedViewResponse CloudInsightsSavedViewResponse
...
func NewCloudInsightsSavedViewResponse() *CloudInsightsSavedViewResponse {
	this := CloudInsightsSavedViewResponse{}
	return &this
}
...
// GetExcludeNonPersonEntities returns the ExcludeNonPersonEntities field value if set, zero value otherwise.
func (o *CloudInsightsSavedViewResponse) GetExcludeNonPersonEntities() bool {
	if o == nil || IsNil(o.ExcludeNonPersonEntities) {
		var ret bool
		return ret
	}
	return *o.ExcludeNonPersonEntities
}

// GetExcludeNonPersonEntitiesOk returns a tuple with the ExcludeNonPersonEntities field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CloudInsightsSavedViewResponse) GetExcludeNonPersonEntitiesOk() (*bool, bool) {
	if o == nil || IsNil(o.ExcludeNonPersonEntities) {
		return nil, false
	}
	return o.ExcludeNonPersonEntities, true
}
...
// SetExcludeNonPersonEntities gets a reference to the given bool and assigns it to the ExcludeNonPersonEntities field.
func (o *CloudInsightsSavedViewResponse) SetExcludeNonPersonEntities(v bool) {
	o.ExcludeNonPersonEntities = &v
}

// GetFilters returns the Filters field value if set, zero value otherwise.
func (o *CloudInsightsSavedViewResponse) GetFilters() []CloudInsightsSavedViewBaseFiltersInner {
	if o == nil || IsNil(o.Filters) {
		var ret []CloudInsightsSavedViewBaseFiltersInner
		return ret
	}
	return o.Filters
}
...
// SetFilters gets a reference to the given []CloudInsightsSavedViewBaseFiltersInner and assigns it to the Filters field.
...
func (o CloudInsightsSavedViewResponse) MarshalJSON() ([]byte, error) {
...
func (o CloudInsightsSavedViewResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Columns) {
		toSerialize["columns"] = o.Columns
	}
	if !IsNil(o.ExcludeNonPersonEntities) {
		toSerialize["excludeNonPersonEntities"] = o.ExcludeNonPersonEntities
	}
	if !IsNil(o.Filters) {
...
func (o *CloudInsightsSavedViewResponse) UnmarshalJSON(bytes []byte) (err error) {
	varCloudInsightsSavedViewResponse := _CloudInsightsSavedViewResponse{}

	if err = json.Unmarshal(bytes, &varCloudInsightsSavedViewResponse); err == nil {
		*o = CloudInsightsSavedViewResponse(varCloudInsightsSavedViewResponse)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "excludeNonPersonEntities")
		delete(additionalProperties, "filters")
		delete(additionalProperties, "timeRange")
		delete(additionalProperties, "name")
		delete(additionalProperties, "organizationObjectId")
...
type NullableCloudInsightsSavedViewResponse struct {
	value *CloudInsightsSavedViewResponse
	isSet bool
}

func (v NullableCloudInsightsSavedViewResponse) Get() *CloudInsightsSavedViewResponse {
	return v.value
}

func (v *NullableCloudInsightsSavedViewResponse) Set(val *CloudInsightsSavedViewResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudInsightsSavedViewResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudInsightsSavedViewResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudInsightsSavedViewResponse(val *CloudInsightsSavedViewResponse) *NullableCloudInsightsSavedViewResponse {
	return &NullableCloudInsightsSavedViewResponse{value: val, isSet: true}
}

func (v NullableCloudInsightsSavedViewResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudInsightsSavedViewResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
