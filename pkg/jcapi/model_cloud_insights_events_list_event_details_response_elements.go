...
// checks if the CloudInsightsEventsListEventDetailsResponseElements type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudInsightsEventsListEventDetailsResponseElements{}

// CloudInsightsEventsListEventDetailsResponseElements struct for CloudInsightsEventsListEventDetailsResponseElements
type CloudInsightsEventsListEventDetailsResponseElements struct {
	ConsoleLogin *string `json:"ConsoleLogin,omitempty"`
	AssumedRoleUser *CloudInsightsEventsListEventDetailsResponseElementsAssumedRoleUser `json:"assumedRoleUser,omitempty"`
	Audience *string `json:"audience,omitempty"`
	Credentials *CloudInsightsEventsListEventDetailsResponseElementsCredentials `json:"credentials,omitempty"`
...
type _CloudInsightsEventsListEventDetailsResponseElements CloudInsightsEventsListEventDetailsResponseElements
...
func NewCloudInsightsEventsListEventDetailsResponseElements() *CloudInsightsEventsListEventDetailsResponseElements {
	this := CloudInsightsEventsListEventDetailsResponseElements{}
	return &this
}
...
// GetConsoleLogin returns the ConsoleLogin field value if set, zero value otherwise.
func (o *CloudInsightsEventsListEventDetailsResponseElements) GetConsoleLogin() string {
	if o == nil || IsNil(o.ConsoleLogin) {
		var ret string
		return ret
	}
	return *o.ConsoleLogin
}

// GetConsoleLoginOk returns a tuple with the ConsoleLogin field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CloudInsightsEventsListEventDetailsResponseElements) GetConsoleLoginOk() (*string, bool) {
	if o == nil || IsNil(o.ConsoleLogin) {
		return nil, false
	}
	return o.ConsoleLogin, true
}
...
// SetConsoleLogin gets a reference to the given string and assigns it to the ConsoleLogin field.
func (o *CloudInsightsEventsListEventDetailsResponseElements) SetConsoleLogin(v string) {
	o.ConsoleLogin = &v
}

// GetAssumedRoleUser returns the AssumedRoleUser field value if set, zero value otherwise.
func (o *CloudInsightsEventsListEventDetailsResponseElements) GetAssumedRoleUser() CloudInsightsEventsListEventDetailsResponseElementsAssumedRoleUser {
	if o == nil || IsNil(o.AssumedRoleUser) {
		var ret CloudInsightsEventsListEventDetailsResponseElementsAssumedRoleUser
		return ret
	}
	return *o.AssumedRoleUser
}

// GetAssumedRoleUserOk returns a tuple with the AssumedRoleUser field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetAssumedRoleUser gets a reference to the given CloudInsightsEventsListEventDetailsResponseElementsAssumedRoleUser and assigns it to the AssumedRoleUser field.
...
func (o *CloudInsightsEventsListEventDetailsResponseElements) GetCredentials() CloudInsightsEventsListEventDetailsResponseElementsCredentials {
	if o == nil || IsNil(o.Credentials) {
		var ret CloudInsightsEventsListEventDetailsResponseElementsCredentials
		return ret
	}
...
// SetCredentials gets a reference to the given CloudInsightsEventsListEventDetailsResponseElementsCredentials and assigns it to the Credentials field.
...
// GetNameQualifier returns the NameQualifier field value if set, zero value otherwise.
func (o *CloudInsightsEventsListEventDetailsResponseElements) GetNameQualifier() string {
	if o == nil || IsNil(o.NameQualifier) {
		var ret string
		return ret
	}
	return *o.NameQualifier
}

// GetNameQualifierOk returns a tuple with the NameQualifier field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CloudInsightsEventsListEventDetailsResponseElements) GetNameQualifierOk() (*string, bool) {
	if o == nil || IsNil(o.NameQualifier) {
		return nil, false
	}
	return o.NameQualifier, true
}
...
// SetNameQualifier gets a reference to the given string and assigns it to the NameQualifier field.
...
func (o CloudInsightsEventsListEventDetailsResponseElements) MarshalJSON() ([]byte, error) {
...
func (o CloudInsightsEventsListEventDetailsResponseElements) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ConsoleLogin) {
		toSerialize["ConsoleLogin"] = o.ConsoleLogin
	}
	if !IsNil(o.AssumedRoleUser) {
		toSerialize["assumedRoleUser"] = o.AssumedRoleUser
	}
	if !IsNil(o.Audience) {
	...
	if !IsNil(o.NameQualifier) {
		toSerialize["nameQualifier"] = o.NameQualifier
	}
	if !IsNil(o.Subject) {
...
func (o *CloudInsightsEventsListEventDetailsResponseElements) UnmarshalJSON(bytes []byte) (err error) {
	varCloudInsightsEventsListEventDetailsResponseElements := _CloudInsightsEventsListEventDetailsResponseElements{}

	if err = json.Unmarshal(bytes, &varCloudInsightsEventsListEventDetailsResponseElements); err == nil {
		*o = CloudInsightsEventsListEventDetailsResponseElements(varCloudInsightsEventsListEventDetailsResponseElements)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "ConsoleLogin")
		delete(additionalProperties, "assumedRoleUser")
		delete(additionalProperties, "audience")
		delete(additionalProperties, "credentials")
		delete(additionalProperties, "issuer")
		delete(additionalProperties, "nameQualifier")
...
type NullableCloudInsightsEventsListEventDetailsResponseElements struct {
	value *CloudInsightsEventsListEventDetailsResponseElements
	isSet bool
}

func (v NullableCloudInsightsEventsListEventDetailsResponseElements) Get() *CloudInsightsEventsListEventDetailsResponseElements {
	return v.value
}

func (v *NullableCloudInsightsEventsListEventDetailsResponseElements) Set(val *CloudInsightsEventsListEventDetailsResponseElements) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudInsightsEventsListEventDetailsResponseElements) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudInsightsEventsListEventDetailsResponseElements) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudInsightsEventsListEventDetailsResponseElements(val *CloudInsightsEventsListEventDetailsResponseElements) *NullableCloudInsightsEventsListEventDetailsResponseElements {
	return &NullableCloudInsightsEventsListEventDetailsResponseElements{value: val, isSet: true}
}

func (v NullableCloudInsightsEventsListEventDetailsResponseElements) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudInsightsEventsListEventDetailsResponseElements) UnmarshalJSON(src []byte) error {
	v.isSet = true
