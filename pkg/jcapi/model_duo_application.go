...
// checks if the DuoApplication type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DuoApplication{}

// DuoApplication struct for DuoApplication
...
type _DuoApplication DuoApplication
...
func (o DuoApplication) MarshalJSON() ([]byte, error) {
...
func (o DuoApplication) ToMap() (map[string]interface{}, error) {
...
func (o *DuoApplication) UnmarshalJSON(bytes []byte) (err error) {
	varDuoApplication := _DuoApplication{}

	if err = json.Unmarshal(bytes, &varDuoApplication); err == nil {
		*o = DuoApplication(varDuoApplication)
	}
...
type NullableDuoApplication struct {
	value *DuoApplication
	isSet bool
}

func (v NullableDuoApplication) Get() *DuoApplication {
	return v.value
}

func (v *NullableDuoApplication) Set(val *DuoApplication) {
	v.value = val
	v.isSet = true
}

func (v NullableDuoApplication) IsSet() bool {
	return v.isSet
}

func (v *NullableDuoApplication) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDuoApplication(val *DuoApplication) *NullableDuoApplication {
	return &NullableDuoApplication{value: val, isSet: true}
}

func (v NullableDuoApplication) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDuoApplication) UnmarshalJSON(src []byte) error {
	v.isSet = true
