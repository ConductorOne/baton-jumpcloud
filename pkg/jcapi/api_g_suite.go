...
// Google Directory API maximum number of results per page. See https://developers.google.com/admin-sdk/directory/reference/rest/v1/users/list.
func (r GSuiteApiGsuitesListImportUsersRequest) MaxResults(maxResults int32) GSuiteApiGsuitesListImportUsersRequest {
	r.maxResults = &maxResults
	return r
}

// Google Directory API sort field parameter. See https://developers.google.com/admin-sdk/directory/reference/rest/v1/users/list.
func (r GSuiteApiGsuitesListImportUsersRequest) OrderBy(orderBy string) GSuiteApiGsuitesListImportUsersRequest {
	r.orderBy = &orderBy
	return r
}

// Google Directory API token used to access the next page of results. See https://developers.google.com/admin-sdk/directory/reference/rest/v1/users/list.
func (r GSuiteApiGsuitesListImportUsersRequest) PageToken(pageToken string) GSuiteApiGsuitesListImportUsersRequest {
	r.pageToken = &pageToken
	return r
}

// Google Directory API search parameter. See https://developers.google.com/admin-sdk/directory/v1/guides/search-users.
func (r GSuiteApiGsuitesListImportUsersRequest) Query(query string) GSuiteApiGsuitesListImportUsersRequest {
	r.query = &query
	return r
}

// Google Directory API sort direction parameter. See https://developers.google.com/admin-sdk/directory/reference/rest/v1/users/list.
func (r GSuiteApiGsuitesListImportUsersRequest) SortOrder(sortOrder string) GSuiteApiGsuitesListImportUsersRequest {
	r.sortOrder = &sortOrder
	return r
}

func (r GSuiteApiGsuitesListImportUsersRequest) Execute() (*GsuitesListImportUsers200Response, *http.Response, error) {
...
Lists G Suite users available for import.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param gsuiteId
 @return GSuiteApiGsuitesListImportUsersRequest
*/
func (a *GSuiteApiService) GsuitesListImportUsers(ctx context.Context, gsuiteId string) GSuiteApiGsuitesListImportUsersRequest {
	return GSuiteApiGsuitesListImportUsersRequest{
		ApiService: a,
		ctx: ctx,
		gsuiteId: gsuiteId,
...
func (a *GSuiteApiService) GsuitesListImportUsersExecute(r GSuiteApiGsuitesListImportUsersRequest) (*GsuitesListImportUsers200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type GSuiteApiGsuitesPatchRequest struct {
	ctx context.Context
	ApiService *GSuiteApiService
	id string
	xOrgId *string
...
// Organization identifier that can be obtained from console settings.
func (r GSuiteApiGsuitesPatchRequest) XOrgId(xOrgId string) GSuiteApiGsuitesPatchRequest {
	r.xOrgId = &xOrgId
	return r
}

func (r GSuiteApiGsuitesPatchRequest) Body(body Gsuite) GSuiteApiGsuitesPatchRequest {
	r.body = &body
	return r
}

func (r GSuiteApiGsuitesPatchRequest) Execute() (*Gsuite, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id Unique identifier of the GSuite.
 @return GSuiteApiGsuitesPatchRequest
*/
func (a *GSuiteApiService) GsuitesPatch(ctx context.Context, id string) GSuiteApiGsuitesPatchRequest {
	return GSuiteApiGsuitesPatchRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return Gsuite
func (a *GSuiteApiService) GsuitesPatchExecute(r GSuiteApiGsuitesPatchRequest) (*Gsuite, *http.Response, error) {
	var (
...
type GSuiteApiTranslationRulesGSuiteDeleteRequest struct {
	ctx context.Context
	ApiService *GSuiteApiService
	gsuiteId string
	id string
...
func (r GSuiteApiTranslationRulesGSuiteDeleteRequest) Execute() (*http.Response, error) {
...
curl -X DELETE https://console.jumpcloud.com/api/v2/gsuites/{gsuite_id}/translationrules/{id} \
 ...
 @param gsuiteId
 @param id
 @return GSuiteApiTranslationRulesGSuiteDeleteRequest
*/
func (a *GSuiteApiService) TranslationRulesGSuiteDelete(ctx context.Context, gsuiteId string, id string) GSuiteApiTranslationRulesGSuiteDeleteRequest {
	return GSuiteApiTranslationRulesGSuiteDeleteRequest{
		ApiService: a,
		ctx: ctx,
		gsuiteId: gsuiteId,
...
// Execute executes the request
func (a *GSuiteApiService) TranslationRulesGSuiteDeleteExecute(r GSuiteApiTranslationRulesGSuiteDeleteRequest) (*http.Response, error) {
	var (
...
type GSuiteApiTranslationRulesGSuiteGetRequest struct {
	ctx context.Context
	ApiService *GSuiteApiService
	gsuiteId string
	id string
...
func (r GSuiteApiTranslationRulesGSuiteGetRequest) Execute() (*GSuiteTranslationRule, *http.Response, error) {
...
```
 ...
 @param gsuiteId
 @param id
 @return GSuiteApiTranslationRulesGSuiteGetRequest
*/
func (a *GSuiteApiService) TranslationRulesGSuiteGet(ctx context.Context, gsuiteId string, id string) GSuiteApiTranslationRulesGSuiteGetRequest {
	return GSuiteApiTranslationRulesGSuiteGetRequest{
		ApiService: a,
		ctx: ctx,
		gsuiteId: gsuiteId,
...
func (a *GSuiteApiService) TranslationRulesGSuiteGetExecute(r GSuiteApiTranslationRulesGSuiteGetRequest) (*GSuiteTranslationRule, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type GSuiteApiTranslationRulesGSuiteListRequest struct {
	ctx context.Context
	ApiService *GSuiteApiService
	gsuiteId string
	fields *[]string
...
func (r GSuiteApiTranslationRulesGSuiteListRequest) Fields(fields []string) GSuiteApiTranslationRulesGSuiteListRequest {
	r.fields = &fields
	return r
}

// A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
func (r GSuiteApiTranslationRulesGSuiteListRequest) Filter(filter []string) GSuiteApiTranslationRulesGSuiteListRequest {
	r.filter = &filter
	return r
}

// The number of records to return at once. Limited to 100.
func (r GSuiteApiTranslationRulesGSuiteListRequest) Limit(limit int32) GSuiteApiTranslationRulesGSuiteListRequest {
	r.limit = &limit
	return r
}

// The offset into the records to return.
func (r GSuiteApiTranslationRulesGSuiteListRequest) Skip(skip int32) GSuiteApiTranslationRulesGSuiteListRequest {
	r.skip = &skip
	return r
}

// The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. 
func (r GSuiteApiTranslationRulesGSuiteListRequest) Sort(sort []string) GSuiteApiTranslationRulesGSuiteListRequest {
	r.sort = &sort
	return r
}

func (r GSuiteApiTranslationRulesGSuiteListRequest) Execute() ([]GSuiteTranslationRule, *http.Response, error) {
...
curl -X GET  https://console.jumpcloud.com/api/v2/gsuites/{gsuite_id}/translationrules \
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param gsuiteId
 @return GSuiteApiTranslationRulesGSuiteListRequest
*/
func (a *GSuiteApiService) TranslationRulesGSuiteList(ctx context.Context, gsuiteId string) GSuiteApiTranslationRulesGSuiteListRequest {
	return GSuiteApiTranslationRulesGSuiteListRequest{
		ApiService: a,
		ctx: ctx,
		gsuiteId: gsuiteId,
...
// Execute executes the request
//  @return []GSuiteTranslationRule
func (a *GSuiteApiService) TranslationRulesGSuiteListExecute(r GSuiteApiTranslationRulesGSuiteListRequest) ([]GSuiteTranslationRule, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type GSuiteApiTranslationRulesGSuitePostRequest struct {
	ctx context.Context
	ApiService *GSuiteApiService
	gsuiteId string
...
func (r GSuiteApiTranslationRulesGSuitePostRequest) Body(body GSuiteTranslationRuleRequest) GSuiteApiTranslationRulesGSuitePostRequest {
	r.body = &body
	return r
}

func (r GSuiteApiTranslationRulesGSuitePostRequest) Execute() (*GSuiteTranslationRule, *http.Response, error) {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param gsuiteId
 @return GSuiteApiTranslationRulesGSuitePostRequest
*/
func (a *GSuiteApiService) TranslationRulesGSuitePost(ctx context.Context, gsuiteId string) GSuiteApiTranslationRulesGSuitePostRequest {
	return GSuiteApiTranslationRulesGSuitePostRequest{
		ApiService: a,
		ctx: ctx,
		gsuiteId: gsuiteId,
...
// Execute executes the request
//  @return GSuiteTranslationRule
func (a *GSuiteApiService) TranslationRulesGSuitePostExecute(r GSuiteApiTranslationRulesGSuitePostRequest) (*GSuiteTranslationRule, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
