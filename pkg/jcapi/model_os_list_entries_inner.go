...
// checks if the OSListEntriesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OSListEntriesInner{}

// OSListEntriesInner struct for OSListEntriesInner
type OSListEntriesInner struct {
...
type _OSListEntriesInner OSListEntriesInner
...
func (o OSListEntriesInner) MarshalJSON() ([]byte, error) {
...
func (o OSListEntriesInner) ToMap() (map[string]interface{}, error) {
...
func (o *OSListEntriesInner) UnmarshalJSON(bytes []byte) (err error) {
	varOSListEntriesInner := _OSListEntriesInner{}

	if err = json.Unmarshal(bytes, &varOSListEntriesInner); err == nil {
		*o = OSListEntriesInner(varOSListEntriesInner)
	}
...
type NullableOSListEntriesInner struct {
	value *OSListEntriesInner
	isSet bool
}

func (v NullableOSListEntriesInner) Get() *OSListEntriesInner {
	return v.value
}

func (v *NullableOSListEntriesInner) Set(val *OSListEntriesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableOSListEntriesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableOSListEntriesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOSListEntriesInner(val *OSListEntriesInner) *NullableOSListEntriesInner {
	return &NullableOSListEntriesInner{value: val, isSet: true}
}

func (v NullableOSListEntriesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOSListEntriesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
