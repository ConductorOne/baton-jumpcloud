...
// checks if the SystemInsightsBrowserPlugins type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemInsightsBrowserPlugins{}

// SystemInsightsBrowserPlugins struct for SystemInsightsBrowserPlugins
...
type _SystemInsightsBrowserPlugins SystemInsightsBrowserPlugins
...
func NewSystemInsightsBrowserPlugins() *SystemInsightsBrowserPlugins {
	this := SystemInsightsBrowserPlugins{}
	return &this
}
...
func (o *SystemInsightsBrowserPlugins) GetName() string {
...
// SetNative gets a reference to the given int32 and assigns it to the Native field.
...
func (o SystemInsightsBrowserPlugins) MarshalJSON() ([]byte, error) {
...
func (o SystemInsightsBrowserPlugins) ToMap() (map[string]interface{}, error) {
...
func (o *SystemInsightsBrowserPlugins) UnmarshalJSON(bytes []byte) (err error) {
	varSystemInsightsBrowserPlugins := _SystemInsightsBrowserPlugins{}

	if err = json.Unmarshal(bytes, &varSystemInsightsBrowserPlugins); err == nil {
		*o = SystemInsightsBrowserPlugins(varSystemInsightsBrowserPlugins)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "development_region")
...
type NullableSystemInsightsBrowserPlugins struct {
	value *SystemInsightsBrowserPlugins
	isSet bool
}

func (v NullableSystemInsightsBrowserPlugins) Get() *SystemInsightsBrowserPlugins {
	return v.value
}

func (v *NullableSystemInsightsBrowserPlugins) Set(val *SystemInsightsBrowserPlugins) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemInsightsBrowserPlugins) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemInsightsBrowserPlugins) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemInsightsBrowserPlugins(val *SystemInsightsBrowserPlugins) *NullableSystemInsightsBrowserPlugins {
	return &NullableSystemInsightsBrowserPlugins{value: val, isSet: true}
}

func (v NullableSystemInsightsBrowserPlugins) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemInsightsBrowserPlugins) UnmarshalJSON(src []byte) error {
	v.isSet = true
