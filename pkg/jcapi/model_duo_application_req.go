...
// checks if the DuoApplicationReq type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DuoApplicationReq{}

// DuoApplicationReq struct for DuoApplicationReq
...
type _DuoApplicationReq DuoApplicationReq
...
func (o DuoApplicationReq) MarshalJSON() ([]byte, error) {
...
func (o DuoApplicationReq) ToMap() (map[string]interface{}, error) {
...
func (o *DuoApplicationReq) UnmarshalJSON(bytes []byte) (err error) {
	varDuoApplicationReq := _DuoApplicationReq{}

	if err = json.Unmarshal(bytes, &varDuoApplicationReq); err == nil {
		*o = DuoApplicationReq(varDuoApplicationReq)
	}
...
type NullableDuoApplicationReq struct {
	value *DuoApplicationReq
	isSet bool
}

func (v NullableDuoApplicationReq) Get() *DuoApplicationReq {
	return v.value
}

func (v *NullableDuoApplicationReq) Set(val *DuoApplicationReq) {
	v.value = val
	v.isSet = true
}

func (v NullableDuoApplicationReq) IsSet() bool {
	return v.isSet
}

func (v *NullableDuoApplicationReq) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDuoApplicationReq(val *DuoApplicationReq) *NullableDuoApplicationReq {
	return &NullableDuoApplicationReq{value: val, isSet: true}
}

func (v NullableDuoApplicationReq) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDuoApplicationReq) UnmarshalJSON(src []byte) error {
	v.isSet = true
