...
// checks if the WorkdayOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkdayOutput{}

// WorkdayOutput struct for WorkdayOutput
...
type _WorkdayOutput WorkdayOutput
...
// SetAuth gets a reference to the given WorkdayOutputAuth and assigns it to the Auth field.
...
func (o WorkdayOutput) MarshalJSON() ([]byte, error) {
...
func (o WorkdayOutput) ToMap() (map[string]interface{}, error) {
...
func (o *WorkdayOutput) UnmarshalJSON(bytes []byte) (err error) {
	varWorkdayOutput := _WorkdayOutput{}

	if err = json.Unmarshal(bytes, &varWorkdayOutput); err == nil {
		*o = WorkdayOutput(varWorkdayOutput)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "reportUrl")
...
type NullableWorkdayOutput struct {
	value *WorkdayOutput
	isSet bool
}

func (v NullableWorkdayOutput) Get() *WorkdayOutput {
	return v.value
}

func (v *NullableWorkdayOutput) Set(val *WorkdayOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkdayOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkdayOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkdayOutput(val *WorkdayOutput) *NullableWorkdayOutput {
	return &NullableWorkdayOutput{value: val, isSet: true}
}

func (v NullableWorkdayOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkdayOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
