...
// checks if the SoftwareAppStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SoftwareAppStatus{}

// SoftwareAppStatus struct for SoftwareAppStatus
type SoftwareAppStatus struct {
	Code *int32 `json:"code,omitempty"`
	Details *string `json:"details,omitempty"`
	Id *string `json:"id,omitempty"`
	SoftwareAppId *string `json:"softwareAppId,omitempty"`
...
type _SoftwareAppStatus SoftwareAppStatus
...
func (o *SoftwareAppStatus) GetSoftwareAppId() string {
...
// and a boolean to check if the value has been set.
func (o *SoftwareAppStatus) GetSystemIdOk() (*string, bool) {
	if o == nil || IsNil(o.SystemId) {
		return nil, false
	}
...
func (o *SoftwareAppStatus) SetVersion(v string) {
	o.Version = &v
}

func (o SoftwareAppStatus) MarshalJSON() ([]byte, error) {
...
func (o SoftwareAppStatus) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SoftwareAppId) {
		toSerialize["softwareAppId"] = o.SoftwareAppId
	}
	if !IsNil(o.State) {
...
func (o *SoftwareAppStatus) UnmarshalJSON(bytes []byte) (err error) {
	varSoftwareAppStatus := _SoftwareAppStatus{}

	if err = json.Unmarshal(bytes, &varSoftwareAppStatus); err == nil {
		*o = SoftwareAppStatus(varSoftwareAppStatus)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "softwareAppId")
...
type NullableSoftwareAppStatus struct {
	value *SoftwareAppStatus
	isSet bool
}

func (v NullableSoftwareAppStatus) Get() *SoftwareAppStatus {
	return v.value
}

func (v *NullableSoftwareAppStatus) Set(val *SoftwareAppStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableSoftwareAppStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableSoftwareAppStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSoftwareAppStatus(val *SoftwareAppStatus) *NullableSoftwareAppStatus {
	return &NullableSoftwareAppStatus{value: val, isSet: true}
}

func (v NullableSoftwareAppStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSoftwareAppStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
