...
// checks if the SystemInsightsPythonPackages type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemInsightsPythonPackages{}

// SystemInsightsPythonPackages struct for SystemInsightsPythonPackages
type SystemInsightsPythonPackages struct {
...
type _SystemInsightsPythonPackages SystemInsightsPythonPackages
...
func NewSystemInsightsPythonPackages() *SystemInsightsPythonPackages {
	this := SystemInsightsPythonPackages{}
	return &this
}
...
// GetAuther returns the Auther field value if set, zero value otherwise.
func (o *SystemInsightsPythonPackages) GetAuther() string {
	if o == nil || IsNil(o.Auther) {
		var ret string
		return ret
	}
	return *o.Auther
...
// GetAutherOk returns a tuple with the Auther field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SystemInsightsPythonPackages) GetAutherOk() (*string, bool) {
	if o == nil || IsNil(o.Auther) {
		return nil, false
	}
	return o.Auther, true
}
...
// SetAuther gets a reference to the given string and assigns it to the Auther field.
...
func (o *SystemInsightsPythonPackages) GetName() string {
...
func (o SystemInsightsPythonPackages) MarshalJSON() ([]byte, error) {
...
func (o SystemInsightsPythonPackages) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Auther) {
		toSerialize["auther"] = o.Auther
	}
...
func (o *SystemInsightsPythonPackages) UnmarshalJSON(bytes []byte) (err error) {
	varSystemInsightsPythonPackages := _SystemInsightsPythonPackages{}

	if err = json.Unmarshal(bytes, &varSystemInsightsPythonPackages); err == nil {
		*o = SystemInsightsPythonPackages(varSystemInsightsPythonPackages)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "auther")
...
type NullableSystemInsightsPythonPackages struct {
	value *SystemInsightsPythonPackages
	isSet bool
}

func (v NullableSystemInsightsPythonPackages) Get() *SystemInsightsPythonPackages {
	return v.value
}

func (v *NullableSystemInsightsPythonPackages) Set(val *SystemInsightsPythonPackages) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemInsightsPythonPackages) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemInsightsPythonPackages) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemInsightsPythonPackages(val *SystemInsightsPythonPackages) *NullableSystemInsightsPythonPackages {
	return &NullableSystemInsightsPythonPackages{value: val, isSet: true}
}

func (v NullableSystemInsightsPythonPackages) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemInsightsPythonPackages) UnmarshalJSON(src []byte) error {
	v.isSet = true
