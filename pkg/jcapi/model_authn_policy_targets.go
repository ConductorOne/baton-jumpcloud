...
// checks if the AuthnPolicyTargets type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthnPolicyTargets{}

// AuthnPolicyTargets struct for AuthnPolicyTargets
type AuthnPolicyTargets struct {
	Resources []AuthnPolicyResourceTarget `json:"resources,omitempty"`
	UserAttributes *AuthnPolicyUserAttributeTarget `json:"userAttributes,omitempty"`
	UserGroups *AuthnPolicyUserGroupTarget `json:"userGroups,omitempty"`
	Users *AuthnPolicyUserTarget `json:"users,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AuthnPolicyTargets AuthnPolicyTargets
...
func (o *AuthnPolicyTargets) GetResources() []AuthnPolicyResourceTarget {
	if o == nil || IsNil(o.Resources) {
		var ret []AuthnPolicyResourceTarget
		return ret
	}
	return o.Resources
}
...
// SetResources gets a reference to the given []AuthnPolicyResourceTarget and assigns it to the Resources field.
...
func (o *AuthnPolicyTargets) GetUserAttributes() AuthnPolicyUserAttributeTarget {
	if o == nil || IsNil(o.UserAttributes) {
		var ret AuthnPolicyUserAttributeTarget
		return ret
	}
...
// SetUserAttributes gets a reference to the given AuthnPolicyUserAttributeTarget and assigns it to the UserAttributes field.
...
func (o *AuthnPolicyTargets) GetUserGroups() AuthnPolicyUserGroupTarget {
	if o == nil || IsNil(o.UserGroups) {
		var ret AuthnPolicyUserGroupTarget
		return ret
	}
	return *o.UserGroups
}
...
// SetUserGroups gets a reference to the given AuthnPolicyUserGroupTarget and assigns it to the UserGroups field.
...
// SetUsers gets a reference to the given AuthnPolicyUserTarget and assigns it to the Users field.
func (o *AuthnPolicyTargets) SetUsers(v AuthnPolicyUserTarget) {
	o.Users = &v
}

func (o AuthnPolicyTargets) MarshalJSON() ([]byte, error) {
...
func (o AuthnPolicyTargets) ToMap() (map[string]interface{}, error) {
...
func (o *AuthnPolicyTargets) UnmarshalJSON(bytes []byte) (err error) {
	varAuthnPolicyTargets := _AuthnPolicyTargets{}

	if err = json.Unmarshal(bytes, &varAuthnPolicyTargets); err == nil {
		*o = AuthnPolicyTargets(varAuthnPolicyTargets)
	}
...
type NullableAuthnPolicyTargets struct {
	value *AuthnPolicyTargets
	isSet bool
}

func (v NullableAuthnPolicyTargets) Get() *AuthnPolicyTargets {
	return v.value
}

func (v *NullableAuthnPolicyTargets) Set(val *AuthnPolicyTargets) {
	v.value = val
	v.isSet = true
}

func (v NullableAuthnPolicyTargets) IsSet() bool {
	return v.isSet
}

func (v *NullableAuthnPolicyTargets) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuthnPolicyTargets(val *AuthnPolicyTargets) *NullableAuthnPolicyTargets {
	return &NullableAuthnPolicyTargets{value: val, isSet: true}
}

func (v NullableAuthnPolicyTargets) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuthnPolicyTargets) UnmarshalJSON(src []byte) error {
	v.isSet = true
