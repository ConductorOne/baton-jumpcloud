...
// checks if the ConnectWiseTicketingAlertConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectWiseTicketingAlertConfiguration{}

// ConnectWiseTicketingAlertConfiguration struct for ConnectWiseTicketingAlertConfiguration
type ConnectWiseTicketingAlertConfiguration struct {
...
type _ConnectWiseTicketingAlertConfiguration ConnectWiseTicketingAlertConfiguration
...
func NewConnectWiseTicketingAlertConfiguration(shouldCreateTickets bool) *ConnectWiseTicketingAlertConfiguration {
	this := ConnectWiseTicketingAlertConfiguration{}
...
func (o ConnectWiseTicketingAlertConfiguration) MarshalJSON() ([]byte, error) {
...
func (o ConnectWiseTicketingAlertConfiguration) ToMap() (map[string]interface{}, error) {
...
func (o *ConnectWiseTicketingAlertConfiguration) UnmarshalJSON(bytes []byte) (err error) {
	varConnectWiseTicketingAlertConfiguration := _ConnectWiseTicketingAlertConfiguration{}

	if err = json.Unmarshal(bytes, &varConnectWiseTicketingAlertConfiguration); err == nil {
		*o = ConnectWiseTicketingAlertConfiguration(varConnectWiseTicketingAlertConfiguration)
	}
...
type NullableConnectWiseTicketingAlertConfiguration struct {
	value *ConnectWiseTicketingAlertConfiguration
	isSet bool
}

func (v NullableConnectWiseTicketingAlertConfiguration) Get() *ConnectWiseTicketingAlertConfiguration {
	return v.value
}

func (v *NullableConnectWiseTicketingAlertConfiguration) Set(val *ConnectWiseTicketingAlertConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableConnectWiseTicketingAlertConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableConnectWiseTicketingAlertConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConnectWiseTicketingAlertConfiguration(val *ConnectWiseTicketingAlertConfiguration) *NullableConnectWiseTicketingAlertConfiguration {
	return &NullableConnectWiseTicketingAlertConfiguration{value: val, isSet: true}
}

func (v NullableConnectWiseTicketingAlertConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConnectWiseTicketingAlertConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
