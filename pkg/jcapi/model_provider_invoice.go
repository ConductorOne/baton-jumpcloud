...
// checks if the ProviderInvoice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProviderInvoice{}

// ProviderInvoice Details of a an invoice
type ProviderInvoice struct {
	AmountBilled *string `json:"amountBilled,omitempty"`
...
type _ProviderInvoice ProviderInvoice
...
// GetAmountBilled returns the AmountBilled field value if set, zero value otherwise.
func (o *ProviderInvoice) GetAmountBilled() string {
	if o == nil || IsNil(o.AmountBilled) {
		var ret string
		return ret
	}
	return *o.AmountBilled
}

// GetAmountBilledOk returns a tuple with the AmountBilled field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProviderInvoice) GetAmountBilledOk() (*string, bool) {
	if o == nil || IsNil(o.AmountBilled) {
		return nil, false
	}
	return o.AmountBilled, true
}
...
// SetAmountBilled gets a reference to the given string and assigns it to the AmountBilled field.
...
func (o ProviderInvoice) MarshalJSON() ([]byte, error) {
...
func (o ProviderInvoice) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AmountBilled) {
		toSerialize["amountBilled"] = o.AmountBilled
	}
	if !IsNil(o.AmountPaid) {
		toSerialize["amountPaid"] = o.AmountPaid
	}
	if !IsNil(o.AmountRemaining) {
		toSerialize["amountRemaining"] = o.AmountRemaining
	}
	if !IsNil(o.Currency) {
...
func (o *ProviderInvoice) UnmarshalJSON(bytes []byte) (err error) {
	varProviderInvoice := _ProviderInvoice{}

	if err = json.Unmarshal(bytes, &varProviderInvoice); err == nil {
		*o = ProviderInvoice(varProviderInvoice)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "amountBilled")
		delete(additionalProperties, "amountPaid")
		delete(additionalProperties, "amountRemaining")
...
type NullableProviderInvoice struct {
	value *ProviderInvoice
	isSet bool
}

func (v NullableProviderInvoice) Get() *ProviderInvoice {
	return v.value
}

func (v *NullableProviderInvoice) Set(val *ProviderInvoice) {
	v.value = val
	v.isSet = true
}

func (v NullableProviderInvoice) IsSet() bool {
	return v.isSet
}

func (v *NullableProviderInvoice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProviderInvoice(val *ProviderInvoice) *NullableProviderInvoice {
	return &NullableProviderInvoice{value: val, isSet: true}
}

func (v NullableProviderInvoice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProviderInvoice) UnmarshalJSON(src []byte) error {
	v.isSet = true
