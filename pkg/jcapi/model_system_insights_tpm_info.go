...
// checks if the SystemInsightsTpmInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemInsightsTpmInfo{}

// SystemInsightsTpmInfo struct for SystemInsightsTpmInfo
type SystemInsightsTpmInfo struct {
	Activated *float32 `json:"activated,omitempty"`
	CollectionTime *string `json:"collection_time,omitempty"`
	Enabled *float32 `json:"enabled,omitempty"`
	ManufacturerId *float32 `json:"manufacturer_id,omitempty"`
	ManufacturerName *string `json:"manufacturer_name,omitempty"`
	ManufacturerVersion *string `json:"manufacturer_version,omitempty"`
	Owned *float32 `json:"owned,omitempty"`
	PhysicalPresenceVersion *string `json:"physical_presence_version,omitempty"`
...
type _SystemInsightsTpmInfo SystemInsightsTpmInfo
...
// SetActivated gets a reference to the given float32 and assigns it to the Activated field.
func (o *SystemInsightsTpmInfo) SetActivated(v float32) {
	o.Activated = &v
}
...
func (o *SystemInsightsTpmInfo) HasEnabled() bool {
	if o != nil && !IsNil(o.Enabled) {
		return true
	}
...
// SetManufacturerId gets a reference to the given float32 and assigns it to the ManufacturerId field.
...
// GetManufacturerVersion returns the ManufacturerVersion field value if set, zero value otherwise.
func (o *SystemInsightsTpmInfo) GetManufacturerVersion() string {
	if o == nil || IsNil(o.ManufacturerVersion) {
		var ret string
		return ret
	}
	return *o.ManufacturerVersion
}

// GetManufacturerVersionOk returns a tuple with the ManufacturerVersion field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SystemInsightsTpmInfo) GetManufacturerVersionOk() (*string, bool) {
	if o == nil || IsNil(o.ManufacturerVersion) {
		return nil, false
	}
	return o.ManufacturerVersion, true
}
...
// SetManufacturerVersion gets a reference to the given string and assigns it to the ManufacturerVersion field.
func (o *SystemInsightsTpmInfo) SetManufacturerVersion(v string) {
	o.ManufacturerVersion = &v
}
...
// SetOwned gets a reference to the given float32 and assigns it to the Owned field.
func (o *SystemInsightsTpmInfo) SetOwned(v float32) {
	o.Owned = &v
}

// GetPhysicalPresenceVersion returns the PhysicalPresenceVersion field value if set, zero value otherwise.
func (o *SystemInsightsTpmInfo) GetPhysicalPresenceVersion() string {
	if o == nil || IsNil(o.PhysicalPresenceVersion) {
		var ret string
		return ret
	}
	return *o.PhysicalPresenceVersion
}

// GetPhysicalPresenceVersionOk returns a tuple with the PhysicalPresenceVersion field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SystemInsightsTpmInfo) GetPhysicalPresenceVersionOk() (*string, bool) {
	if o == nil || IsNil(o.PhysicalPresenceVersion) {
		return nil, false
	}
	return o.PhysicalPresenceVersion, true
}
...
// SetPhysicalPresenceVersion gets a reference to the given string and assigns it to the PhysicalPresenceVersion field.
func (o *SystemInsightsTpmInfo) SetPhysicalPresenceVersion(v string) {
	o.PhysicalPresenceVersion = &v
}
...
func (o *SystemInsightsTpmInfo) SetSpecVersion(v string) {
	o.SpecVersion = &v
}
...
func (o SystemInsightsTpmInfo) MarshalJSON() ([]byte, error) {
...
func (o SystemInsightsTpmInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ManufacturerName) {
		toSerialize["manufacturer_name"] = o.ManufacturerName
	}
	if !IsNil(o.ManufacturerVersion) {
		toSerialize["manufacturer_version"] = o.ManufacturerVersion
	}
	if !IsNil(o.Owned) {
		toSerialize["owned"] = o.Owned
	}
	if !IsNil(o.PhysicalPresenceVersion) {
		toSerialize["physical_presence_version"] = o.PhysicalPresenceVersion
	}
...
func (o *SystemInsightsTpmInfo) UnmarshalJSON(bytes []byte) (err error) {
	varSystemInsightsTpmInfo := _SystemInsightsTpmInfo{}

	if err = json.Unmarshal(bytes, &varSystemInsightsTpmInfo); err == nil {
		*o = SystemInsightsTpmInfo(varSystemInsightsTpmInfo)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "manufacturer_name")
		delete(additionalProperties, "manufacturer_version")
		delete(additionalProperties, "owned")
		delete(additionalProperties, "physical_presence_version")
...
type NullableSystemInsightsTpmInfo struct {
	value *SystemInsightsTpmInfo
	isSet bool
}

func (v NullableSystemInsightsTpmInfo) Get() *SystemInsightsTpmInfo {
	return v.value
}

func (v *NullableSystemInsightsTpmInfo) Set(val *SystemInsightsTpmInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemInsightsTpmInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemInsightsTpmInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemInsightsTpmInfo(val *SystemInsightsTpmInfo) *NullableSystemInsightsTpmInfo {
	return &NullableSystemInsightsTpmInfo{value: val, isSet: true}
}

func (v NullableSystemInsightsTpmInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemInsightsTpmInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
