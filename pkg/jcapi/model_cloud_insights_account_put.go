...
// checks if the CloudInsightsAccountPut type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudInsightsAccountPut{}

// CloudInsightsAccountPut struct for CloudInsightsAccountPut
type CloudInsightsAccountPut struct {
	AwsAccountAlias *string `json:"awsAccountAlias,omitempty"`
	IsActivated *string `json:"isActivated,omitempty"`
	IsValidated *string `json:"isValidated,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _CloudInsightsAccountPut CloudInsightsAccountPut
...
// GetIsActivated returns the IsActivated field value if set, zero value otherwise.
func (o *CloudInsightsAccountPut) GetIsActivated() string {
	if o == nil || IsNil(o.IsActivated) {
		var ret string
		return ret
	}
...
// SetIsActivated gets a reference to the given string and assigns it to the IsActivated field.
...
// SetIsValidated gets a reference to the given string and assigns it to the IsValidated field.
func (o *CloudInsightsAccountPut) SetIsValidated(v string) {
	o.IsValidated = &v
}

func (o CloudInsightsAccountPut) MarshalJSON() ([]byte, error) {
...
func (o CloudInsightsAccountPut) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AwsAccountAlias) {
		toSerialize["awsAccountAlias"] = o.AwsAccountAlias
	}
	if !IsNil(o.IsActivated) {
		toSerialize["isActivated"] = o.IsActivated
	}
...
func (o *CloudInsightsAccountPut) UnmarshalJSON(bytes []byte) (err error) {
	varCloudInsightsAccountPut := _CloudInsightsAccountPut{}

	if err = json.Unmarshal(bytes, &varCloudInsightsAccountPut); err == nil {
		*o = CloudInsightsAccountPut(varCloudInsightsAccountPut)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "awsAccountAlias")
		delete(additionalProperties, "isActivated")
		delete(additionalProperties, "isValidated")
...
type NullableCloudInsightsAccountPut struct {
	value *CloudInsightsAccountPut
	isSet bool
}

func (v NullableCloudInsightsAccountPut) Get() *CloudInsightsAccountPut {
	return v.value
}

func (v *NullableCloudInsightsAccountPut) Set(val *CloudInsightsAccountPut) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudInsightsAccountPut) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudInsightsAccountPut) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudInsightsAccountPut(val *CloudInsightsAccountPut) *NullableCloudInsightsAccountPut {
	return &NullableCloudInsightsAccountPut{value: val, isSet: true}
}

func (v NullableCloudInsightsAccountPut) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudInsightsAccountPut) UnmarshalJSON(src []byte) error {
	v.isSet = true
