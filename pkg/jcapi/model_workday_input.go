...
// checks if the WorkdayInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkdayInput{}

// WorkdayInput struct for WorkdayInput
...
type _WorkdayInput WorkdayInput
...
func (o WorkdayInput) MarshalJSON() ([]byte, error) {
...
func (o WorkdayInput) ToMap() (map[string]interface{}, error) {
...
func (o *WorkdayInput) UnmarshalJSON(bytes []byte) (err error) {
	varWorkdayInput := _WorkdayInput{}

	if err = json.Unmarshal(bytes, &varWorkdayInput); err == nil {
		*o = WorkdayInput(varWorkdayInput)
	}
...
type NullableWorkdayInput struct {
	value *WorkdayInput
	isSet bool
}

func (v NullableWorkdayInput) Get() *WorkdayInput {
	return v.value
}

func (v *NullableWorkdayInput) Set(val *WorkdayInput) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkdayInput) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkdayInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkdayInput(val *WorkdayInput) *NullableWorkdayInput {
	return &NullableWorkdayInput{value: val, isSet: true}
}

func (v NullableWorkdayInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkdayInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
