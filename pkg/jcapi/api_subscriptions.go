...
func (r SubscriptionsApiSubscriptionsGetRequest) Execute() ([]Subscription, *http.Response, error) {
	return r.ApiService.SubscriptionsGetExecute(r)
}

/*
SubscriptionsGet Lists all the Pricing & Packaging Subscriptions
...
//  @return []Subscription
func (a *SubscriptionsApiService) SubscriptionsGetExecute(r SubscriptionsApiSubscriptionsGetRequest) ([]Subscription, *http.Response, error) {
	var (
