...
// checks if the SystemInsightsSipConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemInsightsSipConfig{}

// SystemInsightsSipConfig struct for SystemInsightsSipConfig
...
type _SystemInsightsSipConfig SystemInsightsSipConfig
...
// GetConfigFlag returns the ConfigFlag field value if set, zero value otherwise.
func (o *SystemInsightsSipConfig) GetConfigFlag() string {
	if o == nil || IsNil(o.ConfigFlag) {
		var ret string
		return ret
	}
	return *o.ConfigFlag
...
// SetConfigFlag gets a reference to the given string and assigns it to the ConfigFlag field.
...
// GetEnabledNvram returns the EnabledNvram field value if set, zero value otherwise.
func (o *SystemInsightsSipConfig) GetEnabledNvram() int32 {
	if o == nil || IsNil(o.EnabledNvram) {
		var ret int32
		return ret
	}
	return *o.EnabledNvram
}

// GetEnabledNvramOk returns a tuple with the EnabledNvram field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SystemInsightsSipConfig) GetEnabledNvramOk() (*int32, bool) {
	if o == nil || IsNil(o.EnabledNvram) {
		return nil, false
	}
	return o.EnabledNvram, true
}
...
// SetEnabledNvram gets a reference to the given int32 and assigns it to the EnabledNvram field.
...
func (o SystemInsightsSipConfig) MarshalJSON() ([]byte, error) {
...
func (o SystemInsightsSipConfig) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.CollectionTime) {
		toSerialize["collection_time"] = o.CollectionTime
	}
	if !IsNil(o.ConfigFlag) {
		toSerialize["config_flag"] = o.ConfigFlag
	}
	if !IsNil(o.Enabled) {
		toSerialize["enabled"] = o.Enabled
	}
	if !IsNil(o.EnabledNvram) {
		toSerialize["enabled_nvram"] = o.EnabledNvram
	}
	if !IsNil(o.SystemId) {
...
func (o *SystemInsightsSipConfig) UnmarshalJSON(bytes []byte) (err error) {
	varSystemInsightsSipConfig := _SystemInsightsSipConfig{}

	if err = json.Unmarshal(bytes, &varSystemInsightsSipConfig); err == nil {
		*o = SystemInsightsSipConfig(varSystemInsightsSipConfig)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "config_flag")
		delete(additionalProperties, "enabled")
		delete(additionalProperties, "enabled_nvram")
...
type NullableSystemInsightsSipConfig struct {
	value *SystemInsightsSipConfig
	isSet bool
}

func (v NullableSystemInsightsSipConfig) Get() *SystemInsightsSipConfig {
	return v.value
}

func (v *NullableSystemInsightsSipConfig) Set(val *SystemInsightsSipConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemInsightsSipConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemInsightsSipConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemInsightsSipConfig(val *SystemInsightsSipConfig) *NullableSystemInsightsSipConfig {
	return &NullableSystemInsightsSipConfig{value: val, isSet: true}
}

func (v NullableSystemInsightsSipConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemInsightsSipConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
