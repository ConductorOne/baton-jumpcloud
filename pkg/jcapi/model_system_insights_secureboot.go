...
// checks if the SystemInsightsSecureboot type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemInsightsSecureboot{}

// SystemInsightsSecureboot struct for SystemInsightsSecureboot
type SystemInsightsSecureboot struct {
	CollectionTime *string `json:"collection_time,omitempty"`
	SecureBoot *float32 `json:"secure_boot,omitempty"`
	SetupMode *float32 `json:"setup_mode,omitempty"`
	SystemId *string `json:"system_id,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _SystemInsightsSecureboot SystemInsightsSecureboot
...
// SetSecureBoot gets a reference to the given float32 and assigns it to the SecureBoot field.
...
// SetSetupMode gets a reference to the given float32 and assigns it to the SetupMode field.
...
func (o SystemInsightsSecureboot) MarshalJSON() ([]byte, error) {
...
func (o SystemInsightsSecureboot) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.CollectionTime) {
		toSerialize["collection_time"] = o.CollectionTime
	}
	if !IsNil(o.SecureBoot) {
		toSerialize["secure_boot"] = o.SecureBoot
	}
	if !IsNil(o.SetupMode) {
		toSerialize["setup_mode"] = o.SetupMode
	}
	if !IsNil(o.SystemId) {
...
func (o *SystemInsightsSecureboot) UnmarshalJSON(bytes []byte) (err error) {
	varSystemInsightsSecureboot := _SystemInsightsSecureboot{}

	if err = json.Unmarshal(bytes, &varSystemInsightsSecureboot); err == nil {
		*o = SystemInsightsSecureboot(varSystemInsightsSecureboot)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "secure_boot")
		delete(additionalProperties, "setup_mode")
...
type NullableSystemInsightsSecureboot struct {
	value *SystemInsightsSecureboot
	isSet bool
}

func (v NullableSystemInsightsSecureboot) Get() *SystemInsightsSecureboot {
	return v.value
}

func (v *NullableSystemInsightsSecureboot) Set(val *SystemInsightsSecureboot) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemInsightsSecureboot) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemInsightsSecureboot) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemInsightsSecureboot(val *SystemInsightsSecureboot) *NullableSystemInsightsSecureboot {
	return &NullableSystemInsightsSecureboot{value: val, isSet: true}
}

func (v NullableSystemInsightsSecureboot) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemInsightsSecureboot) UnmarshalJSON(src []byte) error {
	v.isSet = true
