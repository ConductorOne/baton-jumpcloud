...
// checks if the SharedFolderDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SharedFolderDetails{}

// SharedFolderDetails struct for SharedFolderDetails
type SharedFolderDetails struct {
...
type _SharedFolderDetails SharedFolderDetails
...
func (o SharedFolderDetails) MarshalJSON() ([]byte, error) {
...
func (o SharedFolderDetails) ToMap() (map[string]interface{}, error) {
...
func (o *SharedFolderDetails) UnmarshalJSON(bytes []byte) (err error) {
	varSharedFolderDetails := _SharedFolderDetails{}

	if err = json.Unmarshal(bytes, &varSharedFolderDetails); err == nil {
		*o = SharedFolderDetails(varSharedFolderDetails)
	}
...
type NullableSharedFolderDetails struct {
	value *SharedFolderDetails
	isSet bool
}

func (v NullableSharedFolderDetails) Get() *SharedFolderDetails {
	return v.value
}

func (v *NullableSharedFolderDetails) Set(val *SharedFolderDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableSharedFolderDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableSharedFolderDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSharedFolderDetails(val *SharedFolderDetails) *NullableSharedFolderDetails {
	return &NullableSharedFolderDetails{value: val, isSet: true}
}

func (v NullableSharedFolderDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSharedFolderDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
