...
// checks if the CloudInsightsAccountPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudInsightsAccountPost{}

// CloudInsightsAccountPost Properties of a Cloud Insights account POST object
type CloudInsightsAccountPost struct {
...
type _CloudInsightsAccountPost CloudInsightsAccountPost
...
func (o CloudInsightsAccountPost) MarshalJSON() ([]byte, error) {
...
func (o CloudInsightsAccountPost) ToMap() (map[string]interface{}, error) {
...
func (o *CloudInsightsAccountPost) UnmarshalJSON(bytes []byte) (err error) {
	varCloudInsightsAccountPost := _CloudInsightsAccountPost{}

	if err = json.Unmarshal(bytes, &varCloudInsightsAccountPost); err == nil {
		*o = CloudInsightsAccountPost(varCloudInsightsAccountPost)
	}
...
type NullableCloudInsightsAccountPost struct {
	value *CloudInsightsAccountPost
	isSet bool
}

func (v NullableCloudInsightsAccountPost) Get() *CloudInsightsAccountPost {
	return v.value
}

func (v *NullableCloudInsightsAccountPost) Set(val *CloudInsightsAccountPost) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudInsightsAccountPost) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudInsightsAccountPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudInsightsAccountPost(val *CloudInsightsAccountPost) *NullableCloudInsightsAccountPost {
	return &NullableCloudInsightsAccountPost{value: val, isSet: true}
}

func (v NullableCloudInsightsAccountPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudInsightsAccountPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
