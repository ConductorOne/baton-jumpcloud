...
// checks if the OrganizationCase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationCase{}

// OrganizationCase Details of an organization's case (support/feature request)
...
type _OrganizationCase OrganizationCase
...
func (o *OrganizationCase) GetLabel() string {
...
// GetReporterEmail returns the ReporterEmail field value if set, zero value otherwise.
func (o *OrganizationCase) GetReporterEmail() string {
	if o == nil || IsNil(o.ReporterEmail) {
		var ret string
		return ret
	}
...
// SetReporterEmail gets a reference to the given string and assigns it to the ReporterEmail field.
...
func (o *OrganizationCase) SetSubject(v string) {
	o.Subject = &v
}

func (o OrganizationCase) MarshalJSON() ([]byte, error) {
...
func (o OrganizationCase) ToMap() (map[string]interface{}, error) {
...
func (o *OrganizationCase) UnmarshalJSON(bytes []byte) (err error) {
	varOrganizationCase := _OrganizationCase{}

	if err = json.Unmarshal(bytes, &varOrganizationCase); err == nil {
		*o = OrganizationCase(varOrganizationCase)
	}
...
type NullableOrganizationCase struct {
	value *OrganizationCase
	isSet bool
}

func (v NullableOrganizationCase) Get() *OrganizationCase {
	return v.value
}

func (v *NullableOrganizationCase) Set(val *OrganizationCase) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganizationCase) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganizationCase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganizationCase(val *OrganizationCase) *NullableOrganizationCase {
	return &NullableOrganizationCase{value: val, isSet: true}
}

func (v NullableOrganizationCase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrganizationCase) UnmarshalJSON(src []byte) error {
	v.isSet = true
