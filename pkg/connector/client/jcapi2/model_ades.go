...
// checks if the ADES type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ADES{}

// ADES struct for ADES
type ADES struct {
	Ios *ADE `json:"ios,omitempty"`
	Macos *ADE `json:"macos,omitempty"`
...
// SetIos gets a reference to the given ADE and assigns it to the Ios field.
...
// SetMacos gets a reference to the given ADE and assigns it to the Macos field.
func (o *ADES) SetMacos(v ADE) {
	o.Macos = &v
}

func (o ADES) MarshalJSON() ([]byte, error) {
...
func (o ADES) ToMap() (map[string]interface{}, error) {
...
func (o *ADES) UnmarshalJSON(bytes []byte) (err error) {
	varADES := _ADES{}

	if err = json.Unmarshal(bytes, &varADES); err == nil {
		*o = ADES(varADES)
	}
...
type NullableADES struct {
	value *ADES
	isSet bool
}

func (v NullableADES) Get() *ADES {
	return v.value
}

func (v *NullableADES) Set(val *ADES) {
	v.value = val
	v.isSet = true
}

func (v NullableADES) IsSet() bool {
	return v.isSet
}

func (v *NullableADES) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableADES(val *ADES) *NullableADES {
	return &NullableADES{value: val, isSet: true}
}

func (v NullableADES) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableADES) UnmarshalJSON(src []byte) error {
	v.isSet = true
