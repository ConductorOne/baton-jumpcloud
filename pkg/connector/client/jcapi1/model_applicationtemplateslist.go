...
// checks if the Applicationtemplateslist type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Applicationtemplateslist{}
...
type _Applicationtemplateslist Applicationtemplateslist
...
func (o *Applicationtemplateslist) UnmarshalJSON(bytes []byte) (err error) {
	varApplicationtemplateslist := _Applicationtemplateslist{}

	if err = json.Unmarshal(bytes, &varApplicationtemplateslist); err == nil {
		*o = Applicationtemplateslist(varApplicationtemplateslist)
	}
...
type NullableApplicationtemplateslist struct {
	value *Applicationtemplateslist
	isSet bool
}
...
func NewNullableApplicationtemplateslist(val *Applicationtemplateslist) *NullableApplicationtemplateslist {
	return &NullableApplicationtemplateslist{value: val, isSet: true}
}
