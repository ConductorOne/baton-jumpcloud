...
// checks if the CommandresultResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommandresultResponse{}
...
type _CommandresultResponse CommandresultResponse
...
func (o *CommandresultResponse) GetData() CommandresultResponseData {
	if o == nil || IsNil(o.Data) {
		var ret CommandresultResponseData
		return ret
	}
	return *o.Data
}
...
func (o *CommandresultResponse) UnmarshalJSON(bytes []byte) (err error) {
	varCommandresultResponse := _CommandresultResponse{}

	if err = json.Unmarshal(bytes, &varCommandresultResponse); err == nil {
		*o = CommandresultResponse(varCommandresultResponse)
	}
...
func NewNullableCommandresultResponse(val *CommandresultResponse) *NullableCommandresultResponse {
	return &NullableCommandresultResponse{value: val, isSet: true}
}
