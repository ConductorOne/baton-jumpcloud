...
// checks if the CommandresultslistResultsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommandresultslistResultsInner{}
...
type _CommandresultslistResultsInner CommandresultslistResultsInner
...
func NewCommandresultslistResultsInner() *CommandresultslistResultsInner {
	this := CommandresultslistResultsInner{}
	return &this
}
...
func (o *CommandresultslistResultsInner) UnmarshalJSON(bytes []byte) (err error) {
	varCommandresultslistResultsInner := _CommandresultslistResultsInner{}

	if err = json.Unmarshal(bytes, &varCommandresultslistResultsInner); err == nil {
		*o = CommandresultslistResultsInner(varCommandresultslistResultsInner)
	}
...
type NullableCommandresultslistResultsInner struct {
	value *CommandresultslistResultsInner
	isSet bool
}
...
func NewNullableCommandresultslistResultsInner(val *CommandresultslistResultsInner) *NullableCommandresultslistResultsInner {
	return &NullableCommandresultslistResultsInner{value: val, isSet: true}
}
