...
func (o *Organization) GetEntitlement() Organizationentitlement {
	if o == nil || IsNil(o.Entitlement) {
		var ret Organizationentitlement
		return ret
	}
...
func (o *Organization) GetHasCreditCard() bool {
	if o == nil || IsNil(o.HasCreditCard) {
		var ret bool
		return ret
	}
...
// GetHasCreditCardOk returns a tuple with the HasCreditCard field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Organization) GetHasCreditCardOk() (*bool, bool) {
	if o == nil || IsNil(o.HasCreditCard) {
		return nil, false
	}
	return o.HasCreditCard, true
}
...
func (o *Organization) GetHasStripeCustomerId() bool {
	if o == nil || IsNil(o.HasStripeCustomerId) {
		var ret bool
		return ret
	}
	return *o.HasStripeCustomerId
}

// GetHasStripeCustomerIdOk returns a tuple with the HasStripeCustomerId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Organization) GetHasStripeCustomerIdOk() (*bool, bool) {
	if o == nil || IsNil(o.HasStripeCustomerId) {
		return nil, false
	}
	return o.HasStripeCustomerId, true
}
...
func (o *Organization) GetLastEstimateCalculationTimeStamp() string {
	if o == nil || IsNil(o.LastEstimateCalculationTimeStamp) {
		var ret string
		return ret
	}
	return *o.LastEstimateCalculationTimeStamp
}

// GetLastEstimateCalculationTimeStampOk returns a tuple with the LastEstimateCalculationTimeStamp field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Organization) GetLastEstimateCalculationTimeStampOk() (*string, bool) {
	if o == nil || IsNil(o.LastEstimateCalculationTimeStamp) {
		return nil, false
	}
	return o.LastEstimateCalculationTimeStamp, true
}
...
func (o *Organization) SetLastEstimateCalculationTimeStamp(v string) {
	o.LastEstimateCalculationTimeStamp = &v
}
...
func (o *Organization) GetLastSfdcSyncStatus() map[string]interface{} {
	if o == nil || IsNil(o.LastSfdcSyncStatus) {
		var ret map[string]interface{}
		return ret
	}
	return o.LastSfdcSyncStatus
}

// GetLastSfdcSyncStatusOk returns a tuple with the LastSfdcSyncStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Organization) GetLastSfdcSyncStatusOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.LastSfdcSyncStatus) {
		return map[string]interface{}{}, false
	}
	return o.LastSfdcSyncStatus, true
}
...
func (o *Organization) GetTotalBillingEstimate() int32 {
	if o == nil || IsNil(o.TotalBillingEstimate) {
		var ret int32
		return ret
	}
	return *o.TotalBillingEstimate
}

// GetTotalBillingEstimateOk returns a tuple with the TotalBillingEstimate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Organization) GetTotalBillingEstimateOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalBillingEstimate) {
		return nil, false
	}
	return o.TotalBillingEstimate, true
}
...
func (o Organization) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.HasCreditCard) {
		toSerialize["hasCreditCard"] = o.HasCreditCard
	}
	if !IsNil(o.HasStripeCustomerId) {
		toSerialize["hasStripeCustomerId"] = o.HasStripeCustomerId
	}
	if !IsNil(o.LastEstimateCalculationTimeStamp) {
		toSerialize["lastEstimateCalculationTimeStamp"] = o.LastEstimateCalculationTimeStamp
	}
	if !IsNil(o.LastSfdcSyncStatus) {
		toSerialize["lastSfdcSyncStatus"] = o.LastSfdcSyncStatus
	}
	if !IsNil(o.LogoUrl) {
	...
	if !IsNil(o.TotalBillingEstimate) {
		toSerialize["totalBillingEstimate"] = o.TotalBillingEstimate
	}
...
func (o *Organization) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "accountsReceivable")
		delete(additionalProperties, "created")
		delete(additionalProperties, "displayName")
		delete(additionalProperties, "entitlement")
		delete(additionalProperties, "hasCreditCard")
		delete(additionalProperties, "hasStripeCustomerId")
		delete(additionalProperties, "lastEstimateCalculationTimeStamp")
		delete(additionalProperties, "lastSfdcSyncStatus")
		delete(additionalProperties, "logoUrl")
		delete(additionalProperties, "provider")
		delete(additionalProperties, "settings")
		delete(additionalProperties, "totalBillingEstimate")
