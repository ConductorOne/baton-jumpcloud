...
// checks if the Radiusserverput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Radiusserverput{}
...
type _Radiusserverput Radiusserverput
...
func (o *Radiusserverput) UnmarshalJSON(bytes []byte) (err error) {
	varRadiusserverput := _Radiusserverput{}

	if err = json.Unmarshal(bytes, &varRadiusserverput); err == nil {
		*o = Radiusserverput(varRadiusserverput)
	}
...
func NewNullableRadiusserverput(val *Radiusserverput) *NullableRadiusserverput {
	return &NullableRadiusserverput{value: val, isSet: true}
}
