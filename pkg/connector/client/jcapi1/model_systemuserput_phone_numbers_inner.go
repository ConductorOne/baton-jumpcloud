...
// checks if the SystemuserputPhoneNumbersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemuserputPhoneNumbersInner{}
...
type _SystemuserputPhoneNumbersInner SystemuserputPhoneNumbersInner
...
func NewSystemuserputPhoneNumbersInner() *SystemuserputPhoneNumbersInner {
	this := SystemuserputPhoneNumbersInner{}
	return &this
}
...
func (o *SystemuserputPhoneNumbersInner) UnmarshalJSON(bytes []byte) (err error) {
	varSystemuserputPhoneNumbersInner := _SystemuserputPhoneNumbersInner{}

	if err = json.Unmarshal(bytes, &varSystemuserputPhoneNumbersInner); err == nil {
		*o = SystemuserputPhoneNumbersInner(varSystemuserputPhoneNumbersInner)
	}
...
type NullableSystemuserputPhoneNumbersInner struct {
	value *SystemuserputPhoneNumbersInner
	isSet bool
}
...
func NewNullableSystemuserputPhoneNumbersInner(val *SystemuserputPhoneNumbersInner) *NullableSystemuserputPhoneNumbersInner {
	return &NullableSystemuserputPhoneNumbersInner{value: val, isSet: true}
}
