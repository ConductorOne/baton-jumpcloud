...
// checks if the Radiusserverslist type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Radiusserverslist{}
...
type _Radiusserverslist Radiusserverslist
...
func (o *Radiusserverslist) UnmarshalJSON(bytes []byte) (err error) {
	varRadiusserverslist := _Radiusserverslist{}

	if err = json.Unmarshal(bytes, &varRadiusserverslist); err == nil {
		*o = Radiusserverslist(varRadiusserverslist)
	}
...
func NewNullableRadiusserverslist(val *Radiusserverslist) *NullableRadiusserverslist {
	return &NullableRadiusserverslist{value: val, isSet: true}
}
