...
// checks if the OrganizationentitlementEntitlementProductsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationentitlementEntitlementProductsInner{}
...
type _OrganizationentitlementEntitlementProductsInner OrganizationentitlementEntitlementProductsInner
...
func NewOrganizationentitlementEntitlementProductsInner() *OrganizationentitlementEntitlementProductsInner {
	this := OrganizationentitlementEntitlementProductsInner{}
	return &this
}
...
func (o *OrganizationentitlementEntitlementProductsInner) GetCommittedUsers() int32 {
	if o == nil || IsNil(o.CommittedUsers) {
		var ret int32
		return ret
	}
	return *o.CommittedUsers
}

// GetCommittedUsersOk returns a tuple with the CommittedUsers field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OrganizationentitlementEntitlementProductsInner) GetCommittedUsersOk() (*int32, bool) {
	if o == nil || IsNil(o.CommittedUsers) {
		return nil, false
	}
	return o.CommittedUsers, true
}
...
func (o *OrganizationentitlementEntitlementProductsInner) GetMaxUserCount() int32 {
	if o == nil || IsNil(o.MaxUserCount) {
		var ret int32
		return ret
	}
	return *o.MaxUserCount
}

// GetMaxUserCountOk returns a tuple with the MaxUserCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OrganizationentitlementEntitlementProductsInner) GetMaxUserCountOk() (*int32, bool) {
	if o == nil || IsNil(o.MaxUserCount) {
		return nil, false
	}
	return o.MaxUserCount, true
}
...
func (o *OrganizationentitlementEntitlementProductsInner) GetPricePerUser() int32 {
	if o == nil || IsNil(o.PricePerUser) {
		var ret int32
		return ret
	}
	return *o.PricePerUser
}

// GetPricePerUserOk returns a tuple with the PricePerUser field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OrganizationentitlementEntitlementProductsInner) GetPricePerUserOk() (*int32, bool) {
	if o == nil || IsNil(o.PricePerUser) {
		return nil, false
	}
	return o.PricePerUser, true
}
...
func (o *OrganizationentitlementEntitlementProductsInner) GetUncommittedUsers() int32 {
	if o == nil || IsNil(o.UncommittedUsers) {
		var ret int32
		return ret
	}
	return *o.UncommittedUsers
}

// GetUncommittedUsersOk returns a tuple with the UncommittedUsers field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OrganizationentitlementEntitlementProductsInner) GetUncommittedUsersOk() (*int32, bool) {
	if o == nil || IsNil(o.UncommittedUsers) {
		return nil, false
	}
	return o.UncommittedUsers, true
}
...
func (o OrganizationentitlementEntitlementProductsInner) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CommittedUsers) {
		toSerialize["committedUsers"] = o.CommittedUsers
	}
	if !IsNil(o.ContractType) {
		toSerialize["contractType"] = o.ContractType
	}
	if !IsNil(o.MaxUserCount) {
		toSerialize["maxUserCount"] = o.MaxUserCount
	}
	if !IsNil(o.Name) {
		toSerialize["name"] = o.Name
	}
	if !IsNil(o.PricePerUser) {
		toSerialize["pricePerUser"] = o.PricePerUser
	}
	...
	if !IsNil(o.UncommittedUsers) {
		toSerialize["uncommittedUsers"] = o.UncommittedUsers
	}
...
func (o *OrganizationentitlementEntitlementProductsInner) UnmarshalJSON(bytes []byte) (err error) {
	varOrganizationentitlementEntitlementProductsInner := _OrganizationentitlementEntitlementProductsInner{}

	if err = json.Unmarshal(bytes, &varOrganizationentitlementEntitlementProductsInner); err == nil {
		*o = OrganizationentitlementEntitlementProductsInner(varOrganizationentitlementEntitlementProductsInner)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "committedUsers")
		delete(additionalProperties, "contractType")
		delete(additionalProperties, "maxUserCount")
		delete(additionalProperties, "name")
		delete(additionalProperties, "pricePerUser")
		delete(additionalProperties, "productCategory")
		delete(additionalProperties, "productCode")
		delete(additionalProperties, "uncommittedUsers")
...
type NullableOrganizationentitlementEntitlementProductsInner struct {
	value *OrganizationentitlementEntitlementProductsInner
	isSet bool
}
...
func NewNullableOrganizationentitlementEntitlementProductsInner(val *OrganizationentitlementEntitlementProductsInner) *NullableOrganizationentitlementEntitlementProductsInner {
	return &NullableOrganizationentitlementEntitlementProductsInner{value: val, isSet: true}
}
