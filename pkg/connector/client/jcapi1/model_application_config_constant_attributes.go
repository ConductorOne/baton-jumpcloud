...
// checks if the ApplicationConfigConstantAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationConfigConstantAttributes{}
...
type _ApplicationConfigConstantAttributes ApplicationConfigConstantAttributes
...
func NewApplicationConfigConstantAttributes() *ApplicationConfigConstantAttributes {
	this := ApplicationConfigConstantAttributes{}
	return &this
}
...
func (o *ApplicationConfigConstantAttributes) GetTooltip() ApplicationConfigAcsUrlTooltip {
	if o == nil || IsNil(o.Tooltip) {
		var ret ApplicationConfigAcsUrlTooltip
		return ret
	}
	return *o.Tooltip
}
...
func (o *ApplicationConfigConstantAttributes) GetValue() []ApplicationConfigConstantAttributesValueInner {
	if o == nil || IsNil(o.Value) {
		var ret []ApplicationConfigConstantAttributesValueInner
		return ret
	}
	return o.Value
}
...
func (o *ApplicationConfigConstantAttributes) UnmarshalJSON(bytes []byte) (err error) {
	varApplicationConfigConstantAttributes := _ApplicationConfigConstantAttributes{}

	if err = json.Unmarshal(bytes, &varApplicationConfigConstantAttributes); err == nil {
		*o = ApplicationConfigConstantAttributes(varApplicationConfigConstantAttributes)
	}
...
type NullableApplicationConfigConstantAttributes struct {
	value *ApplicationConfigConstantAttributes
	isSet bool
}
...
func NewNullableApplicationConfigConstantAttributes(val *ApplicationConfigConstantAttributes) *NullableApplicationConfigConstantAttributes {
	return &NullableApplicationConfigConstantAttributes{value: val, isSet: true}
}
