...
// checks if the TrustedappConfigGetTrustedAppsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TrustedappConfigGetTrustedAppsInner{}
...
type _TrustedappConfigGetTrustedAppsInner TrustedappConfigGetTrustedAppsInner
...
func NewTrustedappConfigGetTrustedAppsInner(name string) *TrustedappConfigGetTrustedAppsInner {
	this := TrustedappConfigGetTrustedAppsInner{}
	this.Name = name
	return &this
}
...
func (o *TrustedappConfigGetTrustedAppsInner) UnmarshalJSON(bytes []byte) (err error) {
	varTrustedappConfigGetTrustedAppsInner := _TrustedappConfigGetTrustedAppsInner{}

	if err = json.Unmarshal(bytes, &varTrustedappConfigGetTrustedAppsInner); err == nil {
		*o = TrustedappConfigGetTrustedAppsInner(varTrustedappConfigGetTrustedAppsInner)
	}
...
type NullableTrustedappConfigGetTrustedAppsInner struct {
	value *TrustedappConfigGetTrustedAppsInner
	isSet bool
}
...
func NewNullableTrustedappConfigGetTrustedAppsInner(val *TrustedappConfigGetTrustedAppsInner) *NullableTrustedappConfigGetTrustedAppsInner {
	return &NullableTrustedappConfigGetTrustedAppsInner{value: val, isSet: true}
}
