...
// checks if the SystemusersStateActivateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemusersStateActivateRequest{}
...
type _SystemusersStateActivateRequest SystemusersStateActivateRequest
...
func NewSystemusersStateActivateRequest() *SystemusersStateActivateRequest {
	this := SystemusersStateActivateRequest{}
	return &this
}
...
func (o *SystemusersStateActivateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varSystemusersStateActivateRequest := _SystemusersStateActivateRequest{}

	if err = json.Unmarshal(bytes, &varSystemusersStateActivateRequest); err == nil {
		*o = SystemusersStateActivateRequest(varSystemusersStateActivateRequest)
	}
...
type NullableSystemusersStateActivateRequest struct {
	value *SystemusersStateActivateRequest
	isSet bool
}
...
func NewNullableSystemusersStateActivateRequest(val *SystemusersStateActivateRequest) *NullableSystemusersStateActivateRequest {
	return &NullableSystemusersStateActivateRequest{value: val, isSet: true}
}
