...
// checks if the SystemBuiltInCommandsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemBuiltInCommandsInner{}
...
type _SystemBuiltInCommandsInner SystemBuiltInCommandsInner
...
func NewSystemBuiltInCommandsInner() *SystemBuiltInCommandsInner {
	this := SystemBuiltInCommandsInner{}
	return &this
}
...
func (o *SystemBuiltInCommandsInner) UnmarshalJSON(bytes []byte) (err error) {
	varSystemBuiltInCommandsInner := _SystemBuiltInCommandsInner{}

	if err = json.Unmarshal(bytes, &varSystemBuiltInCommandsInner); err == nil {
		*o = SystemBuiltInCommandsInner(varSystemBuiltInCommandsInner)
	}
...
type NullableSystemBuiltInCommandsInner struct {
	value *SystemBuiltInCommandsInner
	isSet bool
}
...
func NewNullableSystemBuiltInCommandsInner(val *SystemBuiltInCommandsInner) *NullableSystemBuiltInCommandsInner {
	return &NullableSystemBuiltInCommandsInner{value: val, isSet: true}
}
