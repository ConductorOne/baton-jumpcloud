...
// checks if the OrganizationPutRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationPutRequest{}
...
type _OrganizationPutRequest OrganizationPutRequest
...
func (o *OrganizationPutRequest) GetSettings() Organizationsettingsput {
	if o == nil || IsNil(o.Settings) {
		var ret Organizationsettingsput
		return ret
	}
	return *o.Settings
}
...
func (o *OrganizationPutRequest) UnmarshalJSON(bytes []byte) (err error) {
	varOrganizationPutRequest := _OrganizationPutRequest{}

	if err = json.Unmarshal(bytes, &varOrganizationPutRequest); err == nil {
		*o = OrganizationPutRequest(varOrganizationPutRequest)
	}
...
func NewNullableOrganizationPutRequest(val *OrganizationPutRequest) *NullableOrganizationPutRequest {
	return &NullableOrganizationPutRequest{value: val, isSet: true}
}
