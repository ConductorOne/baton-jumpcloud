...
// checks if the ApplicationConfigConstantAttributesValueInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationConfigConstantAttributesValueInner{}
...
type _ApplicationConfigConstantAttributesValueInner ApplicationConfigConstantAttributesValueInner
...
func NewApplicationConfigConstantAttributesValueInner() *ApplicationConfigConstantAttributesValueInner {
	this := ApplicationConfigConstantAttributesValueInner{}
	return &this
}
...
func (o *ApplicationConfigConstantAttributesValueInner) UnmarshalJSON(bytes []byte) (err error) {
	varApplicationConfigConstantAttributesValueInner := _ApplicationConfigConstantAttributesValueInner{}

	if err = json.Unmarshal(bytes, &varApplicationConfigConstantAttributesValueInner); err == nil {
		*o = ApplicationConfigConstantAttributesValueInner(varApplicationConfigConstantAttributesValueInner)
	}
...
type NullableApplicationConfigConstantAttributesValueInner struct {
	value *ApplicationConfigConstantAttributesValueInner
	isSet bool
}
...
func NewNullableApplicationConfigConstantAttributesValueInner(val *ApplicationConfigConstantAttributesValueInner) *NullableApplicationConfigConstantAttributesValueInner {
	return &NullableApplicationConfigConstantAttributesValueInner{value: val, isSet: true}
}
