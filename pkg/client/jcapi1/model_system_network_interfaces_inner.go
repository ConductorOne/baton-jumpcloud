...
// checks if the SystemNetworkInterfacesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemNetworkInterfacesInner{}
...
type _SystemNetworkInterfacesInner SystemNetworkInterfacesInner
...
func NewSystemNetworkInterfacesInner() *SystemNetworkInterfacesInner {
	this := SystemNetworkInterfacesInner{}
	return &this
}
...
func (o *SystemNetworkInterfacesInner) UnmarshalJSON(bytes []byte) (err error) {
	varSystemNetworkInterfacesInner := _SystemNetworkInterfacesInner{}

	if err = json.Unmarshal(bytes, &varSystemNetworkInterfacesInner); err == nil {
		*o = SystemNetworkInterfacesInner(varSystemNetworkInterfacesInner)
	}
...
type NullableSystemNetworkInterfacesInner struct {
	value *SystemNetworkInterfacesInner
	isSet bool
}
...
func NewNullableSystemNetworkInterfacesInner(val *SystemNetworkInterfacesInner) *NullableSystemNetworkInterfacesInner {
	return &NullableSystemNetworkInterfacesInner{value: val, isSet: true}
}
