...
// checks if the Applicationslist type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Applicationslist{}
...
type _Applicationslist Applicationslist
...
func (o *Applicationslist) UnmarshalJSON(bytes []byte) (err error) {
	varApplicationslist := _Applicationslist{}

	if err = json.Unmarshal(bytes, &varApplicationslist); err == nil {
		*o = Applicationslist(varApplicationslist)
	}
...
func NewNullableApplicationslist(val *Applicationslist) *NullableApplicationslist {
	return &NullableApplicationslist{value: val, isSet: true}
}
