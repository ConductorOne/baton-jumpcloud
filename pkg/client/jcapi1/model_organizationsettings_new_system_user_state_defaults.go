...
// checks if the OrganizationsettingsNewSystemUserStateDefaults type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationsettingsNewSystemUserStateDefaults{}
...
type _OrganizationsettingsNewSystemUserStateDefaults OrganizationsettingsNewSystemUserStateDefaults
...
func NewOrganizationsettingsNewSystemUserStateDefaults() *OrganizationsettingsNewSystemUserStateDefaults {
	this := OrganizationsettingsNewSystemUserStateDefaults{}
	return &this
}
...
func (o *OrganizationsettingsNewSystemUserStateDefaults) UnmarshalJSON(bytes []byte) (err error) {
	varOrganizationsettingsNewSystemUserStateDefaults := _OrganizationsettingsNewSystemUserStateDefaults{}

	if err = json.Unmarshal(bytes, &varOrganizationsettingsNewSystemUserStateDefaults); err == nil {
		*o = OrganizationsettingsNewSystemUserStateDefaults(varOrganizationsettingsNewSystemUserStateDefaults)
	}
...
type NullableOrganizationsettingsNewSystemUserStateDefaults struct {
	value *OrganizationsettingsNewSystemUserStateDefaults
	isSet bool
}
...
func NewNullableOrganizationsettingsNewSystemUserStateDefaults(val *OrganizationsettingsNewSystemUserStateDefaults) *NullableOrganizationsettingsNewSystemUserStateDefaults {
	return &NullableOrganizationsettingsNewSystemUserStateDefaults{value: val, isSet: true}
}
