...
// checks if the OrganizationsettingsFeaturesDirectoryInsights type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationsettingsFeaturesDirectoryInsights{}
...
type _OrganizationsettingsFeaturesDirectoryInsights OrganizationsettingsFeaturesDirectoryInsights
...
func NewOrganizationsettingsFeaturesDirectoryInsights() *OrganizationsettingsFeaturesDirectoryInsights {
	this := OrganizationsettingsFeaturesDirectoryInsights{}
	return &this
}
...
func (o *OrganizationsettingsFeaturesDirectoryInsights) UnmarshalJSON(bytes []byte) (err error) {
	varOrganizationsettingsFeaturesDirectoryInsights := _OrganizationsettingsFeaturesDirectoryInsights{}

	if err = json.Unmarshal(bytes, &varOrganizationsettingsFeaturesDirectoryInsights); err == nil {
		*o = OrganizationsettingsFeaturesDirectoryInsights(varOrganizationsettingsFeaturesDirectoryInsights)
	}
...
type NullableOrganizationsettingsFeaturesDirectoryInsights struct {
	value *OrganizationsettingsFeaturesDirectoryInsights
	isSet bool
}
...
func NewNullableOrganizationsettingsFeaturesDirectoryInsights(val *OrganizationsettingsFeaturesDirectoryInsights) *NullableOrganizationsettingsFeaturesDirectoryInsights {
	return &NullableOrganizationsettingsFeaturesDirectoryInsights{value: val, isSet: true}
}
