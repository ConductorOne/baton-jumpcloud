...
// checks if the ApplicationtemplateLogo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationtemplateLogo{}
...
type _ApplicationtemplateLogo ApplicationtemplateLogo
...
func (o *ApplicationtemplateLogo) UnmarshalJSON(bytes []byte) (err error) {
	varApplicationtemplateLogo := _ApplicationtemplateLogo{}

	if err = json.Unmarshal(bytes, &varApplicationtemplateLogo); err == nil {
		*o = ApplicationtemplateLogo(varApplicationtemplateLogo)
	}
...
func NewNullableApplicationtemplateLogo(val *ApplicationtemplateLogo) *NullableApplicationtemplateLogo {
	return &NullableApplicationtemplateLogo{value: val, isSet: true}
}
