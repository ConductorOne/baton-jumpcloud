...
// checks if the ApplicationConfigDatabaseAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationConfigDatabaseAttributes{}
...
type _ApplicationConfigDatabaseAttributes ApplicationConfigDatabaseAttributes
...
func NewApplicationConfigDatabaseAttributes() *ApplicationConfigDatabaseAttributes {
	this := ApplicationConfigDatabaseAttributes{}
	return &this
}
...
func (o *ApplicationConfigDatabaseAttributes) UnmarshalJSON(bytes []byte) (err error) {
	varApplicationConfigDatabaseAttributes := _ApplicationConfigDatabaseAttributes{}

	if err = json.Unmarshal(bytes, &varApplicationConfigDatabaseAttributes); err == nil {
		*o = ApplicationConfigDatabaseAttributes(varApplicationConfigDatabaseAttributes)
	}
...
type NullableApplicationConfigDatabaseAttributes struct {
	value *ApplicationConfigDatabaseAttributes
	isSet bool
}
...
func NewNullableApplicationConfigDatabaseAttributes(val *ApplicationConfigDatabaseAttributes) *NullableApplicationConfigDatabaseAttributes {
	return &NullableApplicationConfigDatabaseAttributes{value: val, isSet: true}
}
