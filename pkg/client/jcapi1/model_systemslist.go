...
// checks if the Systemslist type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Systemslist{}
...
func (o *Systemslist) UnmarshalJSON(bytes []byte) (err error) {
	varSystemslist := _Systemslist{}

	if err = json.Unmarshal(bytes, &varSystemslist); err == nil {
		*o = Systemslist(varSystemslist)
	}
...
func NewNullableSystemslist(val *Systemslist) *NullableSystemslist {
	return &NullableSystemslist{value: val, isSet: true}
}
