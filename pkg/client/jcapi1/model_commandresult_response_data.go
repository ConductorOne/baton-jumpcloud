...
// checks if the CommandresultResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommandresultResponseData{}
...
type _CommandresultResponseData CommandresultResponseData
...
func NewCommandresultResponseData() *CommandresultResponseData {
	this := CommandresultResponseData{}
	return &this
}
...
func (o *CommandresultResponseData) UnmarshalJSON(bytes []byte) (err error) {
	varCommandresultResponseData := _CommandresultResponseData{}

	if err = json.Unmarshal(bytes, &varCommandresultResponseData); err == nil {
		*o = CommandresultResponseData(varCommandresultResponseData)
	}
...
type NullableCommandresultResponseData struct {
	value *CommandresultResponseData
	isSet bool
}
...
func NewNullableCommandresultResponseData(val *CommandresultResponseData) *NullableCommandresultResponseData {
	return &NullableCommandresultResponseData{value: val, isSet: true}
}
