...
// checks if the SystemDomainInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemDomainInfo{}
...
type _SystemDomainInfo SystemDomainInfo
...
func (o *SystemDomainInfo) GetPartOfDomain() bool {
	if o == nil || IsNil(o.PartOfDomain) {
		var ret bool
		return ret
	}
	return *o.PartOfDomain
}

// GetPartOfDomainOk returns a tuple with the PartOfDomain field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SystemDomainInfo) GetPartOfDomainOk() (*bool, bool) {
	if o == nil || IsNil(o.PartOfDomain) {
		return nil, false
	}
	return o.PartOfDomain, true
}
...
func (o SystemDomainInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PartOfDomain) {
		toSerialize["partOfDomain"] = o.PartOfDomain
	}
...
func (o *SystemDomainInfo) UnmarshalJSON(bytes []byte) (err error) {
	varSystemDomainInfo := _SystemDomainInfo{}

	if err = json.Unmarshal(bytes, &varSystemDomainInfo); err == nil {
		*o = SystemDomainInfo(varSystemDomainInfo)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "partOfDomain")
...
func NewNullableSystemDomainInfo(val *SystemDomainInfo) *NullableSystemDomainInfo {
	return &NullableSystemDomainInfo{value: val, isSet: true}
}
