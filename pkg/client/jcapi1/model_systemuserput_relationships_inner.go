...
// checks if the SystemuserputRelationshipsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemuserputRelationshipsInner{}
...
type _SystemuserputRelationshipsInner SystemuserputRelationshipsInner
...
func NewSystemuserputRelationshipsInner() *SystemuserputRelationshipsInner {
	this := SystemuserputRelationshipsInner{}
	return &this
}
...
func (o *SystemuserputRelationshipsInner) UnmarshalJSON(bytes []byte) (err error) {
	varSystemuserputRelationshipsInner := _SystemuserputRelationshipsInner{}

	if err = json.Unmarshal(bytes, &varSystemuserputRelationshipsInner); err == nil {
		*o = SystemuserputRelationshipsInner(varSystemuserputRelationshipsInner)
	}
...
type NullableSystemuserputRelationshipsInner struct {
	value *SystemuserputRelationshipsInner
	isSet bool
}
...
func NewNullableSystemuserputRelationshipsInner(val *SystemuserputRelationshipsInner) *NullableSystemuserputRelationshipsInner {
	return &NullableSystemuserputRelationshipsInner{value: val, isSet: true}
}
