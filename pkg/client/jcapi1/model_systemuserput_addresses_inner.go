...
// checks if the SystemuserputAddressesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemuserputAddressesInner{}
...
type _SystemuserputAddressesInner SystemuserputAddressesInner
...
func NewSystemuserputAddressesInner() *SystemuserputAddressesInner {
	this := SystemuserputAddressesInner{}
	return &this
}
...
func (o *SystemuserputAddressesInner) UnmarshalJSON(bytes []byte) (err error) {
	varSystemuserputAddressesInner := _SystemuserputAddressesInner{}

	if err = json.Unmarshal(bytes, &varSystemuserputAddressesInner); err == nil {
		*o = SystemuserputAddressesInner(varSystemuserputAddressesInner)
	}
...
type NullableSystemuserputAddressesInner struct {
	value *SystemuserputAddressesInner
	isSet bool
}
...
func NewNullableSystemuserputAddressesInner(val *SystemuserputAddressesInner) *NullableSystemuserputAddressesInner {
	return &NullableSystemuserputAddressesInner{value: val, isSet: true}
}
