...
// checks if the SystemSshdParamsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemSshdParamsInner{}
...
type _SystemSshdParamsInner SystemSshdParamsInner
...
func (o *SystemSshdParamsInner) UnmarshalJSON(bytes []byte) (err error) {
	varSystemSshdParamsInner := _SystemSshdParamsInner{}

	if err = json.Unmarshal(bytes, &varSystemSshdParamsInner); err == nil {
		*o = SystemSshdParamsInner(varSystemSshdParamsInner)
	}
...
func NewNullableSystemSshdParamsInner(val *SystemSshdParamsInner) *NullableSystemSshdParamsInner {
	return &NullableSystemSshdParamsInner{value: val, isSet: true}
}
