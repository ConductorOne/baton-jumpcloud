...
// checks if the SystemuserreturnPhoneNumbersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemuserreturnPhoneNumbersInner{}
...
type _SystemuserreturnPhoneNumbersInner SystemuserreturnPhoneNumbersInner
...
func NewSystemuserreturnPhoneNumbersInner() *SystemuserreturnPhoneNumbersInner {
	this := SystemuserreturnPhoneNumbersInner{}
	return &this
}
...
func (o *SystemuserreturnPhoneNumbersInner) UnmarshalJSON(bytes []byte) (err error) {
	varSystemuserreturnPhoneNumbersInner := _SystemuserreturnPhoneNumbersInner{}

	if err = json.Unmarshal(bytes, &varSystemuserreturnPhoneNumbersInner); err == nil {
		*o = SystemuserreturnPhoneNumbersInner(varSystemuserreturnPhoneNumbersInner)
	}
...
type NullableSystemuserreturnPhoneNumbersInner struct {
	value *SystemuserreturnPhoneNumbersInner
	isSet bool
}
...
func NewNullableSystemuserreturnPhoneNumbersInner(val *SystemuserreturnPhoneNumbersInner) *NullableSystemuserreturnPhoneNumbersInner {
	return &NullableSystemuserreturnPhoneNumbersInner{value: val, isSet: true}
}
