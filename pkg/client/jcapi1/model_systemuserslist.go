...
// checks if the Systemuserslist type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Systemuserslist{}
...
type _Systemuserslist Systemuserslist
...
func (o *Systemuserslist) UnmarshalJSON(bytes []byte) (err error) {
	varSystemuserslist := _Systemuserslist{}

	if err = json.Unmarshal(bytes, &varSystemuserslist); err == nil {
		*o = Systemuserslist(varSystemuserslist)
	}
...
func NewNullableSystemuserslist(val *Systemuserslist) *NullableSystemuserslist {
	return &NullableSystemuserslist{value: val, isSet: true}
}
