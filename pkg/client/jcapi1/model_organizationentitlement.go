...
// checks if the Organizationentitlement type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Organizationentitlement{}
...
type _Organizationentitlement Organizationentitlement
...
func (o *Organizationentitlement) GetEntitlementProducts() []OrganizationentitlementEntitlementProductsInner {
	if o == nil || IsNil(o.EntitlementProducts) {
		var ret []OrganizationentitlementEntitlementProductsInner
		return ret
	}
	return o.EntitlementProducts
}

// GetEntitlementProductsOk returns a tuple with the EntitlementProducts field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Organizationentitlement) GetEntitlementProductsOk() ([]OrganizationentitlementEntitlementProductsInner, bool) {
	if o == nil || IsNil(o.EntitlementProducts) {
		return nil, false
	}
	return o.EntitlementProducts, true
}
...
func (o *Organizationentitlement) GetIsManuallyBilled() bool {
	if o == nil || IsNil(o.IsManuallyBilled) {
		var ret bool
		return ret
	}
	return *o.IsManuallyBilled
}

// GetIsManuallyBilledOk returns a tuple with the IsManuallyBilled field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Organizationentitlement) GetIsManuallyBilledOk() (*bool, bool) {
	if o == nil || IsNil(o.IsManuallyBilled) {
		return nil, false
	}
	return o.IsManuallyBilled, true
}
...
func (o *Organizationentitlement) GetPricePerUserSum() int32 {
	if o == nil || IsNil(o.PricePerUserSum) {
		var ret int32
		return ret
	}
	return *o.PricePerUserSum
}

// GetPricePerUserSumOk returns a tuple with the PricePerUserSum field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Organizationentitlement) GetPricePerUserSumOk() (*int32, bool) {
	if o == nil || IsNil(o.PricePerUserSum) {
		return nil, false
	}
	return o.PricePerUserSum, true
}
...
func (o Organizationentitlement) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.EntitlementProducts) {
		toSerialize["entitlementProducts"] = o.EntitlementProducts
	}
	if !IsNil(o.IsManuallyBilled) {
		toSerialize["isManuallyBilled"] = o.IsManuallyBilled
	}
	if !IsNil(o.PricePerUserSum) {
		toSerialize["pricePerUserSum"] = o.PricePerUserSum
	}
...
func (o *Organizationentitlement) UnmarshalJSON(bytes []byte) (err error) {
	varOrganizationentitlement := _Organizationentitlement{}

	if err = json.Unmarshal(bytes, &varOrganizationentitlement); err == nil {
		*o = Organizationentitlement(varOrganizationentitlement)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "entitlementProducts")
		delete(additionalProperties, "isManuallyBilled")
		delete(additionalProperties, "pricePerUserSum")
...
func NewNullableOrganizationentitlement(val *Organizationentitlement) *NullableOrganizationentitlement {
	return &NullableOrganizationentitlement{value: val, isSet: true}
}
