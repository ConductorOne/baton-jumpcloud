...
// checks if the SystemMdmInternal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemMdmInternal{}
...
type _SystemMdmInternal SystemMdmInternal
...
func (o *SystemMdmInternal) GetWindowsDeviceId() string {
	if o == nil || IsNil(o.WindowsDeviceId) {
		var ret string
		return ret
	}
	return *o.WindowsDeviceId
}

// GetWindowsDeviceIdOk returns a tuple with the WindowsDeviceId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SystemMdmInternal) GetWindowsDeviceIdOk() (*string, bool) {
	if o == nil || IsNil(o.WindowsDeviceId) {
		return nil, false
	}
	return o.WindowsDeviceId, true
}
...
func (o SystemMdmInternal) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.WindowsDeviceId) {
		toSerialize["windowsDeviceId"] = o.WindowsDeviceId
	}
...
func (o *SystemMdmInternal) UnmarshalJSON(bytes []byte) (err error) {
	varSystemMdmInternal := _SystemMdmInternal{}

	if err = json.Unmarshal(bytes, &varSystemMdmInternal); err == nil {
		*o = SystemMdmInternal(varSystemMdmInternal)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "windowsDeviceId")
...
func NewNullableSystemMdmInternal(val *SystemMdmInternal) *NullableSystemMdmInternal {
	return &NullableSystemMdmInternal{value: val, isSet: true}
}
