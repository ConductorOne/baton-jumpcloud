...
// checks if the TrustedappConfigGet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TrustedappConfigGet{}
...
type _TrustedappConfigGet TrustedappConfigGet
...
func (o *TrustedappConfigGet) UnmarshalJSON(bytes []byte) (err error) {
	varTrustedappConfigGet := _TrustedappConfigGet{}

	if err = json.Unmarshal(bytes, &varTrustedappConfigGet); err == nil {
		*o = TrustedappConfigGet(varTrustedappConfigGet)
	}
...
func NewNullableTrustedappConfigGet(val *TrustedappConfigGet) *NullableTrustedappConfigGet {
	return &NullableTrustedappConfigGet{value: val, isSet: true}
}
