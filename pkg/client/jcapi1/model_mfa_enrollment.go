...
// checks if the MfaEnrollment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MfaEnrollment{}
...
type _MfaEnrollment MfaEnrollment
...
// GetTotpStatusOk returns a tuple with the TotpStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MfaEnrollment) GetTotpStatusOk() (*MfaEnrollmentStatus, bool) {
	if o == nil || IsNil(o.TotpStatus) {
		return nil, false
	}
	return o.TotpStatus, true
}
...
func (o *MfaEnrollment) GetWebAuthnStatus() MfaEnrollmentStatus {
	if o == nil || IsNil(o.WebAuthnStatus) {
		var ret MfaEnrollmentStatus
		return ret
	}
	return *o.WebAuthnStatus
}

// GetWebAuthnStatusOk returns a tuple with the WebAuthnStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MfaEnrollment) GetWebAuthnStatusOk() (*MfaEnrollmentStatus, bool) {
	if o == nil || IsNil(o.WebAuthnStatus) {
		return nil, false
	}
	return o.WebAuthnStatus, true
}
...
func (o MfaEnrollment) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TotpStatus) {
		toSerialize["totpStatus"] = o.TotpStatus
	}
	if !IsNil(o.WebAuthnStatus) {
		toSerialize["webAuthnStatus"] = o.WebAuthnStatus
	}
...
func (o *MfaEnrollment) UnmarshalJSON(bytes []byte) (err error) {
	varMfaEnrollment := _MfaEnrollment{}

	if err = json.Unmarshal(bytes, &varMfaEnrollment); err == nil {
		*o = MfaEnrollment(varMfaEnrollment)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "totpStatus")
		delete(additionalProperties, "webAuthnStatus")
...
func NewNullableMfaEnrollment(val *MfaEnrollment) *NullableMfaEnrollment {
	return &NullableMfaEnrollment{value: val, isSet: true}
}
