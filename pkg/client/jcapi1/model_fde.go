...
// checks if the Fde type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Fde{}
...
// GetKeyPresentOk returns a tuple with the KeyPresent field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Fde) GetKeyPresentOk() (*bool, bool) {
	if o == nil || IsNil(o.KeyPresent) {
		return nil, false
	}
	return o.KeyPresent, true
}
...
func (o Fde) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.KeyPresent) {
		toSerialize["keyPresent"] = o.KeyPresent
	}
...
func (o *Fde) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &varFde); err == nil {
		*o = Fde(varFde)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "keyPresent")
...
func NewNullableFde(val *Fde) *NullableFde {
	return &NullableFde{value: val, isSet: true}
}
