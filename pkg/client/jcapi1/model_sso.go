...
func (o *Sso) GetIdpCertExpirationAt() time.Time {
	if o == nil || IsNil(o.IdpCertExpirationAt) {
		var ret time.Time
		return ret
	}
	return *o.IdpCertExpirationAt
}

// GetIdpCertExpirationAtOk returns a tuple with the IdpCertExpirationAt field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Sso) GetIdpCertExpirationAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.IdpCertExpirationAt) {
		return nil, false
	}
	return o.IdpCertExpirationAt, true
}
...
func (o Sso) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IdpCertExpirationAt) {
		toSerialize["idpCertExpirationAt"] = o.IdpCertExpirationAt
	}
	if !IsNil(o.Jit) {
...
func (o *Sso) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &varSso); err == nil {
		*o = Sso(varSso)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "idpCertExpirationAt")
