...
import (
    ...
    "fmt"
    "os"
    openapiclient "github.com/conductorone/baton-jumpcloud/pkg/client/jcapi2"or/client/jcapi2"
)
...
import (
    ...
    "fmt"
    "os"
    openapiclient "github.com/conductorone/baton-jumpcloud/pkg/client/jcapi2"or/client/jcapi2"or/client/jcapi2"
)
...
[**[]SystemInsightsAzureInstanceTags**](SystemInsightsAzureInstanceTags.md)
...
[**[]SystemInsightsBitlockerInfo**](SystemInsightsBitlockerInfo.md)
...
[**[]SystemInsightsCertificates**](SystemInsightsCertificates.md)
...
[**[]SystemInsightsDiskEncryption**](SystemInsightsDiskEncryption.md)
...
[**[]SystemInsightsDnsResolvers**](SystemInsightsDnsResolvers.md)
...
[**[]SystemInsightsFirefoxAddons**](SystemInsightsFirefoxAddons.md)
...
[**[]SystemInsightsInterfaceDetails**](SystemInsightsInterfaceDetails.md)
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListKernelInfo(context.Background()).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListKernelInfo``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListKernelInfo`: []SystemInsightsKernelInfo
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListKernelInfo`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListKernelInfoRequest struct via the builder pattern
...
[**[]SystemInsightsKernelInfo**](SystemInsightsKernelInfo.md)
...
> []SystemInsightsLaunchd SysteminsightsListLaunchd(ctx).XOrgId(xOrgId).Skip(skip).Sort(sort).Filter(filter).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListLaunchd(context.Background()).XOrgId(xOrgId).Skip(skip).Sort(sort).Filter(filter).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListLaunchd``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListLaunchd`: []SystemInsightsLaunchd
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListLaunchd`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListLaunchdRequest struct via the builder pattern
...
[**[]SystemInsightsLaunchd**](SystemInsightsLaunchd.md)
...
> []SystemInsightsLinuxPackages SysteminsightsListLinuxPackages(ctx).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListLinuxPackages(context.Background()).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListLinuxPackages``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListLinuxPackages`: []SystemInsightsLinuxPackages
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListLinuxPackages`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListLinuxPackagesRequest struct via the builder pattern
...
[**[]SystemInsightsLinuxPackages**](SystemInsightsLinuxPackages.md)
...
> []SystemInsightsLoggedInUsers SysteminsightsListLoggedInUsers(ctx).XOrgId(xOrgId).Skip(skip).Sort(sort).Filter(filter).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListLoggedInUsers(context.Background()).XOrgId(xOrgId).Skip(skip).Sort(sort).Filter(filter).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListLoggedInUsers``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListLoggedInUsers`: []SystemInsightsLoggedInUsers
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListLoggedInUsers`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListLoggedInUsersRequest struct via the builder pattern
...
[**[]SystemInsightsLoggedInUsers**](SystemInsightsLoggedInUsers.md)
...
> []SystemInsightsLogicalDrives SysteminsightsListLogicalDrives(ctx).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListLogicalDrives(context.Background()).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListLogicalDrives``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListLogicalDrives`: []SystemInsightsLogicalDrives
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListLogicalDrives`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListLogicalDrivesRequest struct via the builder pattern
...
[**[]SystemInsightsLogicalDrives**](SystemInsightsLogicalDrives.md)
...
> []SystemInsightsManagedPolicies SysteminsightsListManagedPolicies(ctx).XOrgId(xOrgId).Skip(skip).Sort(sort).Filter(filter).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListManagedPolicies(context.Background()).XOrgId(xOrgId).Skip(skip).Sort(sort).Filter(filter).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListManagedPolicies``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListManagedPolicies`: []SystemInsightsManagedPolicies
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListManagedPolicies`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListManagedPoliciesRequest struct via the builder pattern
...
[**[]SystemInsightsManagedPolicies**](SystemInsightsManagedPolicies.md)
...
> []SystemInsightsMounts SysteminsightsListMounts(ctx).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListMounts(context.Background()).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListMounts``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListMounts`: []SystemInsightsMounts
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListMounts`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListMountsRequest struct via the builder pattern
...
[**[]SystemInsightsMounts**](SystemInsightsMounts.md)
...
> []SystemInsightsOsVersion SysteminsightsListOsVersion(ctx).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListOsVersion(context.Background()).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListOsVersion``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListOsVersion`: []SystemInsightsOsVersion
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListOsVersion`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListOsVersionRequest struct via the builder pattern
...
[**[]SystemInsightsOsVersion**](SystemInsightsOsVersion.md)
...
> []SystemInsightsPatches SysteminsightsListPatches(ctx).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListPatches(context.Background()).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListPatches``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListPatches`: []SystemInsightsPatches
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListPatches`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListPatchesRequest struct via the builder pattern
...
[**[]SystemInsightsPatches**](SystemInsightsPatches.md)
...
> []SystemInsightsPrograms SysteminsightsListPrograms(ctx).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListPrograms(context.Background()).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListPrograms``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListPrograms`: []SystemInsightsPrograms
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListPrograms`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListProgramsRequest struct via the builder pattern
...
[**[]SystemInsightsPrograms**](SystemInsightsPrograms.md)
...
> []SystemInsightsPythonPackages SysteminsightsListPythonPackages(ctx).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListPythonPackages(context.Background()).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListPythonPackages``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListPythonPackages`: []SystemInsightsPythonPackages
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListPythonPackages`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListPythonPackagesRequest struct via the builder pattern
...
[**[]SystemInsightsPythonPackages**](SystemInsightsPythonPackages.md)
...
> []SystemInsightsSafariExtensions SysteminsightsListSafariExtensions(ctx).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListSafariExtensions(context.Background()).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListSafariExtensions``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListSafariExtensions`: []SystemInsightsSafariExtensions
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListSafariExtensions`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListSafariExtensionsRequest struct via the builder pattern
...
[**[]SystemInsightsSafariExtensions**](SystemInsightsSafariExtensions.md)
...
> []SystemInsightsScheduledTasks SysteminsightsListScheduledTasks(ctx).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListScheduledTasks(context.Background()).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListScheduledTasks``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListScheduledTasks`: []SystemInsightsScheduledTasks
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListScheduledTasks`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListScheduledTasksRequest struct via the builder pattern
...
[**[]SystemInsightsScheduledTasks**](SystemInsightsScheduledTasks.md)
...
> []SystemInsightsSecureboot SysteminsightsListSecureboot(ctx).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListSecureboot(context.Background()).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListSecureboot``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListSecureboot`: []SystemInsightsSecureboot
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListSecureboot`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListSecurebootRequest struct via the builder pattern
...
[**[]SystemInsightsSecureboot**](SystemInsightsSecureboot.md)
...
> []SystemInsightsServices SysteminsightsListServices(ctx).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListServices(context.Background()).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListServices``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListServices`: []SystemInsightsServices
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListServices`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListServicesRequest struct via the builder pattern
...
[**[]SystemInsightsServices**](SystemInsightsServices.md)
...
> []SystemInsightsShadow SysteminsightsListShadow(ctx).XOrgId(xOrgId).Skip(skip).Sort(sort).Filter(filter).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListShadow(context.Background()).XOrgId(xOrgId).Skip(skip).Sort(sort).Filter(filter).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListShadow``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListShadow`: []SystemInsightsShadow
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListShadow`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListShadowRequest struct via the builder pattern
...
[**[]SystemInsightsShadow**](SystemInsightsShadow.md)
...
> []SystemInsightsSharedFolders SysteminsightsListSharedFolders(ctx).XOrgId(xOrgId).Skip(skip).Sort(sort).Filter(filter).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListSharedFolders(context.Background()).XOrgId(xOrgId).Skip(skip).Sort(sort).Filter(filter).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListSharedFolders``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListSharedFolders`: []SystemInsightsSharedFolders
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListSharedFolders`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListSharedFoldersRequest struct via the builder pattern
...
[**[]SystemInsightsSharedFolders**](SystemInsightsSharedFolders.md)
...
> []SystemInsightsSharedResources SysteminsightsListSharedResources(ctx).XOrgId(xOrgId).Skip(skip).Sort(sort).Filter(filter).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListSharedResources(context.Background()).XOrgId(xOrgId).Skip(skip).Sort(sort).Filter(filter).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListSharedResources``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListSharedResources`: []SystemInsightsSharedResources
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListSharedResources`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListSharedResourcesRequest struct via the builder pattern
...
[**[]SystemInsightsSharedResources**](SystemInsightsSharedResources.md)
...
> []SystemInsightsSharingPreferences SysteminsightsListSharingPreferences(ctx).XOrgId(xOrgId).Skip(skip).Sort(sort).Filter(filter).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListSharingPreferences(context.Background()).XOrgId(xOrgId).Skip(skip).Sort(sort).Filter(filter).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListSharingPreferences``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListSharingPreferences`: []SystemInsightsSharingPreferences
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListSharingPreferences`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListSharingPreferencesRequest struct via the builder pattern
...
[**[]SystemInsightsSharingPreferences**](SystemInsightsSharingPreferences.md)
...
> []SystemInsightsSipConfig SysteminsightsListSipConfig(ctx).XOrgId(xOrgId).Skip(skip).Sort(sort).Filter(filter).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListSipConfig(context.Background()).XOrgId(xOrgId).Skip(skip).Sort(sort).Filter(filter).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListSipConfig``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListSipConfig`: []SystemInsightsSipConfig
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListSipConfig`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListSipConfigRequest struct via the builder pattern
...
[**[]SystemInsightsSipConfig**](SystemInsightsSipConfig.md)
...
> []SystemInsightsStartupItems SysteminsightsListStartupItems(ctx).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListStartupItems(context.Background()).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListStartupItems``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListStartupItems`: []SystemInsightsStartupItems
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListStartupItems`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListStartupItemsRequest struct via the builder pattern
...
[**[]SystemInsightsStartupItems**](SystemInsightsStartupItems.md)
...
> []SystemInsightsSystemControls SysteminsightsListSystemControls(ctx).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
...
func main() {
    skip := int32(56) // int32 | The offset into the records to return. (optional) (default to 0)
    sort := []string{"Inner_example"} // []string | The comma separated fields used to sort the collection. Default sort is ascending, prefix with `-` to sort descending. e.g: Sort by single field: `sort=field` Sort descending by single field: `sort=-field` Sort by multiple fields: `sort=field1,-field2,field3`  (optional) (default to [])
    filter := []string{"Inner_example"} // []string | Supported operators are: eq, in. e.g: Filter for single value: `filter=field:eq:value` Filter value in a list: (note \"pipe\" character: `|` separating values) `filter=field:in:value1|value2|value3` Note: You can only filter by `system_id` and `name`  (optional) (default to [])
    xOrgId := "xOrgId_example" // string | Organization identifier that can be obtained from console settings. (optional)
    limit := int32(56) // int32 |  (optional) (default to 10)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListSystemControls(context.Background()).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListSystemControls``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListSystemControls`: []SystemInsightsSystemControls
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListSystemControls`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListSystemControlsRequest struct via the builder pattern
 ...
 **skip** | **int32** | The offset into the records to return. | [default to 0]
 **sort** | **[]string** | The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. e.g: Sort by single field: &#x60;sort&#x3D;field&#x60; Sort descending by single field: &#x60;sort&#x3D;-field&#x60; Sort by multiple fields: &#x60;sort&#x3D;field1,-field2,field3&#x60;  | [default to []]
 **filter** | **[]string** | Supported operators are: eq, in. e.g: Filter for single value: &#x60;filter&#x3D;field:eq:value&#x60; Filter value in a list: (note \&quot;pipe\&quot; character: &#x60;|&#x60; separating values) &#x60;filter&#x3D;field:in:value1|value2|value3&#x60; Note: You can only filter by &#x60;system_id&#x60; and &#x60;name&#x60;  | [default to []]
 **xOrgId** | **string** | Organization identifier that can be obtained from console settings. | 
 **limit** | **int32** |  | [default to 10]

### Return type

[**[]SystemInsightsSystemControls**](SystemInsightsSystemControls.md)
...
> []SystemInsightsSystemInfo SysteminsightsListSystemInfo(ctx).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListSystemInfo(context.Background()).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListSystemInfo``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListSystemInfo`: []SystemInsightsSystemInfo
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListSystemInfo`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListSystemInfoRequest struct via the builder pattern
...
[**[]SystemInsightsSystemInfo**](SystemInsightsSystemInfo.md)
...
> []SystemInsightsTpmInfo SysteminsightsListTpmInfo(ctx).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListTpmInfo(context.Background()).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListTpmInfo``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListTpmInfo`: []SystemInsightsTpmInfo
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListTpmInfo`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListTpmInfoRequest struct via the builder pattern
...
[**[]SystemInsightsTpmInfo**](SystemInsightsTpmInfo.md)
...
> []SystemInsightsUptime SysteminsightsListUptime(ctx).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
...
func main() {
    skip := int32(56) // int32 | The offset into the records to return. (optional) (default to 0)
    sort := []string{"Inner_example"} // []string | The comma separated fields used to sort the collection. Default sort is ascending, prefix with `-` to sort descending. e.g: Sort by single field: `sort=field` Sort descending by single field: `sort=-field` Sort by multiple fields: `sort=field1,-field2,field3`  (optional) (default to [])
    filter := []string{"Inner_example"} // []string | Supported operators are: eq, gte, in. e.g: Filter for single value: `filter=field:gte:value` Filter for any value in a list: (note \"pipe\" character: `|` separating values) `filter=field:in:value1|value2|value3`  (optional) (default to [])
    xOrgId := "xOrgId_example" // string | Organization identifier that can be obtained from console settings. (optional)
    limit := int32(56) // int32 |  (optional) (default to 10)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListUptime(context.Background()).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListUptime``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListUptime`: []SystemInsightsUptime
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListUptime`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListUptimeRequest struct via the builder pattern
 ...
 **skip** | **int32** | The offset into the records to return. | [default to 0]
 **sort** | **[]string** | The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. e.g: Sort by single field: &#x60;sort&#x3D;field&#x60; Sort descending by single field: &#x60;sort&#x3D;-field&#x60; Sort by multiple fields: &#x60;sort&#x3D;field1,-field2,field3&#x60;  | [default to []]
 **filter** | **[]string** | Supported operators are: eq, gte, in. e.g: Filter for single value: &#x60;filter&#x3D;field:gte:value&#x60; Filter for any value in a list: (note \&quot;pipe\&quot; character: &#x60;|&#x60; separating values) &#x60;filter&#x3D;field:in:value1|value2|value3&#x60;  | [default to []]
 **xOrgId** | **string** | Organization identifier that can be obtained from console settings. | 
 **limit** | **int32** |  | [default to 10]

### Return type

[**[]SystemInsightsUptime**](SystemInsightsUptime.md)
...
> []SystemInsightsUsbDevices SysteminsightsListUsbDevices(ctx).XOrgId(xOrgId).Skip(skip).Sort(sort).Filter(filter).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListUsbDevices(context.Background()).XOrgId(xOrgId).Skip(skip).Sort(sort).Filter(filter).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListUsbDevices``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListUsbDevices`: []SystemInsightsUsbDevices
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListUsbDevices`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListUsbDevicesRequest struct via the builder pattern
...
[**[]SystemInsightsUsbDevices**](SystemInsightsUsbDevices.md)
...
> []SystemInsightsUserGroups SysteminsightsListUserGroups(ctx).XOrgId(xOrgId).Skip(skip).Sort(sort).Filter(filter).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListUserGroups(context.Background()).XOrgId(xOrgId).Skip(skip).Sort(sort).Filter(filter).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListUserGroups``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListUserGroups`: []SystemInsightsUserGroups
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListUserGroups`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListUserGroupsRequest struct via the builder pattern
...
[**[]SystemInsightsUserGroups**](SystemInsightsUserGroups.md)
...
> []SystemInsightsUserSshKeys SysteminsightsListUserSshKeys(ctx).XOrgId(xOrgId).Skip(skip).Sort(sort).Filter(filter).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListUserSshKeys(context.Background()).XOrgId(xOrgId).Skip(skip).Sort(sort).Filter(filter).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListUserSshKeys``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListUserSshKeys`: []SystemInsightsUserSshKeys
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListUserSshKeys`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListUserSshKeysRequest struct via the builder pattern
...
[**[]SystemInsightsUserSshKeys**](SystemInsightsUserSshKeys.md)
...
> []SystemInsightsUserassist SysteminsightsListUserassist(ctx).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListUserassist(context.Background()).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListUserassist``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListUserassist`: []SystemInsightsUserassist
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListUserassist`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListUserassistRequest struct via the builder pattern
...
[**[]SystemInsightsUserassist**](SystemInsightsUserassist.md)
...
> []SystemInsightsUsers SysteminsightsListUsers(ctx).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListUsers(context.Background()).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListUsers``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListUsers`: []SystemInsightsUsers
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListUsers`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListUsersRequest struct via the builder pattern
...
[**[]SystemInsightsUsers**](SystemInsightsUsers.md)
...
> []SystemInsightsWifiNetworks SysteminsightsListWifiNetworks(ctx).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListWifiNetworks(context.Background()).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListWifiNetworks``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListWifiNetworks`: []SystemInsightsWifiNetworks
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListWifiNetworks`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListWifiNetworksRequest struct via the builder pattern
...
[**[]SystemInsightsWifiNetworks**](SystemInsightsWifiNetworks.md)
...
> []SystemInsightsWifiStatus SysteminsightsListWifiStatus(ctx).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListWifiStatus(context.Background()).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListWifiStatus``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListWifiStatus`: []SystemInsightsWifiStatus
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListWifiStatus`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListWifiStatusRequest struct via the builder pattern
...
[**[]SystemInsightsWifiStatus**](SystemInsightsWifiStatus.md)
...
> []SystemInsightsWindowsSecurityCenter SysteminsightsListWindowsSecurityCenter(ctx).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListWindowsSecurityCenter(context.Background()).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListWindowsSecurityCenter``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListWindowsSecurityCenter`: []SystemInsightsWindowsSecurityCenter
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListWindowsSecurityCenter`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListWindowsSecurityCenterRequest struct via the builder pattern
...
[**[]SystemInsightsWindowsSecurityCenter**](SystemInsightsWindowsSecurityCenter.md)
...
> []SystemInsightsWindowsSecurityProducts SysteminsightsListWindowsSecurityProducts(ctx).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SystemInsightsApi.SysteminsightsListWindowsSecurityProducts(context.Background()).Skip(skip).Sort(sort).Filter(filter).XOrgId(xOrgId).Limit(limit).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SystemInsightsApi.SysteminsightsListWindowsSecurityProducts``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SysteminsightsListWindowsSecurityProducts`: []SystemInsightsWindowsSecurityProducts
    fmt.Fprintf(os.Stdout, "Response from `SystemInsightsApi.SysteminsightsListWindowsSecurityProducts`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSysteminsightsListWindowsSecurityProductsRequest struct via the builder pattern
...
[**[]SystemInsightsWindowsSecurityProducts**](SystemInsightsWindowsSecurityProducts.md)
