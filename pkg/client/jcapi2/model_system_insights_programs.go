...
// checks if the SystemInsightsPrograms type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemInsightsPrograms{}

// SystemInsightsPrograms struct for SystemInsightsPrograms
...
type _SystemInsightsPrograms SystemInsightsPrograms
...
func (o *SystemInsightsPrograms) SetCollectionTime(v string) {
	o.CollectionTime = &v
}

// GetIdentifyingNumber returns the IdentifyingNumber field value if set, zero value otherwise.
func (o *SystemInsightsPrograms) GetIdentifyingNumber() string {
	if o == nil || IsNil(o.IdentifyingNumber) {
		var ret string
		return ret
	}
	return *o.IdentifyingNumber
}

// GetIdentifyingNumberOk returns a tuple with the IdentifyingNumber field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SystemInsightsPrograms) GetIdentifyingNumberOk() (*string, bool) {
	if o == nil || IsNil(o.IdentifyingNumber) {
		return nil, false
	}
	return o.IdentifyingNumber, true
}
...
// SetIdentifyingNumber gets a reference to the given string and assigns it to the IdentifyingNumber field.
func (o *SystemInsightsPrograms) SetIdentifyingNumber(v string) {
	o.IdentifyingNumber = &v
}
...
func (o *SystemInsightsPrograms) HasInstallDate() bool {
	if o != nil && !IsNil(o.InstallDate) {
		return true
	}
...
// GetInstallLocation returns the InstallLocation field value if set, zero value otherwise.
func (o *SystemInsightsPrograms) GetInstallLocation() string {
	if o == nil || IsNil(o.InstallLocation) {
		var ret string
		return ret
	}
...
// GetInstallLocationOk returns a tuple with the InstallLocation field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetInstallLocation gets a reference to the given string and assigns it to the InstallLocation field.
func (o *SystemInsightsPrograms) SetInstallLocation(v string) {
	o.InstallLocation = &v
}

// GetInstallSource returns the InstallSource field value if set, zero value otherwise.
func (o *SystemInsightsPrograms) GetInstallSource() string {
	if o == nil || IsNil(o.InstallSource) {
		var ret string
		return ret
	}
	return *o.InstallSource
}

// GetInstallSourceOk returns a tuple with the InstallSource field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SystemInsightsPrograms) GetInstallSourceOk() (*string, bool) {
	if o == nil || IsNil(o.InstallSource) {
		return nil, false
	}
	return o.InstallSource, true
}
...
// SetInstallSource gets a reference to the given string and assigns it to the InstallSource field.
func (o *SystemInsightsPrograms) SetInstallSource(v string) {
	o.InstallSource = &v
}

// GetLanguage returns the Language field value if set, zero value otherwise.
func (o *SystemInsightsPrograms) GetLanguage() string {
...
// GetUninstallString returns the UninstallString field value if set, zero value otherwise.
func (o *SystemInsightsPrograms) GetUninstallString() string {
	if o == nil || IsNil(o.UninstallString) {
		var ret string
		return ret
	}
	return *o.UninstallString
}

// GetUninstallStringOk returns a tuple with the UninstallString field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SystemInsightsPrograms) GetUninstallStringOk() (*string, bool) {
	if o == nil || IsNil(o.UninstallString) {
		return nil, false
	}
	return o.UninstallString, true
}
...
// SetUninstallString gets a reference to the given string and assigns it to the UninstallString field.
func (o *SystemInsightsPrograms) SetUninstallString(v string) {
	o.UninstallString = &v
}
...
func (o SystemInsightsPrograms) MarshalJSON() ([]byte, error) {
...
func (o SystemInsightsPrograms) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.CollectionTime) {
		toSerialize["collection_time"] = o.CollectionTime
	}
	if !IsNil(o.IdentifyingNumber) {
		toSerialize["identifying_number"] = o.IdentifyingNumber
	}
	if !IsNil(o.InstallDate) {
		toSerialize["install_date"] = o.InstallDate
	}
	if !IsNil(o.InstallLocation) {
		toSerialize["install_location"] = o.InstallLocation
	}
	if !IsNil(o.InstallSource) {
		toSerialize["install_source"] = o.InstallSource
	}
	if !IsNil(o.Language) {
	...
	if !IsNil(o.UninstallString) {
		toSerialize["uninstall_string"] = o.UninstallString
	}
	if !IsNil(o.Version) {
...
func (o *SystemInsightsPrograms) UnmarshalJSON(bytes []byte) (err error) {
	varSystemInsightsPrograms := _SystemInsightsPrograms{}

	if err = json.Unmarshal(bytes, &varSystemInsightsPrograms); err == nil {
		*o = SystemInsightsPrograms(varSystemInsightsPrograms)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "identifying_number")
		delete(additionalProperties, "install_date")
		delete(additionalProperties, "install_location")
		delete(additionalProperties, "install_source")
		delete(additionalProperties, "language")
		delete(additionalProperties, "name")
		delete(additionalProperties, "publisher")
		delete(additionalProperties, "system_id")
		delete(additionalProperties, "uninstall_string")
...
type NullableSystemInsightsPrograms struct {
	value *SystemInsightsPrograms
	isSet bool
}

func (v NullableSystemInsightsPrograms) Get() *SystemInsightsPrograms {
	return v.value
}

func (v *NullableSystemInsightsPrograms) Set(val *SystemInsightsPrograms) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemInsightsPrograms) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemInsightsPrograms) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemInsightsPrograms(val *SystemInsightsPrograms) *NullableSystemInsightsPrograms {
	return &NullableSystemInsightsPrograms{value: val, isSet: true}
}

func (v NullableSystemInsightsPrograms) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemInsightsPrograms) UnmarshalJSON(src []byte) error {
	v.isSet = true
