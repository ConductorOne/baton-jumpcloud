...
// checks if the PwmUserItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PwmUserItem{}

// PwmUserItem struct for PwmUserItem
type PwmUserItem struct {
...
func (o PwmUserItem) MarshalJSON() ([]byte, error) {
...
func (o PwmUserItem) ToMap() (map[string]interface{}, error) {
...
func (o *PwmUserItem) UnmarshalJSON(bytes []byte) (err error) {
	varPwmUserItem := _PwmUserItem{}

	if err = json.Unmarshal(bytes, &varPwmUserItem); err == nil {
		*o = PwmUserItem(varPwmUserItem)
	}
...
type NullablePwmUserItem struct {
	value *PwmUserItem
	isSet bool
}

func (v NullablePwmUserItem) Get() *PwmUserItem {
	return v.value
}

func (v *NullablePwmUserItem) Set(val *PwmUserItem) {
	v.value = val
	v.isSet = true
}

func (v NullablePwmUserItem) IsSet() bool {
	return v.isSet
}

func (v *NullablePwmUserItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePwmUserItem(val *PwmUserItem) *NullablePwmUserItem {
	return &NullablePwmUserItem{value: val, isSet: true}
}

func (v NullablePwmUserItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePwmUserItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
