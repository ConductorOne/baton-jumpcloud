...
// GetSuggestionCounts returns the SuggestionCounts field value if set, zero value otherwise.
func (o *UserGroup) GetSuggestionCounts() SuggestionCounts {
	if o == nil || IsNil(o.SuggestionCounts) {
		var ret SuggestionCounts
		return ret
	}
	return *o.SuggestionCounts
}

// GetSuggestionCountsOk returns a tuple with the SuggestionCounts field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserGroup) GetSuggestionCountsOk() (*SuggestionCounts, bool) {
	if o == nil || IsNil(o.SuggestionCounts) {
		return nil, false
	}
	return o.SuggestionCounts, true
}
...
// SetSuggestionCounts gets a reference to the given SuggestionCounts and assigns it to the SuggestionCounts field.
func (o *UserGroup) SetSuggestionCounts(v SuggestionCounts) {
	o.SuggestionCounts = &v
}
...
func (o UserGroup) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SuggestionCounts) {
		toSerialize["suggestionCounts"] = o.SuggestionCounts
	}
	if !IsNil(o.Type) {
