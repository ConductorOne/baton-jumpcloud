...
// checks if the GroupPwm type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupPwm{}

// GroupPwm struct for GroupPwm
type GroupPwm struct {
...
func (o GroupPwm) MarshalJSON() ([]byte, error) {
...
func (o GroupPwm) ToMap() (map[string]interface{}, error) {
...
func (o *GroupPwm) UnmarshalJSON(bytes []byte) (err error) {
	varGroupPwm := _GroupPwm{}

	if err = json.Unmarshal(bytes, &varGroupPwm); err == nil {
		*o = GroupPwm(varGroupPwm)
	}
...
type NullableGroupPwm struct {
	value *GroupPwm
	isSet bool
}

func (v NullableGroupPwm) Get() *GroupPwm {
	return v.value
}

func (v *NullableGroupPwm) Set(val *GroupPwm) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupPwm) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupPwm) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupPwm(val *GroupPwm) *NullableGroupPwm {
	return &NullableGroupPwm{value: val, isSet: true}
}

func (v NullableGroupPwm) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupPwm) UnmarshalJSON(src []byte) error {
	v.isSet = true
