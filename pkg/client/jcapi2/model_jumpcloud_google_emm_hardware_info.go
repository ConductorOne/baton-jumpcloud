...
// checks if the JumpcloudGoogleEmmHardwareInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JumpcloudGoogleEmmHardwareInfo{}

// JumpcloudGoogleEmmHardwareInfo struct for JumpcloudGoogleEmmHardwareInfo
type JumpcloudGoogleEmmHardwareInfo struct {
...
type _JumpcloudGoogleEmmHardwareInfo JumpcloudGoogleEmmHardwareInfo
...
func NewJumpcloudGoogleEmmHardwareInfo() *JumpcloudGoogleEmmHardwareInfo {
	this := JumpcloudGoogleEmmHardwareInfo{}
	return &this
}
...
// GetDeviceBaseBandVersion returns the DeviceBaseBandVersion field value if set, zero value otherwise.
func (o *JumpcloudGoogleEmmHardwareInfo) GetDeviceBaseBandVersion() string {
	if o == nil || IsNil(o.DeviceBaseBandVersion) {
		var ret string
		return ret
	}
	return *o.DeviceBaseBandVersion
}

// GetDeviceBaseBandVersionOk returns a tuple with the DeviceBaseBandVersion field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *JumpcloudGoogleEmmHardwareInfo) GetDeviceBaseBandVersionOk() (*string, bool) {
	if o == nil || IsNil(o.DeviceBaseBandVersion) {
		return nil, false
	}
	return o.DeviceBaseBandVersion, true
}
...
// SetDeviceBaseBandVersion gets a reference to the given string and assigns it to the DeviceBaseBandVersion field.
func (o *JumpcloudGoogleEmmHardwareInfo) SetDeviceBaseBandVersion(v string) {
	o.DeviceBaseBandVersion = &v
}
...
func (o JumpcloudGoogleEmmHardwareInfo) MarshalJSON() ([]byte, error) {
...
func (o JumpcloudGoogleEmmHardwareInfo) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Brand) {
		toSerialize["brand"] = o.Brand
	}
	if !IsNil(o.DeviceBaseBandVersion) {
		toSerialize["deviceBaseBandVersion"] = o.DeviceBaseBandVersion
	}
	if !IsNil(o.Hardware) {
...
func (o *JumpcloudGoogleEmmHardwareInfo) UnmarshalJSON(bytes []byte) (err error) {
	varJumpcloudGoogleEmmHardwareInfo := _JumpcloudGoogleEmmHardwareInfo{}

	if err = json.Unmarshal(bytes, &varJumpcloudGoogleEmmHardwareInfo); err == nil {
		*o = JumpcloudGoogleEmmHardwareInfo(varJumpcloudGoogleEmmHardwareInfo)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "deviceBaseBandVersion")
...
type NullableJumpcloudGoogleEmmHardwareInfo struct {
	value *JumpcloudGoogleEmmHardwareInfo
	isSet bool
}

func (v NullableJumpcloudGoogleEmmHardwareInfo) Get() *JumpcloudGoogleEmmHardwareInfo {
	return v.value
}

func (v *NullableJumpcloudGoogleEmmHardwareInfo) Set(val *JumpcloudGoogleEmmHardwareInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableJumpcloudGoogleEmmHardwareInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableJumpcloudGoogleEmmHardwareInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJumpcloudGoogleEmmHardwareInfo(val *JumpcloudGoogleEmmHardwareInfo) *NullableJumpcloudGoogleEmmHardwareInfo {
	return &NullableJumpcloudGoogleEmmHardwareInfo{value: val, isSet: true}
}

func (v NullableJumpcloudGoogleEmmHardwareInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJumpcloudGoogleEmmHardwareInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
