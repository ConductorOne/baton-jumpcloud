...
// checks if the SystemGroupPut type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemGroupPut{}

// SystemGroupPut struct for SystemGroupPut
type SystemGroupPut struct {
...
type _SystemGroupPut SystemGroupPut
...
func (o SystemGroupPut) MarshalJSON() ([]byte, error) {
...
func (o SystemGroupPut) ToMap() (map[string]interface{}, error) {
...
func (o *SystemGroupPut) UnmarshalJSON(bytes []byte) (err error) {
	varSystemGroupPut := _SystemGroupPut{}

	if err = json.Unmarshal(bytes, &varSystemGroupPut); err == nil {
		*o = SystemGroupPut(varSystemGroupPut)
	}
...
type NullableSystemGroupPut struct {
	value *SystemGroupPut
	isSet bool
}

func (v NullableSystemGroupPut) Get() *SystemGroupPut {
	return v.value
}

func (v *NullableSystemGroupPut) Set(val *SystemGroupPut) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemGroupPut) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemGroupPut) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemGroupPut(val *SystemGroupPut) *NullableSystemGroupPut {
	return &NullableSystemGroupPut{value: val, isSet: true}
}

func (v NullableSystemGroupPut) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemGroupPut) UnmarshalJSON(src []byte) error {
	v.isSet = true
