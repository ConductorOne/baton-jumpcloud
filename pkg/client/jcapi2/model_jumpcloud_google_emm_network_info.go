...
// checks if the JumpcloudGoogleEmmNetworkInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JumpcloudGoogleEmmNetworkInfo{}

// JumpcloudGoogleEmmNetworkInfo struct for JumpcloudGoogleEmmNetworkInfo
type JumpcloudGoogleEmmNetworkInfo struct {
	// Not logging as it contains sensitive information.
	Imei *string `json:"imei,omitempty"`
	// Not logging as it contains sensitive information.
	Meid *string `json:"meid,omitempty"`
	TelephonyInfo []JumpcloudGoogleEmmTelephonyInfo `json:"telephonyInfo,omitempty"`
	// Not logging as it contains sensitive information.
	WifiMacAddress *string `json:"wifiMacAddress,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _JumpcloudGoogleEmmNetworkInfo JumpcloudGoogleEmmNetworkInfo
...
func NewJumpcloudGoogleEmmNetworkInfo() *JumpcloudGoogleEmmNetworkInfo {
	this := JumpcloudGoogleEmmNetworkInfo{}
	return &this
}
...
// GetTelephonyInfo returns the TelephonyInfo field value if set, zero value otherwise.
func (o *JumpcloudGoogleEmmNetworkInfo) GetTelephonyInfo() []JumpcloudGoogleEmmTelephonyInfo {
	if o == nil || IsNil(o.TelephonyInfo) {
		var ret []JumpcloudGoogleEmmTelephonyInfo
		return ret
	}
	return o.TelephonyInfo
}

// GetTelephonyInfoOk returns a tuple with the TelephonyInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *JumpcloudGoogleEmmNetworkInfo) GetTelephonyInfoOk() ([]JumpcloudGoogleEmmTelephonyInfo, bool) {
	if o == nil || IsNil(o.TelephonyInfo) {
		return nil, false
	}
	return o.TelephonyInfo, true
}
...
// SetTelephonyInfo gets a reference to the given []JumpcloudGoogleEmmTelephonyInfo and assigns it to the TelephonyInfo field.
...
func (o JumpcloudGoogleEmmNetworkInfo) MarshalJSON() ([]byte, error) {
...
func (o JumpcloudGoogleEmmNetworkInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TelephonyInfo) {
		toSerialize["telephonyInfo"] = o.TelephonyInfo
	}
...
func (o *JumpcloudGoogleEmmNetworkInfo) UnmarshalJSON(bytes []byte) (err error) {
	varJumpcloudGoogleEmmNetworkInfo := _JumpcloudGoogleEmmNetworkInfo{}

	if err = json.Unmarshal(bytes, &varJumpcloudGoogleEmmNetworkInfo); err == nil {
		*o = JumpcloudGoogleEmmNetworkInfo(varJumpcloudGoogleEmmNetworkInfo)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "telephonyInfo")
		delete(additionalProperties, "wifiMacAddress")
...
type NullableJumpcloudGoogleEmmNetworkInfo struct {
	value *JumpcloudGoogleEmmNetworkInfo
	isSet bool
}

func (v NullableJumpcloudGoogleEmmNetworkInfo) Get() *JumpcloudGoogleEmmNetworkInfo {
	return v.value
}

func (v *NullableJumpcloudGoogleEmmNetworkInfo) Set(val *JumpcloudGoogleEmmNetworkInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableJumpcloudGoogleEmmNetworkInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableJumpcloudGoogleEmmNetworkInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJumpcloudGoogleEmmNetworkInfo(val *JumpcloudGoogleEmmNetworkInfo) *NullableJumpcloudGoogleEmmNetworkInfo {
	return &NullableJumpcloudGoogleEmmNetworkInfo{value: val, isSet: true}
}

func (v NullableJumpcloudGoogleEmmNetworkInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJumpcloudGoogleEmmNetworkInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
