...
func Test_jcapi2_ProvidersApiService(t *testing.T) {
	...
	t.Run("Test ProvidersApiService PolicyGroupTemplatesDelete", func(t *testing.T) {
		...
		httpRes, err := apiClient.ProvidersApi.PolicyGroupTemplatesDelete(context.Background(), providerId, id).Execute()
