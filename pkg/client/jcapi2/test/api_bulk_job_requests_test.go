...
func Test_jcapi2_BulkJobRequestsApiService(t *testing.T) {

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)

	t.Run("Test BulkJobRequestsApiService BulkUserExpires", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.BulkJobRequestsApi.BulkUserExpires(context.Background()).Execute()
