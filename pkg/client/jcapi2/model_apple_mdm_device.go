...
// checks if the AppleMdmDevice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppleMdmDevice{}

// AppleMdmDevice struct for AppleMdmDevice
type AppleMdmDevice struct {
	CreatedAt *string `json:"createdAt,omitempty"`
	DepRegistered *bool `json:"depRegistered,omitempty"`
	DeviceInformation *AppleMdmDeviceInfo `json:"deviceInformation,omitempty"`
	Enrolled *bool `json:"enrolled,omitempty"`
	HasActivationLockBypassCodes *bool `json:"hasActivationLockBypassCodes,omitempty"`
	Id *string `json:"id,omitempty"`
	OsVersion *string `json:"osVersion,omitempty"`
	SecurityInfo *AppleMdmDeviceSecurityInfo `json:"securityInfo,omitempty"`
	SerialNumber *string `json:"serialNumber,omitempty"`
	Udid *string `json:"udid,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AppleMdmDevice AppleMdmDevice
...
// GetDepRegistered returns the DepRegistered field value if set, zero value otherwise.
func (o *AppleMdmDevice) GetDepRegistered() bool {
	if o == nil || IsNil(o.DepRegistered) {
		var ret bool
		return ret
	}
	return *o.DepRegistered
}

// GetDepRegisteredOk returns a tuple with the DepRegistered field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppleMdmDevice) GetDepRegisteredOk() (*bool, bool) {
	if o == nil || IsNil(o.DepRegistered) {
		return nil, false
	}
	return o.DepRegistered, true
}
...
// SetDepRegistered gets a reference to the given bool and assigns it to the DepRegistered field.
func (o *AppleMdmDevice) SetDepRegistered(v bool) {
	o.DepRegistered = &v
}

// GetDeviceInformation returns the DeviceInformation field value if set, zero value otherwise.
func (o *AppleMdmDevice) GetDeviceInformation() AppleMdmDeviceInfo {
	if o == nil || IsNil(o.DeviceInformation) {
		var ret AppleMdmDeviceInfo
		return ret
	}
...
func (o *AppleMdmDevice) GetDeviceInformationOk() (*AppleMdmDeviceInfo, bool) {
	...
	return o.DeviceInformation, true
}
...
// SetDeviceInformation gets a reference to the given AppleMdmDeviceInfo and assigns it to the DeviceInformation field.
func (o *AppleMdmDevice) SetDeviceInformation(v AppleMdmDeviceInfo) {
	o.DeviceInformation = &v
}
...
// GetHasActivationLockBypassCodes returns the HasActivationLockBypassCodes field value if set, zero value otherwise.
func (o *AppleMdmDevice) GetHasActivationLockBypassCodes() bool {
	if o == nil || IsNil(o.HasActivationLockBypassCodes) {
		var ret bool
		return ret
	}
	return *o.HasActivationLockBypassCodes
}

// GetHasActivationLockBypassCodesOk returns a tuple with the HasActivationLockBypassCodes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppleMdmDevice) GetHasActivationLockBypassCodesOk() (*bool, bool) {
	if o == nil || IsNil(o.HasActivationLockBypassCodes) {
		return nil, false
	}
	return o.HasActivationLockBypassCodes, true
}
...
// SetHasActivationLockBypassCodes gets a reference to the given bool and assigns it to the HasActivationLockBypassCodes field.
func (o *AppleMdmDevice) SetHasActivationLockBypassCodes(v bool) {
	o.HasActivationLockBypassCodes = &v
}
...
func (o *AppleMdmDevice) GetSecurityInfo() AppleMdmDeviceSecurityInfo {
	if o == nil || IsNil(o.SecurityInfo) {
		var ret AppleMdmDeviceSecurityInfo
		return ret
	}
...
// SetSecurityInfo gets a reference to the given AppleMdmDeviceSecurityInfo and assigns it to the SecurityInfo field.
...
func (o AppleMdmDevice) MarshalJSON() ([]byte, error) {
...
func (o AppleMdmDevice) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.CreatedAt) {
		toSerialize["createdAt"] = o.CreatedAt
	}
	if !IsNil(o.DepRegistered) {
		toSerialize["depRegistered"] = o.DepRegistered
	}
	if !IsNil(o.DeviceInformation) {
		toSerialize["deviceInformation"] = o.DeviceInformation
	}
	if !IsNil(o.Enrolled) {
		toSerialize["enrolled"] = o.Enrolled
	}
	if !IsNil(o.HasActivationLockBypassCodes) {
		toSerialize["hasActivationLockBypassCodes"] = o.HasActivationLockBypassCodes
	}
	if !IsNil(o.Id) {
		toSerialize["id"] = o.Id
	}
...
func (o *AppleMdmDevice) UnmarshalJSON(bytes []byte) (err error) {
	varAppleMdmDevice := _AppleMdmDevice{}

	if err = json.Unmarshal(bytes, &varAppleMdmDevice); err == nil {
		*o = AppleMdmDevice(varAppleMdmDevice)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "depRegistered")
		delete(additionalProperties, "deviceInformation")
		delete(additionalProperties, "enrolled")
		delete(additionalProperties, "hasActivationLockBypassCodes")
		delete(additionalProperties, "id")
		delete(additionalProperties, "osVersion")
		delete(additionalProperties, "securityInfo")
...
type NullableAppleMdmDevice struct {
	value *AppleMdmDevice
	isSet bool
}

func (v NullableAppleMdmDevice) Get() *AppleMdmDevice {
	return v.value
}

func (v *NullableAppleMdmDevice) Set(val *AppleMdmDevice) {
	v.value = val
	v.isSet = true
}

func (v NullableAppleMdmDevice) IsSet() bool {
	return v.isSet
}

func (v *NullableAppleMdmDevice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppleMdmDevice(val *AppleMdmDevice) *NullableAppleMdmDevice {
	return &NullableAppleMdmDevice{value: val, isSet: true}
}

func (v NullableAppleMdmDevice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppleMdmDevice) UnmarshalJSON(src []byte) error {
	v.isSet = true
