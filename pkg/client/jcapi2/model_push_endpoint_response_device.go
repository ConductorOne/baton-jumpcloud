...
// checks if the PushEndpointResponseDevice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PushEndpointResponseDevice{}

// PushEndpointResponseDevice struct for PushEndpointResponseDevice
type PushEndpointResponseDevice struct {
	AppVersion *string `json:"appVersion,omitempty"`
	Make *string `json:"make,omitempty"`
	Model *string `json:"model,omitempty"`
	Os *string `json:"os,omitempty"`
	OsVersion *string `json:"osVersion,omitempty"`
	UvEnabled *bool `json:"uvEnabled,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PushEndpointResponseDevice PushEndpointResponseDevice
...
func NewPushEndpointResponseDevice() *PushEndpointResponseDevice {
	this := PushEndpointResponseDevice{}
	return &this
}
...
// GetUvEnabled returns the UvEnabled field value if set, zero value otherwise.
func (o *PushEndpointResponseDevice) GetUvEnabled() bool {
	if o == nil || IsNil(o.UvEnabled) {
		var ret bool
		return ret
	}
	return *o.UvEnabled
...
// GetUvEnabledOk returns a tuple with the UvEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PushEndpointResponseDevice) GetUvEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.UvEnabled) {
		return nil, false
	}
	return o.UvEnabled, true
}
...
// SetUvEnabled gets a reference to the given bool and assigns it to the UvEnabled field.
func (o *PushEndpointResponseDevice) SetUvEnabled(v bool) {
	o.UvEnabled = &v
}

func (o PushEndpointResponseDevice) MarshalJSON() ([]byte, error) {
...
func (o PushEndpointResponseDevice) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.UvEnabled) {
		toSerialize["uvEnabled"] = o.UvEnabled
	}
...
func (o *PushEndpointResponseDevice) UnmarshalJSON(bytes []byte) (err error) {
	varPushEndpointResponseDevice := _PushEndpointResponseDevice{}

	if err = json.Unmarshal(bytes, &varPushEndpointResponseDevice); err == nil {
		*o = PushEndpointResponseDevice(varPushEndpointResponseDevice)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "uvEnabled")
...
type NullablePushEndpointResponseDevice struct {
	value *PushEndpointResponseDevice
	isSet bool
}

func (v NullablePushEndpointResponseDevice) Get() *PushEndpointResponseDevice {
	return v.value
}

func (v *NullablePushEndpointResponseDevice) Set(val *PushEndpointResponseDevice) {
	v.value = val
	v.isSet = true
}

func (v NullablePushEndpointResponseDevice) IsSet() bool {
	return v.isSet
}

func (v *NullablePushEndpointResponseDevice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePushEndpointResponseDevice(val *PushEndpointResponseDevice) *NullablePushEndpointResponseDevice {
	return &NullablePushEndpointResponseDevice{value: val, isSet: true}
}

func (v NullablePushEndpointResponseDevice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePushEndpointResponseDevice) UnmarshalJSON(src []byte) error {
	v.isSet = true
