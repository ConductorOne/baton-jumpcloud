...
// checks if the JumpcloudGoogleEmmConnectionStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JumpcloudGoogleEmmConnectionStatus{}

// JumpcloudGoogleEmmConnectionStatus struct for JumpcloudGoogleEmmConnectionStatus
type JumpcloudGoogleEmmConnectionStatus struct {
...
type _JumpcloudGoogleEmmConnectionStatus JumpcloudGoogleEmmConnectionStatus
...
func NewJumpcloudGoogleEmmConnectionStatus() *JumpcloudGoogleEmmConnectionStatus {
	this := JumpcloudGoogleEmmConnectionStatus{}
	return &this
}
...
func (o JumpcloudGoogleEmmConnectionStatus) MarshalJSON() ([]byte, error) {
...
func (o JumpcloudGoogleEmmConnectionStatus) ToMap() (map[string]interface{}, error) {
...
func (o *JumpcloudGoogleEmmConnectionStatus) UnmarshalJSON(bytes []byte) (err error) {
	varJumpcloudGoogleEmmConnectionStatus := _JumpcloudGoogleEmmConnectionStatus{}

	if err = json.Unmarshal(bytes, &varJumpcloudGoogleEmmConnectionStatus); err == nil {
		*o = JumpcloudGoogleEmmConnectionStatus(varJumpcloudGoogleEmmConnectionStatus)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "enterpriseId")
...
type NullableJumpcloudGoogleEmmConnectionStatus struct {
	value *JumpcloudGoogleEmmConnectionStatus
	isSet bool
}

func (v NullableJumpcloudGoogleEmmConnectionStatus) Get() *JumpcloudGoogleEmmConnectionStatus {
	return v.value
}

func (v *NullableJumpcloudGoogleEmmConnectionStatus) Set(val *JumpcloudGoogleEmmConnectionStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableJumpcloudGoogleEmmConnectionStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableJumpcloudGoogleEmmConnectionStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJumpcloudGoogleEmmConnectionStatus(val *JumpcloudGoogleEmmConnectionStatus) *NullableJumpcloudGoogleEmmConnectionStatus {
	return &NullableJumpcloudGoogleEmmConnectionStatus{value: val, isSet: true}
}

func (v NullableJumpcloudGoogleEmmConnectionStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJumpcloudGoogleEmmConnectionStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
