...
// checks if the SystemInsightsServices type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemInsightsServices{}

// SystemInsightsServices struct for SystemInsightsServices
type SystemInsightsServices struct {
	...
	ServiceExitCode *int32 `json:"service_exit_code,omitempty"`
	ServiceType *string `json:"service_type,omitempty"`
	StartType *string `json:"start_type,omitempty"`
	Status *string `json:"status,omitempty"`
	SystemId *string `json:"system_id,omitempty"`
	UserAccount *string `json:"user_account,omitempty"`
	Win32ExitCode *int32 `json:"win32_exit_code,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _SystemInsightsServices SystemInsightsServices
...
// GetServiceExitCode returns the ServiceExitCode field value if set, zero value otherwise.
func (o *SystemInsightsServices) GetServiceExitCode() int32 {
	if o == nil || IsNil(o.ServiceExitCode) {
		var ret int32
		return ret
	}
	return *o.ServiceExitCode
}

// GetServiceExitCodeOk returns a tuple with the ServiceExitCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SystemInsightsServices) GetServiceExitCodeOk() (*int32, bool) {
	if o == nil || IsNil(o.ServiceExitCode) {
		return nil, false
	}
	return o.ServiceExitCode, true
}
...
// SetServiceExitCode gets a reference to the given int32 and assigns it to the ServiceExitCode field.
...
// GetWin32ExitCode returns the Win32ExitCode field value if set, zero value otherwise.
func (o *SystemInsightsServices) GetWin32ExitCode() int32 {
	if o == nil || IsNil(o.Win32ExitCode) {
		var ret int32
		return ret
	}
	return *o.Win32ExitCode
}

// GetWin32ExitCodeOk returns a tuple with the Win32ExitCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SystemInsightsServices) GetWin32ExitCodeOk() (*int32, bool) {
	if o == nil || IsNil(o.Win32ExitCode) {
		return nil, false
	}
	return o.Win32ExitCode, true
}
...
// SetWin32ExitCode gets a reference to the given int32 and assigns it to the Win32ExitCode field.
func (o *SystemInsightsServices) SetWin32ExitCode(v int32) {
	o.Win32ExitCode = &v
}

func (o SystemInsightsServices) MarshalJSON() ([]byte, error) {
...
func (o SystemInsightsServices) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ServiceExitCode) {
		toSerialize["service_exit_code"] = o.ServiceExitCode
	}
	...
	if !IsNil(o.Win32ExitCode) {
		toSerialize["win32_exit_code"] = o.Win32ExitCode
	}
...
func (o *SystemInsightsServices) UnmarshalJSON(bytes []byte) (err error) {
	varSystemInsightsServices := _SystemInsightsServices{}

	if err = json.Unmarshal(bytes, &varSystemInsightsServices); err == nil {
		*o = SystemInsightsServices(varSystemInsightsServices)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "module_path")
		delete(additionalProperties, "name")
		delete(additionalProperties, "path")
		delete(additionalProperties, "pid")
		delete(additionalProperties, "service_exit_code")
		...
		delete(additionalProperties, "user_account")
		delete(additionalProperties, "win32_exit_code")
...
type NullableSystemInsightsServices struct {
	value *SystemInsightsServices
	isSet bool
}

func (v NullableSystemInsightsServices) Get() *SystemInsightsServices {
	return v.value
}

func (v *NullableSystemInsightsServices) Set(val *SystemInsightsServices) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemInsightsServices) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemInsightsServices) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemInsightsServices(val *SystemInsightsServices) *NullableSystemInsightsServices {
	return &NullableSystemInsightsServices{value: val, isSet: true}
}

func (v NullableSystemInsightsServices) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemInsightsServices) UnmarshalJSON(src []byte) error {
	v.isSet = true
