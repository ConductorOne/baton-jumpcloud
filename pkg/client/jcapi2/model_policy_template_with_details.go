...
// checks if the PolicyTemplateWithDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PolicyTemplateWithDetails{}

// PolicyTemplateWithDetails The shallow information about a Policy Template.
type PolicyTemplateWithDetails struct {
	...
	OsRestrictions []OSRestriction `json:"osRestrictions,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PolicyTemplateWithDetails PolicyTemplateWithDetails
...
func NewPolicyTemplateWithDetails() *PolicyTemplateWithDetails {
	this := PolicyTemplateWithDetails{}
	return &this
}
...
func (o *PolicyTemplateWithDetails) GetConfigFields() []PolicyTemplateConfigField {
	if o == nil || IsNil(o.ConfigFields) {
		var ret []PolicyTemplateConfigField
		return ret
	}
...
// SetConfigFields gets a reference to the given []PolicyTemplateConfigField and assigns it to the ConfigFields field.
...
// GetOsMetaFamily returns the OsMetaFamily field value if set, zero value otherwise.
func (o *PolicyTemplateWithDetails) GetOsMetaFamily() string {
	if o == nil || IsNil(o.OsMetaFamily) {
		var ret string
		return ret
	}
	return *o.OsMetaFamily
}

// GetOsMetaFamilyOk returns a tuple with the OsMetaFamily field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PolicyTemplateWithDetails) GetOsMetaFamilyOk() (*string, bool) {
	if o == nil || IsNil(o.OsMetaFamily) {
		return nil, false
	}
	return o.OsMetaFamily, true
}
...
// SetOsMetaFamily gets a reference to the given string and assigns it to the OsMetaFamily field.
func (o *PolicyTemplateWithDetails) SetOsMetaFamily(v string) {
	o.OsMetaFamily = &v
}

// GetOsRestrictions returns the OsRestrictions field value if set, zero value otherwise.
func (o *PolicyTemplateWithDetails) GetOsRestrictions() []OSRestriction {
	if o == nil || IsNil(o.OsRestrictions) {
		var ret []OSRestriction
		return ret
	}
	return o.OsRestrictions
}

// GetOsRestrictionsOk returns a tuple with the OsRestrictions field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PolicyTemplateWithDetails) GetOsRestrictionsOk() ([]OSRestriction, bool) {
	if o == nil || IsNil(o.OsRestrictions) {
		return nil, false
	}
	return o.OsRestrictions, true
}
...
// SetOsRestrictions gets a reference to the given []OSRestriction and assigns it to the OsRestrictions field.
func (o *PolicyTemplateWithDetails) SetOsRestrictions(v []OSRestriction) {
	o.OsRestrictions = v
}

func (o PolicyTemplateWithDetails) MarshalJSON() ([]byte, error) {
...
func (o PolicyTemplateWithDetails) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.OsMetaFamily) {
		toSerialize["osMetaFamily"] = o.OsMetaFamily
	}
	if !IsNil(o.OsRestrictions) {
		toSerialize["osRestrictions"] = o.OsRestrictions
	}
...
func (o *PolicyTemplateWithDetails) UnmarshalJSON(bytes []byte) (err error) {
	varPolicyTemplateWithDetails := _PolicyTemplateWithDetails{}

	if err = json.Unmarshal(bytes, &varPolicyTemplateWithDetails); err == nil {
		*o = PolicyTemplateWithDetails(varPolicyTemplateWithDetails)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "osMetaFamily")
		delete(additionalProperties, "osRestrictions")
...
type NullablePolicyTemplateWithDetails struct {
	value *PolicyTemplateWithDetails
	isSet bool
}

func (v NullablePolicyTemplateWithDetails) Get() *PolicyTemplateWithDetails {
	return v.value
}

func (v *NullablePolicyTemplateWithDetails) Set(val *PolicyTemplateWithDetails) {
	v.value = val
	v.isSet = true
}

func (v NullablePolicyTemplateWithDetails) IsSet() bool {
	return v.isSet
}

func (v *NullablePolicyTemplateWithDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePolicyTemplateWithDetails(val *PolicyTemplateWithDetails) *NullablePolicyTemplateWithDetails {
	return &NullablePolicyTemplateWithDetails{value: val, isSet: true}
}

func (v NullablePolicyTemplateWithDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePolicyTemplateWithDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
