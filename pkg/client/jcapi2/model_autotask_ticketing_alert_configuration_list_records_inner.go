...
// checks if the AutotaskTicketingAlertConfigurationListRecordsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AutotaskTicketingAlertConfigurationListRecordsInner{}

// AutotaskTicketingAlertConfigurationListRecordsInner struct for AutotaskTicketingAlertConfigurationListRecordsInner
type AutotaskTicketingAlertConfigurationListRecordsInner struct {
	...
	Priority *AutotaskTicketingAlertConfigurationPriority `json:"priority,omitempty"`
	...
	Status *AutotaskTicketingAlertConfigurationPriority `json:"status,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AutotaskTicketingAlertConfigurationListRecordsInner AutotaskTicketingAlertConfigurationListRecordsInner
...
func NewAutotaskTicketingAlertConfigurationListRecordsInner() *AutotaskTicketingAlertConfigurationListRecordsInner {
	this := AutotaskTicketingAlertConfigurationListRecordsInner{}
	return &this
}
...
// SetPriority gets a reference to the given AutotaskTicketingAlertConfigurationPriority and assigns it to the Priority field.
...
// SetStatus gets a reference to the given AutotaskTicketingAlertConfigurationPriority and assigns it to the Status field.
func (o *AutotaskTicketingAlertConfigurationListRecordsInner) SetStatus(v AutotaskTicketingAlertConfigurationPriority) {
	o.Status = &v
}

func (o AutotaskTicketingAlertConfigurationListRecordsInner) MarshalJSON() ([]byte, error) {
...
func (o AutotaskTicketingAlertConfigurationListRecordsInner) ToMap() (map[string]interface{}, error) {
...
func (o *AutotaskTicketingAlertConfigurationListRecordsInner) UnmarshalJSON(bytes []byte) (err error) {
	varAutotaskTicketingAlertConfigurationListRecordsInner := _AutotaskTicketingAlertConfigurationListRecordsInner{}

	if err = json.Unmarshal(bytes, &varAutotaskTicketingAlertConfigurationListRecordsInner); err == nil {
		*o = AutotaskTicketingAlertConfigurationListRecordsInner(varAutotaskTicketingAlertConfigurationListRecordsInner)
	}
...
type NullableAutotaskTicketingAlertConfigurationListRecordsInner struct {
	value *AutotaskTicketingAlertConfigurationListRecordsInner
	isSet bool
}

func (v NullableAutotaskTicketingAlertConfigurationListRecordsInner) Get() *AutotaskTicketingAlertConfigurationListRecordsInner {
	return v.value
}

func (v *NullableAutotaskTicketingAlertConfigurationListRecordsInner) Set(val *AutotaskTicketingAlertConfigurationListRecordsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableAutotaskTicketingAlertConfigurationListRecordsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableAutotaskTicketingAlertConfigurationListRecordsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAutotaskTicketingAlertConfigurationListRecordsInner(val *AutotaskTicketingAlertConfigurationListRecordsInner) *NullableAutotaskTicketingAlertConfigurationListRecordsInner {
	return &NullableAutotaskTicketingAlertConfigurationListRecordsInner{value: val, isSet: true}
}

func (v NullableAutotaskTicketingAlertConfigurationListRecordsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAutotaskTicketingAlertConfigurationListRecordsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
