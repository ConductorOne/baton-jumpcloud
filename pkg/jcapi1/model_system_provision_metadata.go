...
// checks if the SystemProvisionMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemProvisionMetadata{}
...
type _SystemProvisionMetadata SystemProvisionMetadata
...
func (o *SystemProvisionMetadata) GetProvisioner() SystemProvisionMetadataProvisioner {
	if o == nil || IsNil(o.Provisioner) {
		var ret SystemProvisionMetadataProvisioner
		return ret
	}
...
func (o *SystemProvisionMetadata) UnmarshalJSON(bytes []byte) (err error) {
	varSystemProvisionMetadata := _SystemProvisionMetadata{}

	if err = json.Unmarshal(bytes, &varSystemProvisionMetadata); err == nil {
		*o = SystemProvisionMetadata(varSystemProvisionMetadata)
	}
...
func NewNullableSystemProvisionMetadata(val *SystemProvisionMetadata) *NullableSystemProvisionMetadata {
	return &NullableSystemProvisionMetadata{value: val, isSet: true}
}
