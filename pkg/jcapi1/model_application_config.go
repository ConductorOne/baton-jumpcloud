...
// checks if the ApplicationConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationConfig{}
...
type _ApplicationConfig ApplicationConfig
...
func (o *ApplicationConfig) GetAcsUrl() ApplicationConfigAcsUrl {
	if o == nil || IsNil(o.AcsUrl) {
		var ret ApplicationConfigAcsUrl
		return ret
	}
	return *o.AcsUrl
}
...
func (o *ApplicationConfig) GetConstantAttributes() ApplicationConfigConstantAttributes {
	if o == nil || IsNil(o.ConstantAttributes) {
		var ret ApplicationConfigConstantAttributes
		return ret
	}
	return *o.ConstantAttributes
}

// GetConstantAttributesOk returns a tuple with the ConstantAttributes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApplicationConfig) GetConstantAttributesOk() (*ApplicationConfigConstantAttributes, bool) {
	if o == nil || IsNil(o.ConstantAttributes) {
		return nil, false
	}
	return o.ConstantAttributes, true
}
...
func (o *ApplicationConfig) GetDatabaseAttributes() ApplicationConfigDatabaseAttributes {
	if o == nil || IsNil(o.DatabaseAttributes) {
		var ret ApplicationConfigDatabaseAttributes
		return ret
	}
...
func (o *ApplicationConfig) GetIdpPrivateKey() ApplicationConfigAcsUrl {
	if o == nil || IsNil(o.IdpPrivateKey) {
		var ret ApplicationConfigAcsUrl
		return ret
	}
	return *o.IdpPrivateKey
}

// GetIdpPrivateKeyOk returns a tuple with the IdpPrivateKey field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApplicationConfig) GetIdpPrivateKeyOk() (*ApplicationConfigAcsUrl, bool) {
	if o == nil || IsNil(o.IdpPrivateKey) {
		return nil, false
	}
	return o.IdpPrivateKey, true
}
...
func (o ApplicationConfig) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ConstantAttributes) {
		toSerialize["constantAttributes"] = o.ConstantAttributes
	}
	...
	if !IsNil(o.IdpPrivateKey) {
		toSerialize["idpPrivateKey"] = o.IdpPrivateKey
	}
...
func (o *ApplicationConfig) UnmarshalJSON(bytes []byte) (err error) {
	varApplicationConfig := _ApplicationConfig{}

	if err = json.Unmarshal(bytes, &varApplicationConfig); err == nil {
		*o = ApplicationConfig(varApplicationConfig)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "constantAttributes")
		delete(additionalProperties, "databaseAttributes")
		delete(additionalProperties, "idpCertificate")
		delete(additionalProperties, "idpEntityId")
		delete(additionalProperties, "idpPrivateKey")
		delete(additionalProperties, "spEntityId")
