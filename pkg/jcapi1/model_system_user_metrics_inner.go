...
// checks if the SystemUserMetricsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemUserMetricsInner{}
...
type _SystemUserMetricsInner SystemUserMetricsInner
...
func (o *SystemUserMetricsInner) GetSecureTokenEnabled() bool {
	if o == nil || IsNil(o.SecureTokenEnabled) {
		var ret bool
		return ret
	}
	return *o.SecureTokenEnabled
}

// GetSecureTokenEnabledOk returns a tuple with the SecureTokenEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SystemUserMetricsInner) GetSecureTokenEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.SecureTokenEnabled) {
		return nil, false
	}
	return o.SecureTokenEnabled, true
}
...
func (o SystemUserMetricsInner) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SecureTokenEnabled) {
		toSerialize["secureTokenEnabled"] = o.SecureTokenEnabled
	}
...
func (o *SystemUserMetricsInner) UnmarshalJSON(bytes []byte) (err error) {
	varSystemUserMetricsInner := _SystemUserMetricsInner{}

	if err = json.Unmarshal(bytes, &varSystemUserMetricsInner); err == nil {
		*o = SystemUserMetricsInner(varSystemUserMetricsInner)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "secureTokenEnabled")
...
func NewNullableSystemUserMetricsInner(val *SystemUserMetricsInner) *NullableSystemUserMetricsInner {
	return &NullableSystemUserMetricsInner{value: val, isSet: true}
}
