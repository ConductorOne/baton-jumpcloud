...
// checks if the SystemuserputpostRecoveryEmail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemuserputpostRecoveryEmail{}
...
type _SystemuserputpostRecoveryEmail SystemuserputpostRecoveryEmail
...
func NewSystemuserputpostRecoveryEmail() *SystemuserputpostRecoveryEmail {
	this := SystemuserputpostRecoveryEmail{}
	return &this
}
...
func (o *SystemuserputpostRecoveryEmail) UnmarshalJSON(bytes []byte) (err error) {
	varSystemuserputpostRecoveryEmail := _SystemuserputpostRecoveryEmail{}

	if err = json.Unmarshal(bytes, &varSystemuserputpostRecoveryEmail); err == nil {
		*o = SystemuserputpostRecoveryEmail(varSystemuserputpostRecoveryEmail)
	}
...
type NullableSystemuserputpostRecoveryEmail struct {
	value *SystemuserputpostRecoveryEmail
	isSet bool
}
...
func NewNullableSystemuserputpostRecoveryEmail(val *SystemuserputpostRecoveryEmail) *NullableSystemuserputpostRecoveryEmail {
	return &NullableSystemuserputpostRecoveryEmail{value: val, isSet: true}
}
