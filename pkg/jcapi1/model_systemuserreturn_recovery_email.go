...
// checks if the SystemuserreturnRecoveryEmail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemuserreturnRecoveryEmail{}
...
type _SystemuserreturnRecoveryEmail SystemuserreturnRecoveryEmail
...
func NewSystemuserreturnRecoveryEmail() *SystemuserreturnRecoveryEmail {
	this := SystemuserreturnRecoveryEmail{}
	return &this
}
...
func (o *SystemuserreturnRecoveryEmail) UnmarshalJSON(bytes []byte) (err error) {
	varSystemuserreturnRecoveryEmail := _SystemuserreturnRecoveryEmail{}

	if err = json.Unmarshal(bytes, &varSystemuserreturnRecoveryEmail); err == nil {
		*o = SystemuserreturnRecoveryEmail(varSystemuserreturnRecoveryEmail)
	}
...
type NullableSystemuserreturnRecoveryEmail struct {
	value *SystemuserreturnRecoveryEmail
	isSet bool
}
...
func NewNullableSystemuserreturnRecoveryEmail(val *SystemuserreturnRecoveryEmail) *NullableSystemuserreturnRecoveryEmail {
	return &NullableSystemuserreturnRecoveryEmail{value: val, isSet: true}
}
