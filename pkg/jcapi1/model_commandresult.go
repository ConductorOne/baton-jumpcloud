...
func (o *Commandresult) UnmarshalJSON(bytes []byte) (err error) {
	varCommandresult := _Commandresult{}

	if err = json.Unmarshal(bytes, &varCommandresult); err == nil {
		*o = Commandresult(varCommandresult)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "workflowInstanceId")
