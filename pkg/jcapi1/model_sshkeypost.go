...
// checks if the Sshkeypost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Sshkeypost{}
...
func (o *Sshkeypost) UnmarshalJSON(bytes []byte) (err error) {
	varSshkeypost := _Sshkeypost{}

	if err = json.Unmarshal(bytes, &varSshkeypost); err == nil {
		*o = Sshkeypost(varSshkeypost)
	}
...
func NewNullableSshkeypost(val *Sshkeypost) *NullableSshkeypost {
	return &NullableSshkeypost{value: val, isSet: true}
}
