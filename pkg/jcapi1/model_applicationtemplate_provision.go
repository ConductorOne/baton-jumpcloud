...
// checks if the ApplicationtemplateProvision type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationtemplateProvision{}
...
type _ApplicationtemplateProvision ApplicationtemplateProvision
...
func NewApplicationtemplateProvision() *ApplicationtemplateProvision {
	this := ApplicationtemplateProvision{}
	return &this
}
...
func (o *ApplicationtemplateProvision) GetGroupsSupported() bool {
	if o == nil || IsNil(o.GroupsSupported) {
		var ret bool
		return ret
	}
	return *o.GroupsSupported
}

// GetGroupsSupportedOk returns a tuple with the GroupsSupported field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApplicationtemplateProvision) GetGroupsSupportedOk() (*bool, bool) {
	if o == nil || IsNil(o.GroupsSupported) {
		return nil, false
	}
	return o.GroupsSupported, true
}
...
func (o ApplicationtemplateProvision) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.GroupsSupported) {
		toSerialize["groups_supported"] = o.GroupsSupported
	}
	if !IsNil(o.Type) {
...
func (o *ApplicationtemplateProvision) UnmarshalJSON(bytes []byte) (err error) {
	varApplicationtemplateProvision := _ApplicationtemplateProvision{}

	if err = json.Unmarshal(bytes, &varApplicationtemplateProvision); err == nil {
		*o = ApplicationtemplateProvision(varApplicationtemplateProvision)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "groups_supported")
...
type NullableApplicationtemplateProvision struct {
	value *ApplicationtemplateProvision
	isSet bool
}
...
func NewNullableApplicationtemplateProvision(val *ApplicationtemplateProvision) *NullableApplicationtemplateProvision {
	return &NullableApplicationtemplateProvision{value: val, isSet: true}
}
