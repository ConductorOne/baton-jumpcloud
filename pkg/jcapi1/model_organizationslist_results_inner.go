...
// checks if the OrganizationslistResultsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationslistResultsInner{}
...
type _OrganizationslistResultsInner OrganizationslistResultsInner
...
func NewOrganizationslistResultsInner() *OrganizationslistResultsInner {
	this := OrganizationslistResultsInner{}
	return &this
}
...
func (o *OrganizationslistResultsInner) UnmarshalJSON(bytes []byte) (err error) {
	varOrganizationslistResultsInner := _OrganizationslistResultsInner{}

	if err = json.Unmarshal(bytes, &varOrganizationslistResultsInner); err == nil {
		*o = OrganizationslistResultsInner(varOrganizationslistResultsInner)
	}
...
type NullableOrganizationslistResultsInner struct {
	value *OrganizationslistResultsInner
	isSet bool
}
...
func NewNullableOrganizationslistResultsInner(val *OrganizationslistResultsInner) *NullableOrganizationslistResultsInner {
	return &NullableOrganizationslistResultsInner{value: val, isSet: true}
}
