...
func (r UsersApiAdminTotpresetBeginRequest) Execute() (*http.Response, error) {
...
func (a *UsersApiService) AdminTotpresetBeginExecute(r UsersApiAdminTotpresetBeginRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersApiService.AdminTotpresetBegin")
	if err != nil {
...
func (a *UsersApiService) UsersReactivateGetExecute(r UsersApiUsersReactivateGetRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersApiService.UsersReactivateGet")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
