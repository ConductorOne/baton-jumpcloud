...
// checks if the Radiusserverpost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Radiusserverpost{}
...
type _Radiusserverpost Radiusserverpost
...
func (o *Radiusserverpost) UnmarshalJSON(bytes []byte) (err error) {
	varRadiusserverpost := _Radiusserverpost{}

	if err = json.Unmarshal(bytes, &varRadiusserverpost); err == nil {
		*o = Radiusserverpost(varRadiusserverpost)
	}
...
func NewNullableRadiusserverpost(val *Radiusserverpost) *NullableRadiusserverpost {
	return &NullableRadiusserverpost{value: val, isSet: true}
}
