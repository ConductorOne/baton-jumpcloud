...
// checks if the ApplicationtemplateJit type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationtemplateJit{}
...
type _ApplicationtemplateJit ApplicationtemplateJit
...
func (o *ApplicationtemplateJit) UnmarshalJSON(bytes []byte) (err error) {
	varApplicationtemplateJit := _ApplicationtemplateJit{}

	if err = json.Unmarshal(bytes, &varApplicationtemplateJit); err == nil {
		*o = ApplicationtemplateJit(varApplicationtemplateJit)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "createOnly")
...
func NewNullableApplicationtemplateJit(val *ApplicationtemplateJit) *NullableApplicationtemplateJit {
	return &NullableApplicationtemplateJit{value: val, isSet: true}
}
