...
// checks if the Commandresultslist type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Commandresultslist{}
...
type _Commandresultslist Commandresultslist
...
func (o *Commandresultslist) GetResults() []CommandresultslistResultsInner {
	if o == nil || IsNil(o.Results) {
		var ret []CommandresultslistResultsInner
		return ret
	}
	return o.Results
}
...
func (o *Commandresultslist) UnmarshalJSON(bytes []byte) (err error) {
	varCommandresultslist := _Commandresultslist{}

	if err = json.Unmarshal(bytes, &varCommandresultslist); err == nil {
		*o = Commandresultslist(varCommandresultslist)
	}
...
func NewNullableCommandresultslist(val *Commandresultslist) *NullableCommandresultslist {
	return &NullableCommandresultslist{value: val, isSet: true}
}
