...
// checks if the SystemSystemInsights type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemSystemInsights{}
...
type _SystemSystemInsights SystemSystemInsights
...
func (o *SystemSystemInsights) UnmarshalJSON(bytes []byte) (err error) {
	varSystemSystemInsights := _SystemSystemInsights{}

	if err = json.Unmarshal(bytes, &varSystemSystemInsights); err == nil {
		*o = SystemSystemInsights(varSystemSystemInsights)
	}
...
func NewNullableSystemSystemInsights(val *SystemSystemInsights) *NullableSystemSystemInsights {
	return &NullableSystemSystemInsights{value: val, isSet: true}
}
