...
// checks if the SystemuserputpostPhoneNumbersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemuserputpostPhoneNumbersInner{}
...
type _SystemuserputpostPhoneNumbersInner SystemuserputpostPhoneNumbersInner
...
func NewSystemuserputpostPhoneNumbersInner() *SystemuserputpostPhoneNumbersInner {
	this := SystemuserputpostPhoneNumbersInner{}
	return &this
}
...
func (o *SystemuserputpostPhoneNumbersInner) UnmarshalJSON(bytes []byte) (err error) {
	varSystemuserputpostPhoneNumbersInner := _SystemuserputpostPhoneNumbersInner{}

	if err = json.Unmarshal(bytes, &varSystemuserputpostPhoneNumbersInner); err == nil {
		*o = SystemuserputpostPhoneNumbersInner(varSystemuserputpostPhoneNumbersInner)
	}
...
type NullableSystemuserputpostPhoneNumbersInner struct {
	value *SystemuserputpostPhoneNumbersInner
	isSet bool
}
...
func NewNullableSystemuserputpostPhoneNumbersInner(val *SystemuserputpostPhoneNumbersInner) *NullableSystemuserputpostPhoneNumbersInner {
	return &NullableSystemuserputpostPhoneNumbersInner{value: val, isSet: true}
}
